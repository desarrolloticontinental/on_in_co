...
DEFINE FRAME F-Main
     BROWSE-5 AT ROW 6.38 COL 115 WIDGET-ID 200
     BtnDone AT ROW 2.88 COL 115 WIDGET-ID 10
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_b-consulta-pickings ( 12.69 , 113.00 ) NO-ERROR.
...
IF NOT AVAILABLE i-faccpedi THEN RETURN.
...
CASE i-faccpedi.coddoc:
    WHEN "O/D" THEN DO:
        ...
        FOR EACH i-ccbcdocu USE-INDEX llave15 WHERE i-ccbcdocu.codcia = s-codcia AND 
            ...
            IF i-ccbcdocu.coddoc <> 'G/R' THEN NEXT.    /* Debe ser GR */
            IF NOT (i-ccbcdocu.libre_c01 = i-faccpedi.coddoc AND i-ccbcdocu.libre_c02 = i-faccpedi.nroped)
                THEN NEXT.      /* Debe ser la O/D */
            CREATE tt-w-report.
            ASSIGN 
            ...
            FIND FIRST Almcmov USE-INDEX Almc07 WHERE Almcmov.codcia = s-codcia AND
            ...
            IF AVAILABLE Almcmov THEN DO:
                ...
                FOR EACH Ccbcdocu NO-LOCK WHERE Ccbcdocu.codcia = s-codcia AND
                    ...
                    Ccbcdocu.coddoc = 'N/C':
                    IF Ccbcdocu.codcli = Almcmov.codcli AND
                        Ccbcdocu.nroped = STRING(Almcmov.nrodoc) AND
                        Ccbcdocu.flgest <> 'A' THEN DO:
                        tt-w-report.campo-c[7] = Ccbcdocu.nrodoc.
                        LEAVE.
                    END.
                END.
            END.
