...
&Scoped-Define ENABLED-OBJECTS BROWSE-2 TOGGLE-genera-pgre FILL-IN-tipo ~
COMBO-NroSer Btn_OK Btn_Cancel RECT-1 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-msg TOGGLE-genera-pgre ~
FILL-IN-tipo COMBO-BOX-Guias COMBO-NroSer-Guia FILL-IN-NroPed ~
...
DEFINE VARIABLE FILL-IN-msg AS CHARACTER FORMAT "X(100)":U INITIAL "Texto adicional..." 
      VIEW-AS TEXT 
     SIZE 64 BY .77
...
DEFINE VARIABLE TOGGLE-genera-pgre AS LOGICAL INITIAL yes 
     LABEL "¿Comprobante va generar pre-guia remision electronica?" 
     VIEW-AS TOGGLE-BOX
     SIZE 58 BY .77
...
DEFINE FRAME bgDialog
     BROWSE-2 AT ROW 9.58 COL 2 WIDGET-ID 200
     FILL-IN-msg AT ROW 8.35 COL 7 COLON-ALIGNED NO-LABEL WIDGET-ID 52
     TOGGLE-genera-pgre AT ROW 7.23 COL 13.14 WIDGET-ID 44
     FILL-IN-tipo AT ROW 3.27 COL 50.86 COLON-ALIGNED NO-LABEL WIDGET-ID 42
     BUTTON-4 AT ROW 5.08 COL 83 WIDGET-ID 40
     ...
     "G" VIEW-AS TEXT
          SIZE 5 BY 1.54 AT ROW 4.65 COL 75 WIDGET-ID 46
          BGCOLOR 15 FGCOLOR 2 FONT 8
     "R" VIEW-AS TEXT
          SIZE 5 BY 1.58 AT ROW 6.23 COL 75 WIDGET-ID 48
          BGCOLOR 15 FGCOLOR 2 FONT 8
     "E" VIEW-AS TEXT
          SIZE 5 BY 1.58 AT ROW 7.81 COL 75 WIDGET-ID 50
          BGCOLOR 15 FGCOLOR 2 FONT 8
     RECT-1 AT ROW 1.27 COL 2 WIDGET-ID 4
     SPACE(13.85) SKIP(13.26)
...
/* SETTINGS FOR FILL-IN FILL-IN-LugEnt IN FRAME bgDialog
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-msg IN FRAME bgDialog
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FILL-IN FILL-IN-NroPed IN FRAME bgDialog
   NO-ENABLE                                                            */
ASSIGN 
       TOGGLE-genera-pgre:MANUAL-HIGHLIGHT IN FRAME bgDialog = TRUE.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-msg TOGGLE-genera-pgre FILL-IN-tipo COMBO-BOX-Guias 
          ...
          FILL-IN-NroDoc-GR 
      WITH FRAME bgDialog.
  ENABLE BROWSE-2 TOGGLE-genera-pgre FILL-IN-tipo COMBO-NroSer Btn_OK 
         Btn_Cancel RECT-1 
      WITH FRAME bgDialog.
  VIEW FRAME bgDialog.
...
------------------------------------------------------------------------------*/
  ...
  IF lGRE_ONLINE = YES THEN DO:    /* GRE */          
    ASSIGN COMBO-NroSer-Guia:SENSITIVE = NO 
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      /* Ic - 13Jul2023, siempre genera GRE */
      fill-in-msg:SCREEN-VALUE = "El pedido logistico SI va generar GRE".
      toggle-genera-pgre:SCREEN-VALUE = 'yes'.
      ...
      IF AVAILABLE b-faccpedi THEN DO:
          ...
          IF b-faccpedi.cliente_recoge = YES OR b-faccpedi.TipVta = 'si' THEN DO:
              fill-in-msg:SCREEN-VALUE = "El pedido logistico es CLIENTE RECOGE por lo tanto no genera GRE".
              IF b-faccpedi.TipVta = 'si' THEN DO:
                  fill-in-msg:SCREEN-VALUE = "El pedido logistico es TRAMITE DOCUMENTARIO por lo tanto no genera GRE".
              END.
              toggle-genera-pgre:SCREEN-VALUE = 'no'.
          END.
