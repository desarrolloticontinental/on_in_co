...
DEFINE TEMP-TABLE tChkTareas NO-UNDO LIKE ChkTareas
...
&Scoped-define INTERNAL-TABLES tt-w-report tmp-w-report tChkTareas VtaCDocu
...
&Scoped-define FIELDS-IN-QUERY-BROWSE-20 tChkTareas.CodDoc ~
tChkTareas.NroPed tchktareas.tnro-phr @ x-col-nro-phr ~
tchktareas.tcoddoc @ x-col-codorden tchkTareas.tnrodoc @  x-col-nroorden ~
tChkTareas.tcliente @ x-cliente-col tchktareas.tbultos @ x-col-bultos ~
tChkTareas.Mesa tchktareas.tchequeador @ x-col-chequeador ~
tiempo-observado(tchktareas.fechafin, tchktareas.horafin) @ x-tiempo-observado-col 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-20 
&Scoped-define QUERY-STRING-BROWSE-20 FOR EACH tChkTareas ~
      WHERE (fill-in-phr = "" or tchktareas.tnro-phr = fill-in-phr) and ~
(fill-in-hpk = "" or tchktareas.nroped = fill-in-hpk) and ~
(combo-box-coddoc = "" or tchktareas.tcoddoc = combo-box-coddoc) and ~
(fill-in-Orden = "" or tchktareas.tnrodoc = fill-in-Orden) NO-LOCK, ~
      EACH VtaCDocu WHERE VtaCDocu.CodCia =  tChkTareas.CodCia AND ~
VtaCDocu.CodPed  = tChkTareas.CodDoc AND ~
VtaCDocu.NroPed =  tChkTareas.NroPed AND  ~
(fill-in-codtrab = "" or entry(1,vtacdocu.libre_c04,"|") = fill-in-codtrab) NO-LOCK
&Scoped-define OPEN-QUERY-BROWSE-20 OPEN QUERY BROWSE-20 FOR EACH tChkTareas ~
      WHERE (fill-in-phr = "" or tchktareas.tnro-phr = fill-in-phr) and ~
(fill-in-hpk = "" or tchktareas.nroped = fill-in-hpk) and ~
(combo-box-coddoc = "" or tchktareas.tcoddoc = combo-box-coddoc) and ~
(fill-in-Orden = "" or tchktareas.tnrodoc = fill-in-Orden) NO-LOCK, ~
...
VtaCDocu.NroPed =  tChkTareas.NroPed AND  ~
(fill-in-codtrab = "" or entry(1,vtacdocu.libre_c04,"|") = fill-in-codtrab) NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-20 tChkTareas VtaCDocu
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-20 tChkTareas
&Scoped-define SECOND-TABLE-IN-QUERY-BROWSE-20 VtaCDocu
...
&Scoped-Define ENABLED-OBJECTS BROWSE-18 BROWSE-20 BUTTON-filtrar ~
FILL-IN-codtrab FILL-IN-phr FILL-IN-hpk FILL-IN-desde FILL-IN-hasta ~
COMBO-BOX-CodDoc FILL-IN-Orden BUTTON-3 BUTTON-35 TOGGLE-packing-zebra ~
BUTTON-6 BUTTON-1 BUTTON-2 BROWSE-16 BUTTON-7 BUTTON-8 BUTTON-9 BUTTON-10 ~
BUTTON-11 BUTTON-34 BUTTON-37 BUTTON-38 RECT-4 RECT-5 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-20 W-Win _STRUCTURED
  QUERY BROWSE-20 NO-LOCK DISPLAY
      tChkTareas.CodDoc COLUMN-LABEL "Cod" FORMAT "x(3)":U WIDTH 3.43
      tChkTareas.NroPed COLUMN-LABEL "Nro.Orden" FORMAT "X(12)":U
            WIDTH 10.43
      tchktareas.tnro-phr @ x-col-nro-phr COLUMN-LABEL "Nro. PHR." FORMAT "x(15)":U
            WIDTH 9.43
      tchktareas.tcoddoc @ x-col-codorden COLUMN-LABEL "Cod.Doc" FORMAT "x(4)":U
            WIDTH 5.43
      tchkTareas.tnrodoc @  x-col-nroorden COLUMN-LABEL "Orden" FORMAT "x(12)":U
            WIDTH 8.43
      tChkTareas.tcliente @ x-cliente-col COLUMN-LABEL "Nombre Cliente" FORMAT "x(50)":U
            WIDTH 40.43
      tchktareas.tbultos @ x-col-bultos COLUMN-LABEL "Bultos" WIDTH 6.43
      tChkTareas.Mesa FORMAT "x(12)":U WIDTH 9.43
      tchktareas.tchequeador @ x-col-chequeador COLUMN-LABEL "Chequeador" FORMAT "x(40)":U
            WIDTH 23.43
      tiempo-observado(tchktareas.fechafin, tchktareas.horafin) @ x-tiempo-observado-col COLUMN-LABEL "Hora Terminado" FORMAT "x(25)":U
            WIDTH 23.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 149 BY 10.5
         FONT 4
...
DEFINE FRAME F-Main
     ...
     BROWSE-20 AT ROW 3.69 COL 2 WIDGET-ID 500
     BUTTON-filtrar AT ROW 2.35 COL 100 WIDGET-ID 68
     FILL-IN-codtrab AT ROW 2.35 COL 83 COLON-ALIGNED WIDGET-ID 30
     FILL-IN-phr AT ROW 2.31 COL 62.86 COLON-ALIGNED WIDGET-ID 32
     FILL-IN-hpk AT ROW 2.27 COL 42.29 COLON-ALIGNED WIDGET-ID 34
     FILL-IN-desde AT ROW 1.15 COL 30.72 COLON-ALIGNED WIDGET-ID 12
     FILL-IN-hasta AT ROW 1.15 COL 50.57 COLON-ALIGNED WIDGET-ID 14
     ...
     BUTTON-3 AT ROW 1.08 COL 67.43 WIDGET-ID 16
     BUTTON-35 AT ROW 19.58 COL 150 WIDGET-ID 52
     TOGGLE-packing-zebra AT ROW 17.85 COL 149.43 WIDGET-ID 48
     FILL-IN-copias AT ROW 8.23 COL 157 COLON-ALIGNED WIDGET-ID 28
     ...
     "Ordenes terminadas" VIEW-AS TEXT
          SIZE 20.57 BY .62 AT ROW 1.35 COL 6 WIDGET-ID 18
          FGCOLOR 9 FONT 10
     "v2" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 13.65 COL 156 WIDGET-ID 66
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tChkTareas T "?" NO-UNDO INTEGRAL ChkTareas
      ADDITIONAL-FIELDS:
          field tcoddoc as char
          field tnrodoc as char
          field tnro-phr as char
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME Custom                                                    */
/* BROWSE-TAB BROWSE-18 1 F-Main */
/* BROWSE-TAB BROWSE-20 BROWSE-18 F-Main */
...
/* Query rebuild information for BROWSE BROWSE-20
     _TblList          = "Temp-Tables.tChkTareas,INTEGRAL.VtaCDocu WHERE Temp-Tables.tChkTareas ..."
     _Options          = "NO-LOCK"
     _Where[1]         = "(fill-in-phr = """" or tchktareas.tnro-phr = fill-in-phr) and
(fill-in-hpk = """" or tchktareas.nroped = fill-in-hpk) and
(combo-box-coddoc = """" or tchktareas.tcoddoc = combo-box-coddoc) and
(fill-in-Orden = """" or tchktareas.tnrodoc = fill-in-Orden)"
     _JoinCode[2]      = "VtaCDocu.CodCia =  tChkTareas.CodCia AND
VtaCDocu.CodPed  = tChkTareas.CodDoc AND
VtaCDocu.NroPed =  tChkTareas.NroPed AND 
(fill-in-codtrab = """" or entry(1,vtacdocu.libre_c04,""|"") = fill-in-codtrab)"
     _FldNameList[1]   > Temp-Tables.tChkTareas.CodDoc
"tChkTareas.CodDoc" "Cod" ? "character" ? ? ? ? ? ? no ? no no "3.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.tChkTareas.NroPed
"tChkTareas.NroPed" "Nro.Orden" ? "character" ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > "_<CALC>"
"tchktareas.tnro-phr @ x-col-nro-phr" "Nro. PHR." "x(15)" ? ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > "_<CALC>"
"tchktareas.tcoddoc @ x-col-codorden" "Cod.Doc" "x(4)" ? ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > "_<CALC>"
"tchkTareas.tnrodoc @  x-col-nroorden" "Orden" "x(12)" ? ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > "_<CALC>"
"tChkTareas.tcliente @ x-cliente-col" "Nombre Cliente" "x(50)" ? ? ? ? ? ? ? no ? no no "40.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"tchktareas.tbultos @ x-col-bultos" "Bultos" ? ? ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.tChkTareas.Mesa
"tChkTareas.Mesa" ? "x(12)" "character" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > "_<CALC>"
"tchktareas.tchequeador @ x-col-chequeador" "Chequeador" "x(40)" ? ? ? ? ? ? ? no ? no no "23.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > "_<CALC>"
"tiempo-observado(tchktareas.fechafin, tchktareas.horafin) @ x-tiempo-observado-col" "Hora Terminado" "x(25)" ? ? ? ? ? ? ? no ? no no "23.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BROWSE-20 */
&ANALYZE-RESUME
...
ON ENTRY OF BROWSE-20 IN FRAME F-Main /* Bandeja de ordenes terminadas - impresion de Rotulos */
DO:
    x-codped = "".
    x-nroped = "".
    /*browse-15:TITLE = "".*/
    IF AVAILABLE tchktareas THEN DO:
          x-codped = tchktareas.coddoc.
          x-nroped = tchktareas.nroped.          
    END.
    FIND FIRST chktareas WHERE chktareas.codcia = 1 AND chktareas.coddiv = s-coddiv AND 
                              chktareas.coddoc = x-codped AND chktareas.nroped = x-nroped NO-LOCK NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-20 W-Win
ON START-SEARCH OF BROWSE-20 IN FRAME F-Main /* Bandeja de ordenes terminadas - impresion de Rotulos */
DO:
...
END.
/*
EACH Temp-Tables.tChkTareas
      WHERE (fill-in-phr = "" or tchktareas.tnro-phr = fill-in-phr) and
(fill-in-hpk = "" or tchktareas.nroped = fill-in-hpk) and
(combo-box-coddoc = "" or tchktareas.tcoddoc = combo-box-coddoc) and
(fill-in-Orden = "" or tchktareas.tnrodoc = fill-in-Orden) NO-LOCK,
      EACH INTEGRAL.VtaCDocu WHERE VtaCDocu.CodCia =  tChkTareas.CodCia AND
VtaCDocu.CodPed  = tChkTareas.CodDoc AND
VtaCDocu.NroPed =  tChkTareas.NroPed AND 
(fill-in-codtrab = "" or entry(1,vtacdocu.libre_c04,"|") = fill-in-codtrab) NO-LOCK
*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BROWSE-20 W-Win
ON VALUE-CHANGED OF BROWSE-20 IN FRAME F-Main /* Bandeja de ordenes terminadas - impresion de Rotulos */
DO:
  x-codped = "".
  x-nroped = "".
  ...
  IF AVAILABLE chktareas AND chktareas.CodDOc = 'HPK' THEN DO:
      ...
      IF AVAILABLE x-vtacdocu THEN DO:
        ...
        FIND FIRST tt-chktareas NO-LOCK NO-ERROR.
...
DO:
  IF AVAILABLE tchktareas THEN DO:
      ...
      IF  tchktareas.tcodclie = "20131376503" THEN DO:
            /* Senati */
      ...
      ELSE DO:
          ...
          IF tt-chktareas.tcodclie = "20100047218" THEN DO:
              /* BCP */              
              RUN imprimir-rotulos IN hProc (INPUT tchktareas.coddiv, 
                                             INPUT tchktareas.coddoc, 
                                             INPUT tchktareas.nroped,
                                             INPUT TABLE tmp-w-report,
                                             INPUT "ROTULOS BCP ZEBRA").               
          END.

          IF tchktareas.tcodclie = "20382036655" THEN DO:
              /* MI BANCO */
              RUN imprimir-rotulos IN hProc (INPUT tchktareas.coddiv, 
                                             INPUT tchktareas.coddoc, 
                                             INPUT tchktareas.nroped,
...
DO:
    ...
    RUN packing-consolidado(INPUT tchktareas.coddoc, INPUT tchktareas.nroped).
...
DO:
  ...
  */
    ...
    IF NOT AVAILABLE tchktareas THEN DO:
        RETURN.
    END.
...
DO:
  ...
  IF AVAILABLE tchktareas THEN DO:
      RUN packing-list(INPUT tchktareas.coddoc, INPUT tchktareas.nroped). /* HPK */
  END.
...
DO:
  ...
  IF AVAILABLE tchktareas THEN DO:
      RUN packing-list(INPUT tchktareas.coddoc, INPUT tchktareas.nroped).
  END.
END.
...
DO:
  IF AVAILABLE tchktareas THEN DO:
      ...
      IF  tchktareas.tcodclie = "20131376503" THEN DO:
            ...
            RUN dist/d-rotulo-bcp-extraordinario.r(INPUT tchktareas.tcoddoc, INPUT tchktareas.tnrodoc).
      ...
      ELSE DO:
          ...
          IF tchktareas.tcodclie = "20100047218" THEN DO:
              /* BCP */
              RUN imprimir-rotulos IN hProc (INPUT tchktareas.coddiv, 
                                             INPUT tchktareas.coddoc, 
                                             INPUT tchktareas.nroped,
...
DO:
  ...
  SESSION:SET-WAIT-STATE('GENERAL').
    ...
    FIND FIRST tchktareas NO-LOCK NO-ERROR.
    
    IF AVAILABLE tchktareas THEN DO:
          x-codped = tchktareas.coddoc.      /* HKP */
          x-nroped = tchktareas.nroped.
    END.
    ...
    {&open-query-browse-20}
    APPLY 'VALUE-CHANGED':U TO BROWSE browse-20.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE BROWSE-18 BROWSE-20 BUTTON-filtrar FILL-IN-codtrab FILL-IN-phr 
         FILL-IN-hpk FILL-IN-desde FILL-IN-hasta COMBO-BOX-CodDoc FILL-IN-Orden 
         BUTTON-3 BUTTON-35 TOGGLE-packing-zebra BUTTON-6 BUTTON-1 BUTTON-2 
         BROWSE-16 BUTTON-7 BUTTON-8 BUTTON-9 BUTTON-10 BUTTON-11 BUTTON-34 
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      fill-in-desde:SCREEN-VALUE = STRING(TODAY - 4,"99/99/9999").
...
DO WITH FRAME {&FRAME-NAME}:
    ASSIGN fill-in-desde fill-in-hasta fill-in-hpk combo-box-coddoc fill-in-Orden fill-in-phr fill-in-codtrab.
END.
...
DEFINE VAR xfiler AS INT INIT 0.

DEFINE VAR xDesde AS DATETIME.
DEFINE VAR xHasta AS DATETIME.
DEFINE VAR iConteo AS INT INIT 0.

xDesde = NOW.

EMPTY TEMP-TABLE tChkTareas.
/*
FILER:
FOR EACH ChkTareas WHERE ChkTareas.codcia = s-codcia AND ChkTareas.coddiv = s-coddiv NO-LOCK:
    iConteo = iConteo + 1.
    IF iConteo > 2 THEN LEAVE FILER.
END.
*/
FOR EACH ChkTareas WHERE ChkTareas.codcia = s-codcia AND ChkTareas.coddiv = s-coddiv AND
        ChkTareas.coddoc = 'HPK' AND ChkTareas.fechafin >= fill-in-desde NO-LOCK:
    /*(ChkTareas.fechafin >= fill-in-desde and ChkTareas.fechafin <= fill-in-hasta) NO-LOCK:*/

    IF LOOKUP(ChkTareas.FlgEst,"T,C") = 0 THEN NEXT.

    CREATE tChkTareas.
    BUFFER-COPY ChkTareas TO tChkTareas.
    ...
    IF chktareas.CodDOc = 'HPK' THEN DO:
        ...
        FIND FIRST x-vtacdocu WHERE x-vtacdocu.codcia = s-codcia AND
                                        ...
                                        x-vtacdocu.nroped = chktareas.nroped NO-LOCK NO-ERROR.
        IF AVAILABLE x-vtacdocu THEN DO:
            ASSIGN tchktareas.tcoddoc = x-vtacdocu.codref
                    tchktareas.tnrodoc = x-vtacdocu.nroref
                    tchktareas.tnro-phr = x-vtacdocu.nroori.
        END.
    END.
    ...
    END.
    /**/
    ASSIGN tchktareas.tbultos = x-col-bultos.
    ...
    x-col-chequeador = x-retval.
    ASSIGN tchktareas.tchequeador = x-col-chequeador.
    ...
    END.
     ...
     ASSIGN tchktareas.tcrossdocking = x-es-crossdocking-col.
    ...
    /* Cliente */
     ...
     END.
    ASSIGN tchktareas.tcliente = x-cliente-col
            tchktareas.tcodclie = x-cod-cliente.
...
{&open-query-browse-18}
*/
/*APPLY 'ENTRY':U TO FacCorre.CodAlm IN BROWSE {&BROWSE-NAME}.*/
APPLY 'VALUE-CHANGED':U TO BROWSE browse-20.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "tChkTareas"}
