...
DEF VAR x-SKUnochk AS INT NO-UNDO.
DEF VAR x-Clientes AS INT NO-UNDO.
DEF VAR x-ptos-entrega AS INT NO-UNDO.
...
DEFINE TEMP-TABLE tt-clientes NO-UNDO
    FIELD   tcodcli AS CHAR.

DEFINE TEMP-TABLE tt-datos-extras NO-UNDO
    FIELD   tcodcli AS CHAR.

DEFINE TEMP-TABLE tt-puntos-entrega NO-UNDO
    FIELD   tnrophr AS CHAR
    FIELD   tcodcli AS CHAR
    FIELD   tsede AS CHAR
    INDEX idx01 tnrophr tcodcli tsede.

DEFINE TEMP-TABLE tt-puntos-entrega2 NO-UNDO
    FIELD   tnrophr AS CHAR
    FIELD   tcodcli AS CHAR
    FIELD   tsede AS CHAR
...
DEFINE TEMP-TABLE tClientes NO-UNDO
    FIELD codclie AS CHAR FORMAT 'x(12)'
    INDEX idx01 codclie.
...
&Scoped-define INTERNAL-TABLES tt-DI-RutaC DI-RutaC
...
tt-DI-RutaC.Libre_d04 tt-DI-RutaC.Libre_d05 @ x-SKU ~
tt-DI-RutaC.Libre_d08 @ x-SKUnochk tt-DI-RutaC.Libre_d03 ~
tt-DI-RUTAC.libre_d07 @ x-ptos-entrega DI-RutaC.Observ DI-RutaC.Libre_c05 ~
DI-RutaC.Libre_f05 
...
&Scoped-define QUERY-STRING-br_table FOR EACH tt-DI-RutaC WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST DI-RutaC OF tt-DI-RutaC NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH tt-DI-RutaC WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST DI-RutaC OF tt-DI-RutaC NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table tt-DI-RutaC DI-RutaC
&Scoped-define FIRST-TABLE-IN-QUERY-br_table tt-DI-RutaC
...
&Scoped-Define ENABLED-OBJECTS COMBO-BOX-cuales FILL-IN-od ~
FILL-IN-contenido br_table BUTTON-Aplicar FILL-IN-Desde FILL-IN-Hasta ~
RADIO-SET-FlgEst 
&Scoped-Define DISPLAYED-OBJECTS COMBO-BOX-cuales FILL-IN-od ~
FILL-IN-contenido FILL-IN-Desde FILL-IN-Hasta RADIO-SET-FlgEst FILL-IN-Peso ~
FILL-IN-Volumen FILL-IN-Importe FILL-IN-Bultos FILL-IN-SKUs ~
FILL-IN-SKUnochk 
...
<SORTBY-OPTIONS>
Fecha|y||tt-DI-RutaC.FchDoc|no
Glosa|||tt-DI-RutaC.Observ|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
* Set attributes related to SORTBY-OPTIONS */
RUN set-attribute-list (
    'SortBy-Options = "':U + 'Fecha,Glosa' + '",
     SortBy-Case = ':U + 'Fecha').
...
DEFINE VARIABLE FILL-IN-SKUnochk AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 5 BY .81
     BGCOLOR 14 FGCOLOR 0  NO-UNDO.
...
"Cerradas", "C",
"Anuladas", "A",
"Todos", "PX|PK|PF|P|A|C"
     SIZE 17 BY 5.85 NO-UNDO.

/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY br_table FOR 
      tt-DI-RutaC
    FIELDS(tt-DI-RutaC.Libre_d01
      tt-DI-RutaC.Libre_d06
      tt-DI-RutaC.Libre_d02
      tt-DI-RutaC.Libre_d04
      tt-DI-RutaC.Libre_d05
      tt-DI-RutaC.Libre_d08
      tt-DI-RutaC.Libre_d03
      tt-DI-RUTAC.libre_d07), 
      DI-RutaC SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      tt-DI-RutaC.Libre_d04 COLUMN-LABEL "Bultos" FORMAT "->>,>>9":U
            WIDTH 4.29
      tt-DI-RutaC.Libre_d05 @ x-SKU COLUMN-LABEL "SKUs" WIDTH 4.43
      tt-DI-RutaC.Libre_d08 @ x-SKUnochk COLUMN-LABEL "SKUs!No Cheq."
      tt-DI-RutaC.Libre_d03 COLUMN-LABEL "Clientes" FORMAT "->,>>>,>>9":U
            WIDTH 5.72
      tt-DI-RUTAC.libre_d07 @ x-ptos-entrega COLUMN-LABEL "Ptos!Entrega" FORMAT "->,>>9":U
            WIDTH 5.43
      DI-RutaC.Observ COLUMN-LABEL "Glosa" FORMAT "x(60)":U COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS MULTIPLE SIZE 139.86 BY 7.81
         FONT 4 ROW-HEIGHT-CHARS .45.
...
DEFINE FRAME F-Main
     ...
     FILL-IN-contenido AT ROW 1.04 COL 25.86 COLON-ALIGNED WIDGET-ID 16
     br_table AT ROW 2.08 COL 1.14
     BUTTON-Aplicar AT ROW 2.08 COL 144 WIDGET-ID 12
     FILL-IN-Desde AT ROW 3.27 COL 145 COLON-ALIGNED WIDGET-ID 2
     FILL-IN-Hasta AT ROW 4.12 COL 145 COLON-ALIGNED WIDGET-ID 4
     RADIO-SET-FlgEst AT ROW 5.12 COL 142 NO-LABEL WIDGET-ID 6
     FILL-IN-Peso AT ROW 9.88 COL 44 RIGHT-ALIGNED NO-LABEL WIDGET-ID 22
     FILL-IN-Volumen AT ROW 9.88 COL 52 RIGHT-ALIGNED NO-LABEL WIDGET-ID 24
     FILL-IN-Importe AT ROW 9.88 COL 63 RIGHT-ALIGNED NO-LABEL WIDGET-ID 26
     FILL-IN-Bultos AT ROW 9.88 COL 69 RIGHT-ALIGNED NO-LABEL WIDGET-ID 28
     FILL-IN-SKUs AT ROW 9.88 COL 74 RIGHT-ALIGNED NO-LABEL WIDGET-ID 30
     FILL-IN-SKUnochk AT ROW 9.88 COL 81 RIGHT-ALIGNED NO-LABEL WIDGET-ID 32
...
/* BROWSE-TAB br_table FILL-IN-contenido F-Main */
ASSIGN 
...
/* SETTINGS FOR FILL-IN FILL-IN-Peso IN FRAME F-Main
   NO-ENABLE ALIGN-R                                                    */
/* SETTINGS FOR FILL-IN FILL-IN-SKUnochk IN FRAME F-Main
   NO-ENABLE ALIGN-R                                                    */
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "Temp-Tables.tt-DI-RutaC,INTEGRAL.DI-RutaC OF Temp-Tables.tt-DI-RutaC"
...
"tt-DI-RutaC.Libre_d02" "Importe" ">>>,>>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "10.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.tt-DI-RutaC.Libre_d04
"tt-DI-RutaC.Libre_d04" "Bultos" "->>,>>9" "decimal" ? ? ? ? ? ? no ? no no "4.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > "_<CALC>"
"tt-DI-RutaC.Libre_d05 @ x-SKU" "SKUs" ? ? ? ? ? ? ? ? no ? no no "4.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > "_<CALC>"
"tt-DI-RutaC.Libre_d08 @ x-SKUnochk" "SKUs!No Cheq." ? ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.tt-DI-RutaC.Libre_d03
"tt-DI-RutaC.Libre_d03" "Clientes" "->,>>>,>>9" "decimal" ? ? ? ? ? ? no ? no no "5.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > "_<CALC>"
"tt-DI-RUTAC.libre_d07 @ x-ptos-entrega" "Ptos!Entrega" "->,>>9" ? ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > INTEGRAL.DI-RutaC.Observ
"DI-RutaC.Observ" "Glosa" ? "character" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > INTEGRAL.DI-RutaC.Libre_c05
"DI-RutaC.Libre_c05" "Usuario!Modificación" "x(10)" "character" ? ? ? ? ? ? no ? no no "9" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > INTEGRAL.DI-RutaC.Libre_f05
"DI-RutaC.Libre_f05" "Fecha Modificación" ? "date" ? ? ? ? ? ? no ? no no "15" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
  ...
  DO k = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS:
      IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(k) THEN 
          ...
          FILL-IN-SKUs = FILL-IN-SKUs + tt-DI-RutaC.Libre_d05
          FILL-IN-SKUnochk = FILL-IN-SKUnochk + tt-DI-RutaC.Libre_d08
          .
  END.
  DISPLAY FILL-IN-Peso FILL-IN-Volumen FILL-IN-Importe FILL-IN-Bultos FILL-IN-SKUs FILL-IN-SKUnochk
      WITH FRAME {&FRAME-NAME}.

  RUN Pinta-Detalle IN lh_handle (ROWID(Di-Rutac)).
...
DO:
  ...
  IF NOT (TRUE <> (x-contenido > "")) THEN DO:
      IF combo-box-cuales <> 1 THEN DO:
          ...
          END.
          ELSE DO:
              FOR EACH gn-clie WHERE gn-clie.nomcli CONTAINS x-contenido NO-LOCK:
                  CREATE tt-clientes.
                  ASSIGN tt-clientes.tcodcli = gn-clie.codcli.
              END.
...
x-Rowid = ROWID(tt-Di-RutaC).
rRowid = ROWID(DI-RutaC).
...
RUN logis/d-mantto-phr-od (INPUT DI-RutaC.CodDoc,
                           ...
                           OUTPUT pMensaje).
/* RUN logis/d-mantto-phr-od-v2 (INPUT DI-RutaC.CodDoc, */
/*                            INPUT DI-RutaC.NroDoc,    */
/*                            OUTPUT pMensaje).         */
IF pMensaje <> "OK" THEN DO:
    IF pMensaje > '' AND pMensaje <> 'ADM-ERROR' THEN MESSAGE pMensaje VIEW-AS ALERT-BOX ERROR.
    RETURN NO-APPLY.
END.
/*ELSE RUN Procesa-Handle IN lh_handle ('Pinta-Detalle').*/

/*
APPLY 'CHOOSE':U TO BUTTON-Aplicar IN FRAME {&FRAME-NAME}.
REPOSITION {&BROWSE-NAME} TO ROWID x-Rowid NO-ERROR.
IF ERROR-STATUS:ERROR = NO THEN RUN Pinta-Detalle IN lh_handle (ROWID(Di-Rutac)).
RUN Pinta-Detalle IN lh_handle (ROWID(Di-Rutac)).
*/

RUN Pinta-Detalle IN lh_handle (rRowid).
...
------------------------------------------------------------------------------*/
  ...
  CASE RETURN-VALUE:
    WHEN 'Fecha':U THEN DO:
      &Scope SORTBY-PHRASE BY tt-DI-RutaC.FchDoc DESCENDING
      {&OPEN-QUERY-{&BROWSE-NAME}}
    END.
    WHEN 'Glosa':U THEN DO:
      &Scope SORTBY-PHRASE BY tt-DI-RutaC.Observ
      {&OPEN-QUERY-{&BROWSE-NAME}}
    END.
    OTHERWISE DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Captura-Registro B-table-Win 
PROCEDURE Captura-Registro :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
DEF OUTPUT PARAMETER TABLE FOR T-RutaC.
...
DEF VAR x-nro-od AS CHAR.
DEF VAR x-nro-phr AS CHAR.
DEF VAR x-existe AS LOG INIT YES.    
DEF VAR x-cuales AS INT.
DEF VAR x-contenido AS CHAR.

EMPTY TEMP-TABLE tClientes.

x-nro-od = fill-in-od:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
RLOOP:
DO k = 1 TO NUM-ENTRIES(RADIO-SET-FlgEst,'|'):
    cFlgEst = ENTRY(k, RADIO-SET-FlgEst, '|').
    FOR EACH DI-RutaC NO-LOCK WHERE DI-RutaC.CodCia = s-codcia AND
        DI-RutaC.CodDiv = s-coddiv AND
        DI-RutaC.CodDoc = s-coddoc AND
        DI-RutaC.FlgEst = cFlgEst AND 
        (DI-RutaC.FchDoc >= FILL-IN-Desde AND DI-RutaC.FchDoc <= FILL-IN-Hasta):
        /* Orden de Despacho */
        IF NOT (TRUE <> (x-nro-od > "")) THEN DO:
            x-nro-phr = di-rutaC.nrodoc.
            x-existe = NO.
            /* Si tiene O/D como dato */
            BUSCAR_OD:
            FOR EACH x-di-rutaD WHERE x-di-rutaD.codcia = s-codcia AND
                ...
                END.
            END.
            IF x-existe = NO THEN NEXT RLOOP.
        END.
        /* Cliente */
...
/*             FIND FIRST Faccpedi NO-LOCK WHERE FacCPedi.CodCia = Di-RutaD.codcia                                       */
/*                 AND FacCPedi.CodDoc = Di-RutaD.codref       /* O/D , OTR */                                           */
/*                 AND FacCPedi.NroPed = Di-RutaD.nroref NO-ERROR.                                                       */
/*             IF NOT AVAILABLE faccPedi THEN NEXT.                                                                      */
/*                                                                                                                       */
/*                                                                                                                       */
/*             /*IF FIRST-OF(Faccpedi.CodCli) THEN tt-di-rutaC.libre_d03 = tt-di-rutaC.libre_d03 + 1.*/                  */
/*             FIND FIRST tclientes WHERE tclientes.codclie = faccpedi.codcli EXCLUSIVE-LOCK NO-ERROR.                   */
/*             IF NOT AVAILABLE tclientes THEN DO:                                                                       */
/*                 CREATE tclientes.                                                                                     */
/*                 ASSIGN tclientes.codclie = faccpedi.codcli.                                                           */
/*                 ASSIGN tt-di-rutaC.libre_d03 = tt-di-rutaC.libre_d03 + 1.                                             */
/*             END.                                                                                                      */
/*             ASSIGN                                                                                                    */
...
/*             /* ******************************* */                                                                     */
/*             ASSIGN tt-Di-RutaC.Libre_d02 = tt-Di-RutaC.Libre_d02 + fImporte().                                        */
/*             /* ******************************* */                                                                     */
...
/*                     ASSIGN                                                                                            */
/*                         tt-puntos-entrega.tnrophr = di-rutaC.nrodoc                                                   */
/*                         tt-puntos-entrega.tsede = faccpedi.sede                                                       */
/*                         tt-puntos-entrega.tcodcli = faccpedi.codcli.                                                  */
/*                     ASSIGN                                                                                            */
/*                         tt-di-rutaC.libre_d07 = tt-di-rutaC.libre_d07 + 1.                                            */
/*             END.                                                                                                      */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE carga-temporal2 B-table-Win 
...
FOR EACH tt-di-rutaC :

        EMPTY TEMP-TABLE tt-puntos-entrega.

        /*FOR EACH Di-RutaD OF Di-RutaC NO-LOCK,*/
        FOR EACH di-rutad WHERE di-rutad.codcia = tt-di-rutaC.codcia AND
                                di-rutad.coddiv = tt-di-rutaC.coddiv AND
                                di-rutad.coddoc = tt-di-rutaC.coddoc AND
                                di-rutad.nrodoc = tt-di-rutaC.nrodoc NO-LOCK:            

            FIND FIRST Faccpedi USE-INDEX llave01 WHERE FacCPedi.CodCia = Di-RutaD.codcia
                AND FacCPedi.CodDoc = Di-RutaD.codref       /* O/D , OTR */
                AND FacCPedi.NroPed = Di-RutaD.nroref NO-LOCK NO-ERROR.
            IF NOT AVAILABLE faccPedi THEN NEXT.
            ...
            IF NOT AVAILABLE tclientes THEN DO:
                ...
                ASSIGN tt-di-rutaC.libre_d03 = tt-di-rutaC.libre_d03 + 1.
            END.
            ASSIGN tt-Di-Rutac.Libre_d01 = tt-Di-Rutac.Libre_d01 + Faccpedi.Peso.
            ASSIGN    tt-Di-Rutac.Libre_d06 = tt-Di-Rutac.Libre_d06 + Faccpedi.Volumen.
            ASSIGN tt-Di-Rutac.Libre_d05 = tt-Di-Rutac.Libre_d05 + Faccpedi.Items .
            IF Faccpedi.FlgEst = "P" AND LOOKUP(Faccpedi.FlgSit, "PC,C") = 0 THEN DO:
                ASSIGN tt-Di-Rutac.Libre_d08 = tt-Di-Rutac.Libre_d08 + Faccpedi.Items.
            END.
            /* ******************************* */
            /* RHC 12/08/2021 TC venta de caja */
            /* ******************************* */
            ...
            FIND FIRST tt-puntos-entrega WHERE  tt-puntos-entrega.tnrophr = tt-di-rutaC.nrodoc AND
                tt-puntos-entrega.tcodcli = faccpedi.codcli AND
                tt-puntos-entrega.tsede = faccpedi.sede EXCLUSIVE-LOCK NO-ERROR.
            IF NOT AVAILABLE tt-puntos-entrega THEN DO:
                CREATE tt-puntos-entrega.
                    ASSIGN  
                        tt-puntos-entrega.tnrophr = tt-di-rutaC.nrodoc
                        tt-puntos-entrega.tsede = faccpedi.sede
                        tt-puntos-entrega.tcodcli = faccpedi.codcli.
                    ASSIGN 
                        tt-di-rutaC.libre_d07 = tt-di-rutaC.libre_d07 + 1.
            ...
            CREATE tt-puntos-entrega2.
            ASSIGN   
                tt-puntos-entrega2.tnrophr = tt-di-rutaC.nrodoc
                tt-puntos-entrega2.tcodcli = faccpedi.codcli
                tt-puntos-entrega2.tsede = FacCPedi.sede
                tt-puntos-entrega2.tcoddoc = FacCPedi.CodDoc
                tt-puntos-entrega2.tnrodoc = FacCPedi.nroped.
...
/* Capturamos el Excel */
SESSION:SET-WAIT-STATE('GENERAL').
RUN Captura-Temporal IN lh_handle (INPUT ROWID(Di-RutaC), INPUT-OUTPUT TABLE T-RUTAD).
...
FOR EACH T-RUTAD OF DI-RutaC NO-LOCK,
    ...
    CASE Faccpedi.coddoc:
        WHEN "OTR" THEN DO:
            IF Faccpedi.tpoped = "XD" THEN w-report.Campo-C[10] = "CROSS DOCKING".
        END.
        WHEN "O/D" THEN DO:
            DEF VAR LocalRastreo AS LOG NO-UNDO.
            IF CAN-FIND(FIRST AlmCDocu WHERE AlmCDocu.CodCia = Faccpedi.codcia AND
                ...
                FOR EACH ccbcdocu NO-LOCK USE-INDEX Llave15 WHERE ccbcdocu.codcia = s-codcia
                    ...
                    LEAVE.
                END.
                IF LocalRastreo = YES THEN w-report.Campo-C[10] = "REPROGRAMADO".
            END.
        END.
    END CASE.
    */
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
      ...
      FILL-IN-Desde = ADD-INTERVAL(TODAY , -7, 'days')
      FILL-IN-Hasta = TODAY.
