...
T-VtaCDocu.Estado @ x-Estado T-VtaCDocu.Bultos @ x-Bultos VtaCDocu.NomCli ~
T-VtaCDocu.FchEnt 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 122 BY 14.54
...
"T-VtaCDocu.Bultos @ x-Bultos" "Bultos" ">>,>>9" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   = INTEGRAL.VtaCDocu.NomCli
     _FldNameList[11]   > Temp-Tables.T-VtaCDocu.FchEnt
...
DEF INPUT-OUTPUT PARAMETER TABLE FOR T-Vtacdocu.

SESSION:SET-WAIT-STATE("GENERAL").
RUN Graba-Datos-Reflejo (pRowid).
...
------------------------------------------------------------------------------*/
    ...
    SESSION:SET-WAIT-STATE("GENERAL").
    RUN Graba-Datos-Reflejo (ROWID(DI-RutaC)).
    SESSION:SET-WAIT-STATE("").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Graba-Datos-Reflejo B-table-Win 
PROCEDURE Graba-Datos-Reflejo :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
