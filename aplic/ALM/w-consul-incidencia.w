...
DEFINE VARIABLE h_b-consul-dincidencia AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ALM/b-consul-dincidencia.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-consul-dincidencia ).
       RUN set-position IN h_b-consul-dincidencia ( 15.38 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-consul-dincidencia ( 11.04 , 140.00 ) NO-ERROR.

       /* Links to SmartBrowser h_b-consul-dincidencia. */
       RUN add-link IN adm-broker-hdl ( h_b-consul-incid-cab , 'Record':U , h_b-consul-dincidencia ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-consul-incid-cab ,
             BUTTON-6:HANDLE IN FRAME F-Main , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-consul-dincidencia ,
