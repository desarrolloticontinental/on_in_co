...
T-MoviAlmacen.Peso @ x-Peso T-MoviAlmacen.NomRef 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      T-MoviAlmacen.NroRf1 COLUMN-LABEL "OC/Comprobante" FORMAT "x(12)":U
            WIDTH 12.43
      T-MoviAlmacen.Observ FORMAT "X(30)":U WIDTH 29.43
      ...
      T-MoviAlmacen.Peso @ x-Peso COLUMN-LABEL "Peso kg" FORMAT ">>>,>>9.99":U
            WIDTH 6
      T-MoviAlmacen.NomRef FORMAT "x(120)":U WIDTH 30.72
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"T-MoviAlmacen.NroDoc" "Numero" "999999999" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.T-MoviAlmacen.NroRf1
"T-MoviAlmacen.NroRf1" "OC/Comprobante" "x(12)" "character" ? ? ? ? ? ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.T-MoviAlmacen.Observ
"T-MoviAlmacen.Observ" ? "X(30)" "character" ? ? ? ? ? ? no ? no no "29.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > Temp-Tables.T-MoviAlmacen.CodPro
"T-MoviAlmacen.CodPro" "Proveedor" ? "character" ? ? ? ? ? ? no ? no no "11.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > "_<CALC>"
"T-MoviAlmacen.Items @ x-Items" "Items" ">>9" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > "_<CALC>"
"T-MoviAlmacen.Volumen @ x-Volumen" "Vol. m3" ">>>,>>9.99" ? ? ? ? ? ? ? no ? no no "5.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > "_<CALC>"
"T-MoviAlmacen.Peso @ x-Peso" "Peso kg" ">>>,>>9.99" ? ? ? ? ? ? ? no ? no no "6" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.T-MoviAlmacen.NomRef
"T-MoviAlmacen.NomRef" ? "x(120)" "character" ? ? ? ? ? ? no ? no no "30.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
/*             IF RETURN-VALUE = 'ADM-ERROR' THEN UNDO CICLO, RETURN 'ADM-ERROR'. */
    ...
    END.
    /* ********************************************************************************** */
    /* 12/04/2024: Hay que eliminar el LogisDChequeo */
    /* ********************************************************************************** */
    FOR EACH Logisdchequeo WHERE logisdchequeo.CodCia = s-codcia AND 
        logisdchequeo.CodDiv = s-coddiv AND 
        logisdchequeo.CodPed = Almcmov.codref AND
        logisdchequeo.NroPed = Almcmov.nroref
    ...
    IF AVAILABLE Ccbcdocu THEN DO:
        ...
        /* ******************************************************************** */
        /* 12/04/2024: Reactivamos, ya que se ha retirado del control de barras */
        /* ******************************************************************** */
...
RLOOP:
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    FOR EACH ooMoviAlmacen WHERE OOMoviAlmacen.CodCia = T-MoviAlmacen.CodCia AND
        OOMoviAlmacen.CodAlm = T-MoviAlmacen.CodAlm AND
        OOMoviAlmacen.TipMov = T-MoviAlmacen.TipMov AND
        OOMoviAlmacen.CodMov = T-MoviAlmacen.CodMov AND 
        OOMoviAlmacen.NroSer = T-MoviAlmacen.NroSer AND 
        OOMoviAlmacen.NroDoc = T-MoviAlmacen.NroDoc AND 
        OOMoviAlmacen.FlagMigracion = "N" EXCLUSIVE-LOCK ON ERROR UNDO, THROW:
