...
DEFINE TEMP-TABLE T-Detalle
    ...
    FIELD MotReposicion LIKE Reposiciones.MotReposicion COLUMN-LABEL 'Motivo Reposicion'
...
REPOSICIONES.NroSer REPOSICIONES.NroDoc ~
REPOSICIONES.Fecha @ REPOSICIONES.Fecha ~
reposiciones.ot @ reposiciones.nrorf1 REPOSICIONES.Libre_c05 ~
REPOSICIONES.Libre_f02 REPOSICIONES.FlgCbd REPOSICIONES.TotItm ~
REPOSICIONES.Libre_d01 REPOSICIONES.TotPesoApro @ x-TotPesoApro ~
REPOSICIONES.Libre_d02 REPOSICIONES.TotVolSol @ x-TotVolSol ~
REPOSICIONES.TotVolApro @ x-TotVolApro REPOSICIONES.TotVolAte @ x-TotVolAte ~
REPOSICIONES.MotReposicion @ x-Motivo almcrepo.Glosa ~
reposiciones.nomrechazo @ reposiciones.libre_c02 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define QUERY-STRING-br_table FOR EACH REPOSICIONES WHERE ~{&KEY-PHRASE} NO-LOCK, ~
 ...
 AND FacCPedi.NroPed = REPOSICIONES.nroped OUTER-JOIN NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH REPOSICIONES WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      FIRST almcrepo OF REPOSICIONES OUTER-JOIN NO-LOCK, ~
      FIRST FacCPedi WHERE TRUE /* Join to REPOSICIONES incomplete */ ~
      AND FacCPedi.CodCia = REPOSICIONES.codcia ~
 AND FacCPedi.CodDoc = REPOSICIONES.coddoc ~
...
BUTTON-19 SELECT-FlgEst sBUTTON-18 BUTTON-3 FILL-IN-CodAlm BUTTON-1 ~
...
FILL-IN-CodMat TOGGLE-VtaPuntual COMBO-BOX-PreHoja FILL-IN-TotVolSol ~
FILL-IN-TotVolAte txtPedAtrazados FILL-IN-TotPedidos FILL-IN-TotPesSol ~
FILL-IN-TotPesAte FILL-IN-TotBultos FILL-IN-TotItm 
...
RUN set-attribute-list (
    'SortBy-Options = "':U + 'FchDoc,Libre_c05,TotItm,Libre_d01,Libre_d02,AlmPed' + '",
...
DEFINE VARIABLE FILL-IN-TotVolAte AS DECIMAL FORMAT "-ZZZ,ZZZ,ZZ9.99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81
     BGCOLOR 14 FGCOLOR 0  NO-UNDO.

DEFINE VARIABLE FILL-IN-TotVolSol AS DECIMAL FORMAT "-ZZZ,ZZZ,ZZ9.99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 11.72 BY .81
     BGCOLOR 14 FGCOLOR 0  NO-UNDO.
...
DEFINE VARIABLE SELECT-FlgEst AS CHARACTER INITIAL "Todos" 
     ...
     LIST-ITEMS "Todos","Emitido","Aprobado","Impreso","Picking","Chequeado","Con PGRE","Documentado","En Ruta","Recepcionado","Anulado","Rechazado" 
     SIZE 20 BY 6.19 TOOLTIP "Selecciona Estados" NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      REPOSICIONES.MotReposicion @ x-Motivo COLUMN-LABEL "Motivo de la Reposición" FORMAT "x(20)":U
...
DEFINE FRAME F-Main
     ...
     sBUTTON-18 AT ROW 1.27 COL 110 WIDGET-ID 62
     ...
     FILL-IN-TotVolSol AT ROW 16.88 COL 66 COLON-ALIGNED NO-LABEL WIDGET-ID 190
     FILL-IN-TotVolAte AT ROW 16.88 COL 89 COLON-ALIGNED NO-LABEL WIDGET-ID 192
     ...
     FILL-IN-TotPesAte AT ROW 16.92 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 108
     FILL-IN-TotBultos AT ROW 16.92 COL 109.57 COLON-ALIGNED NO-LABEL WIDGET-ID 152
     FILL-IN-TotItm AT ROW 16.92 COL 124.57 COLON-ALIGNED NO-LABEL WIDGET-ID 172
     "Total  Volumen Atendido m3" VIEW-AS TEXT
          SIZE 20 BY .5 AT ROW 16.35 COL 89 WIDGET-ID 196
          BGCOLOR 9 FGCOLOR 15 
     "    Total Bultos" VIEW-AS TEXT
          SIZE 13.14 BY .5 AT ROW 16.35 COL 111 WIDGET-ID 154
          BGCOLOR 9 FGCOLOR 15 
     "    Total Items" VIEW-AS TEXT
          SIZE 13.14 BY .5 AT ROW 16.35 COL 126 WIDGET-ID 174
          BGCOLOR 9 FGCOLOR 15 
     "Toral Peso Aprobado kg" VIEW-AS TEXT
          SIZE 17 BY .5 AT ROW 16.35 COL 32 WIDGET-ID 120
          BGCOLOR 9 FGCOLOR 15 
     ...
     "Total Peso Atendido kg" VIEW-AS TEXT
          SIZE 16 BY .5 AT ROW 16.35 COL 50 WIDGET-ID 122
          BGCOLOR 9 FGCOLOR 15 
...
DEFINE FRAME F-Main
     "Toral Volumen Aprobado m3" VIEW-AS TEXT
          SIZE 20 BY .5 AT ROW 16.35 COL 67 WIDGET-ID 194
          BGCOLOR 9 FGCOLOR 15 
...
/* SETTINGS FOR FILL-IN FILL-IN-TotPesSol IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-TotVolAte IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-TotVolSol IN FRAME F-Main
   NO-ENABLE                                                            */
...
"REPOSICIONES.TotPesoApro @ x-TotPesoApro" "Total Peso!Aprobado Kg" "->>>,>>>,>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > Temp-Tables.REPOSICIONES.Libre_d02
...
"REPOSICIONES.MotReposicion @ x-Motivo" "Motivo de la Reposición" "x(20)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[21]   > INTEGRAL.almcrepo.Glosa
"almcrepo.Glosa" ? ? "character" ? ? ? ? ? ? no ? no no "16" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[22]   > "_<CALC>"
"reposiciones.nomrechazo @ reposiciones.libre_c02" "Nombre Rechazo" "X(40)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
    ...
    x-almacenes = FILL-IN-AlmPed:SCREEN-VALUE.
...
DO:
    ...
    CASE s-nivel-acceso:
        WHEN 1 THEN RUN alm/d-almacen (INPUT-OUTPUT x-almacenes).
        WHEN 0 THEN DO:
            FIND Almacen WHERE Almacen.codcia = s-codcia AND
                Almacen.codalm = s-codalm NO-LOCK NO-ERROR.
            IF AVAILABLE Almacen THEN RUN gn/d-almacen-despacho-por-div (Almacen.CodDiv, INPUT-OUTPUT x-almacenes).
        END.
    END CASE.
...
&Scoped-define SELF-NAME sBUTTON-18
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL sBUTTON-18 B-table-Win
ON CHOOSE OF sBUTTON-18 IN FRAME F-Main /* Consultar BD */
DO:
  ASSIGN
  ...
  IF FILL-IN-FchDoc-1 = ? OR FILL-IN-FchDoc-2 = ? THEN DO:
      MESSAGE 'Debe ingresar ambas fechas: EMISTIDOS DESDE y EMITIDOS HASTA' VIEW-AS ALERT-BOX INFORMATION.
      APPLY 'ENTRY':U TO FILL-IN-FchDoc-1.
      RETURN NO-APPLY.
  END.
  /* 18/3/2024: L.Mesia 6 meses pero entre el rango de fechas */
  IF ABSOLUTE( INTERVAL(FILL-IN-FchDoc-1, FILL-IN-FchDoc-2, 'MONTHS') ) > 6 THEN DO:
...
/*   END.                                                                                       */
  ...
  CASE s-Nivel-Acceso:
      WHEN 1 THEN DO:
          IF TRUE <> (FILL-IN-AlmPed > '') OR TRUE <> (FILL-IN-CodAlm > '') THEN DO:
              MESSAGE 'Sería bueno que ingresar ambos almacenes, el Almacén Despacho y el Almacén Destino' SKIP
                  'Continuamos con el proceso?'
                  VIEW-AS ALERT-BOX QUESTION BUTTONS YES-NO
                  UPDATE rpta AS LOG.
              IF rpta = NO THEN DO:
                  APPLY 'ENTRY':U TO FILL-IN-AlmPed.
                  RETURN NO-APPLY.
              END.
          END.
      END.
      WHEN 0 THEN DO:   /* Tiendas */
          IF TRUE <> (FILL-IN-AlmPed > '') OR TRUE <> (FILL-IN-CodAlm > '') THEN DO:
              MESSAGE 'Debe ingresar ambos, el Almacén Despacho y el Almacén Destino'
  ...
  SESSION:SET-WAIT-STATE('').
  MESSAGE 'Consulta BD concluida' VIEW-AS ALERT-BOX INFORMATION.
...
DEF INPUT PARAMETER lNroOtr AS CHAR.
...
FOR EACH REPOSICIONES WHERE LOOKUP(REPOSICIONES.FlgEst, "A,R") = 0:
    ...
    FOR EACH faccpedi NO-LOCK WHERE faccpedi.codcia = s-codcia
        ...
        AND (TRUE <> (lNroOtr > "") OR lNroOtr = faccpedi.nroped)
...
DEF VAR x-TipMov AS CHAR INIT 'A,M' NO-UNDO.
DEF VAR k AS INTE NO-UNDO.

DO k = 1 TO 2:
    /* ********* */
    FOR EACH almacen NO-LOCK WHERE almacen.codcia = s-codcia
            AND (TRUE <> (FILL-IN-CodAlm > '') OR LOOKUP(almacen.codalm, FILL-IN-CodAlm) > 0):
        FOR EACH almcrepo NO-LOCK WHERE almcrepo.codcia = s-codcia
            AND almcrepo.codalm = almacen.codalm
            AND almcrepo.tipmov = ENTRY(k, x-TipMov)
            ...
            /* Filtros */
            /* ********************************************************************** */
            IF NOT (FILL-IN-NroSer = 0 OR almcrepo.nroser = FILL-IN-NroSer) THEN NEXT.
            IF NOT (FILL-IN-NroDoc = 0 OR almcrepo.nrodoc = FILL-IN-NroDoc) THEN NEXT.
            ...
            IF FILL-IN-CodMat > '' THEN DO:
                IF NOT CAN-FIND(FIRST Almdrepo OF Almcrepo WHERE Almdrepo.codmat = FILL-IN-CodMat NO-LOCK) THEN NEXT.
            END.
            /* Por # R/A */
            IF FILL-IN-NroSer > 0 AND Almcrepo.nroser <> FILL-IN-NroSer THEN NEXT.
            IF FILL-IN-NroDoc > 0 AND Almcrepo.nrodoc <> FILL-IN-NroDoc THEN NEXT.
            /* Por Motivo */
            IF NOT (COMBO-BOX-Motivo = 'Seleccione' OR Almcrepo.MotReposicion = COMBO-BOX-Motivo) THEN NEXT.
            /* ********************************************************************** */
            /* ********************************************************************** */
            ...
            BUFFER-COPY almcrepo TO REPOSICIONES
                ...
                .
            IF TOGGLE-CrossDocking = YES THEN
                ASSIGN 
            ...
            IF almcrepo.libre_c02 <> ? THEN DO:
                IF NUM-ENTRIES(almcrepo.libre_c02,"|") > 1 THEN DO:
                    ...
                    FIND FIRST factabla WHERE factabla.codcia = s-codcia AND
                        ...
                        NO-LOCK NO-ERROR.
                    IF AVAILABLE factabla THEN ASSIGN REPOSICIONES.nomrechazo = factabla.nombre.
                END.
            END.
        END.
    END.
...
FOR EACH almacen NO-LOCK WHERE almacen.codcia = s-codcia
    ...
    EACH Faccpedi NO-LOCK WHERE Faccpedi.codcia = s-codcia
        ...
        AND Faccpedi.coddoc = "OTR"
        AND (TRUE <> (lnroOtr > '') OR Faccpedi.nroped = lNroOtr)
    ...
    IF FILL-IN-CodMat > '' THEN DO:
        IF NOT CAN-FIND(FIRST Facdpedi OF Faccpedi WHERE Facdpedi.codmat = FILL-IN-CodMat NO-LOCK) THEN NEXT.
    END.
    /* Por # R/A */
    IF FILL-IN-NroSer > 0 AND INTEGER(SUBSTRING(Faccpedi.nroref,1,3)) <> FILL-IN-NroSer THEN NEXT.
    IF FILL-IN-NroDoc > 0 AND INTEGER(SUBSTRING(Faccpedi.nroref,4)) <> FILL-IN-NroDoc THEN NEXT.
    /* Por Motivo */
    IF NOT (COMBO-BOX-Motivo = 'Seleccione' OR Faccpedi.MotReposicion = COMBO-BOX-Motivo) THEN NEXT.
    /* ********************************************************************** */
    CREATE REPOSICIONES.
...
FOR EACH REPOSICIONES:
    ...
    END.
    /* Por Pre-Hoja */
    IF NOT (COMBO-BOX-PreHoja = 'Todos' OR REPOSICIONES.PreHoja = COMBO-BOX-PreHoja) THEN DO:
        DELETE REPOSICIONES.
        NEXT.
    END.
    /* Por Estados */
    IF NOT (x-Estado = 'Todos' OR LOOKUP(REPOSICIONES.Libre_c05, x-Estado) > 0) THEN DO:
        DELETE REPOSICIONES.
        NEXT.
    END.
    /* Por Motivo */
    IF NOT (COMBO-BOX-Motivo = 'Seleccione' OR REPOSICIONES.MotReposicion = COMBO-BOX-Motivo) THEN DO:
        ...
        NEXT.
    END.
    REPOSICIONES.MotReposicion = fMotivo().
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Carga-Temporal-Por-OTR B-table-Win 
PROCEDURE Carga-Temporal-Por-OTR :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       Exclusivo para búsqueda de OTR específica
------------------------------------------------------------------------------*/
...
FOR EACH almacen NO-LOCK WHERE almacen.codcia = s-codcia
    ...
    EACH Faccpedi NO-LOCK WHERE Faccpedi.codcia = s-codcia
        AND Faccpedi.codcli = almacen.codalm
        AND Faccpedi.coddoc = "OTR"
        AND Faccpedi.nroped = lNroOtr   /* <<<< OJO <<<< */
        AND Faccpedi.codref = "OPEN"
        AND (Faccpedi.FchPed >= FILL-IN-FchDoc-1 AND Faccpedi.FchPed <= FILL-IN-FchDoc-2)
        AND Faccpedi.flgest <> "A" 
        AND (TRUE <> (FILL-IN-AlmPed > '') OR LOOKUP(Faccpedi.codalm, FILL-IN-AlmPed) > 0):
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Carga-Temporal-Sin-OTR B-table-Win 
PROCEDURE Carga-Temporal-Sin-OTR :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
IF faccpedi.flgsit = "C" THEN DO:
    ...
    IF T-TRACKING.FechaI = ? THEN T-TRACKING.FechaI = REPOSICIONES.FchDoc.
    ASSIGN
        REPOSICIONES.Libre_c05 = "Chequeado"
        REPOSICIONES.Libre_f02 = T-TRACKING.FechaI.
END.
/* 08/05/2023: Con PGRE */
IF faccpedi.flgsit = "PGRE" THEN DO:
    CREATE T-TRACKING.
    ASSIGN
        T-TRACKING.CodCia = s-codcia
        T-TRACKING.CodAlm = REPOSICIONES.codalm
        ...
        T-TRACKING.FechaI = FacCPedi.FchChq
        T-TRACKING.usuario= FacCPedi.UsrChq
        T-TRACKING.Libre_c01 = "Con PGRE"
        T-TRACKING.Libre_c05 = fNombreUsuario(FacCPedi.UsrChq)
        T-TRACKING.libre_c04 = SUBSTRING(FacCPedi.HorChq,1,8).
    ASSIGN
        REPOSICIONES.Libre_c05 = "Con PGRE"
        REPOSICIONES.Libre_f02 = T-TRACKING.FechaI.
    /* 08/05/2023 */
    FIND gre_header WHERE gre_header.m_coddoc = Faccpedi.coddoc AND
        gre_header.m_nroser = INTEGER(SUBSTRING(Faccpedi.nroped,1,3)) AND
        gre_header.m_nrodoc = INTEGER(SUBSTRING(Faccpedi.nroped,4))
        NO-LOCK NO-ERROR.
    IF AVAILABLE gre_header THEN DO:
        T-TRACKING.FechaI = gre_header.fechaEmisionGuia.
        T-TRACKING.Libre_c04 = gre_header.horaEmisionGuia.
        T-TRACKING.usuario = gre_header.m_usuario.
    END.
END.
...
------------------------------------------------------------------------------*/
  ...
  ASSIGN
      ...
      FILL-IN-FchDoc-2 = TODAY.
  CASE s-Nivel-Acceso:
      WHEN 0 THEN FILL-IN-CodAlm = s-codalm.
  END CASE.
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      CASE s-Nivel-Acceso:
          WHEN 0 THEN ASSIGN FILL-IN-CodAlm:SENSITIVE = NO.
      END CASE.
      /* Motivos */
...
FOR EACH B-REPOSICIONES NO-LOCK WHERE (x-Estado = 'Todos' OR LOOKUP(B-REPOSICIONES.Libre_c05, x-Estado) > 0)
    ...
    ASSIGN
        ...
        FILL-IN-TotVolSol = FILL-IN-TotVolSol + B-REPOSICIONES.TotVolApro
        .
...
chWorkSheet:Range(cRange):Value = "Total m3 Atendido".
