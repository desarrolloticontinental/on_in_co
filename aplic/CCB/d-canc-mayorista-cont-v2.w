...
RECT-10 RECT-6 BUTTON-1 FILL-IN_ImpNac1 FILL-IN_ImpUsa1 FILL-IN_ImpNac4 ~
FILL-IN_ImpUsa4 BUTTON-TpoCmb RADIO-SET_Codmon Btn_OK Btn_Cancel 
...
FILL-IN_ImpNac6 FILL-IN_ImpUsa6 COMBO-BOX_CodBco7 FILL-IN_ImpNac7 ~
FILL-IN_ImpUsa7 FILL-IN_Voucher7 FILL-IN_SaldoAR FILL-IN_ImpNac8 ~
FILL-IN_ImpUsa8 FILL-IN_Voucher8 FILL-IN_CodBco8 FILL-IN-8 FILL-IN_ImpNac9 ~
FILL-IN_ImpUsa9 FILL-IN_Voucher4 FILL-IN_ImpNac10 FILL-IN_ImpUsa10 ~
RADIO-SET_Codmon FILL-IN_VueNac FILL-IN_VueUsa FILL-IN-coddoc ~
...
DEFINE VARIABLE h_t-canc-mayorista-cont-v2 AS HANDLE NO-UNDO.
...
DEFINE VARIABLE COMBO-BOX_CodBco7 AS CHARACTER FORMAT "x(15)" INITIAL "A/R - Efectivo" 
     VIEW-AS COMBO-BOX INNER-LINES 2
     LIST-ITEMS "A/R - Efectivo" 
     DROP-DOWN-LIST
...
DEFINE FRAME D-Dialog
     BUTTON-1 AT ROW 1.38 COL 2 WIDGET-ID 10
     FILL-IN_NomCli AT ROW 1.38 COL 16 COLON-ALIGNED
     ...
     FILL-IN_Voucher4b AT ROW 6.88 COL 42 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     FILL-IN_Voucher4c AT ROW 6.88 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     ...
     COMBO-BOX_CodBco7 AT ROW 9.19 COL 2 HELP
          "C¢digo de auxiliar" NO-LABEL WIDGET-ID 2
     FILL-IN_ImpNac7 AT ROW 9.19 COL 14 COLON-ALIGNED NO-LABEL
...
DEFINE FRAME D-Dialog
     FILL-IN-coddoc AT ROW 14.27 COL 57 COLON-ALIGNED NO-LABEL
     FILL-IN-nrodoc AT ROW 14.27 COL 65 COLON-ALIGNED NO-LABEL
...
ASSIGN 
       FILL-IN_T_Venta:HIDDEN IN FRAME D-Dialog           = TRUE.
...
ON CHOOSE OF BUTTON-1 IN FRAME D-Dialog /* Actualizar */
DO:
  RUN vta2/d-modclimarket (s-codcli).
END.
...
DO:
    ...
    ASSIGN 
        ...
        COMBO-BOX_CodBco7.
    ASSIGN
        x-CodDoc = SUBSTRING (COMBO-BOX_CodBco7, 1, 3).
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'ccb/t-canc-mayorista-cont-v2.w':U ,
             INPUT  FRAME D-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-canc-mayorista-cont-v2 ).
       RUN set-position IN h_t-canc-mayorista-cont-v2 ( 16.96 , 4.00 ) NO-ERROR.
       RUN set-size IN h_t-canc-mayorista-cont-v2 ( 6.50 , 64.00 ) NO-ERROR.
       ...
       /* Links to SmartBrowser h_t-canc-mayorista-cont-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv12 , 'TableIO':U , h_t-canc-mayorista-cont-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_t-canc-mayorista-cont-v2 ,
             h_tab95 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-updv12 ,
             h_t-canc-mayorista-cont-v2 , 'AFTER':U ).
    END. /* Page 2 */
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN_NomCli FILL-IN_MonNac FILL-IN_SaldoNac FILL-IN_MonUSA 
          ...
          FILL-IN_ImpNac6 FILL-IN_ImpUsa6 COMBO-BOX_CodBco7 FILL-IN_ImpNac7 
          FILL-IN_ImpUsa7 FILL-IN_Voucher7 FILL-IN_SaldoAR FILL-IN_ImpNac8 
          FILL-IN_ImpUsa8 FILL-IN_Voucher8 FILL-IN_CodBco8 FILL-IN-8 
          FILL-IN_ImpNac9 FILL-IN_ImpUsa9 FILL-IN_Voucher4 FILL-IN_ImpNac10 
          FILL-IN_ImpUsa10 RADIO-SET_Codmon FILL-IN_VueNac FILL-IN_VueUsa 
          FILL-IN-coddoc FILL-IN-nrodoc FILL-IN_T_Compra 
      WITH FRAME D-Dialog.
  ENABLE RECT-8 RECT-32 RECT-9 RECT-7 RECT-5 RECT-4 RECT-10 RECT-6 BUTTON-1 
         FILL-IN_ImpNac1 FILL-IN_ImpUsa1 FILL-IN_ImpNac4 FILL-IN_ImpUsa4 
         BUTTON-TpoCmb RADIO-SET_Codmon Btn_OK Btn_Cancel 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
/*           STRING(FacCorre.Correlativo, "999999") @ FILL-IN-nrodoc */
          ...
          STRING(FacCorre.Correlativo,ENTRY(2,x-Formato,'-')) @ FILL-IN-nrodoc
