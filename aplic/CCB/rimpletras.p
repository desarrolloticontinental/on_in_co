...
ON END-ERROR OF W-Win /* Impresión de Letras */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Impresión de Letras */
DO:
...
FOR EACH Ccbcdocu NO-LOCK WHERE Ccbcdocu.codcia = s-codcia
    ...
    /* 07/03/2024 Tomar la dirección de la tabla gn-clied (si es que hay dato) */
    FIND FIRST gn-clied WHERE gn-clied.codcia = gn-clie.codcia AND
        gn-clied.codcli = gn-clie.codcli AND
        gn-clied.sede = "@@@"
        NO-LOCK NO-ERROR.
    IF AVAILABLE gn-clied AND gn-clied.dircli > '' THEN w-report.Campo-C[6] = gn-clied.DirCli.
