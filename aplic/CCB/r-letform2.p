...
DO c-Copias = 1 TO s-nro-copias ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE:
    CASE s-salida-impresion:
        WHEN 1 OR WHEN 3 THEN
            OUTPUT TO VALUE(s-print-file) PAGED PAGE-SIZE 24.
        WHEN 2 THEN
            OUTPUT TO PRINTER PAGED PAGE-SIZE 24. /* Impresora */
    END CASE.
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH w-report WHERE
        ...
        PUT
            ...
            SPACE(5)  campo-c[2]  FORMAT "XXXXXXXXXXXX"
            SPACE(6) "LIMA"
            ...
            SKIP(2).
        PUT UNFORMATTED
            SPACE(28) campo-c[4]  SKIP(2)     /* SKIP(1) */
            SPACE(40) campo-c[5]  SKIP
            SPACE(40) campo-c[20] SKIP     /* SKIP(1)*/
            SPACE(40) campo-c[7]  SPACE(20) campo-c[8] SKIP
            SPACE(40) campo-c[21] SPACE(20) campo-c[22] SKIP
            SPACE(35) campo-c[6]  SKIP
            SPACE(35) campo-c[23] SKIP(1).  /* SKIP(1) */
        PUT UNFORMATTED
            SPACE(50) campo-c[9]  SKIP
            SPACE(50) campo-c[13] SKIP
            SPACE(38) campo-c[16] SPACE(20) campo-c[12] SKIP
