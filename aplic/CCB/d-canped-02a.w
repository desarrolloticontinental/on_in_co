...
DEF INPUT  PARAMETER PgoTarjCr2 AS CHARACTER.
DEF OUTPUT PARAMETER OK        AS LOGICAL.

/* Local Variable Definitions ---                                       */
OK = NO.

DEFINE VAR PgoTarjCr AS CHAR.
DEFINE VAR x-es-rappi AS LOG INIT NO.

PgoTarjCr = PgoTarjCr2.
IF NUM-ENTRIES(PgoTarjCr2,"|") > 1 THEN DO:
    PgoTarjCr = ENTRY(1,PgoTarjCr2,"|").
    IF ENTRY(2,PgoTarjCr2,"|") = "RAPPI" THEN x-es-rappi = YES.
END.
...
RECT-10 RECT-6 FILL-IN_ImpUsa1 FILL-IN_ImpNac1 FILL-IN_ImpUsa2 ~
FILL-IN_ImpNac2 FILL-IN_ImpUsa4 FILL-IN_ImpNac4 COMBO-BOX_CodBco5 ~
FILL-IN_Voucher5 COMBO-BOX_CodBco7 FILL-IN_Voucher7 FILL-IN_ImpUsa8 ~
FILL-IN_Voucher8 FILL-IN_CodBco8 FILL-IN_ImpNac8 BUTTON-Vales BUTTON-TpoCmb ~
RADIO-SET_Codmon Btn_OK Btn_Cancel BUTTON-10 
...
FILL-IN_ImpUsa1 FILL-IN_ImpNac1 FILL-IN_ImpUsa2 FILL-IN_Voucher2 ~
FILL-IN_CodBco2 FILL-IN-NroCta FILL-IN_FecPres FILL-IN_ImpNac2 ~
FILL-IN_Voucher4a FILL-IN_Voucher4b FILL-IN_Voucher4c FILL-IN_ImpUsa4 ~
FILL-IN_CodBco4 COMBO_TarjCred FILL-IN-4 FILL-IN_ImpNac4 FILL-IN_Voucher4 ~
COMBO-BOX_CodBco5 FILL-IN_ImpUsa5 FILL-IN_Voucher5 FILL-IN_CodBco5 ~
FILL-IN-5 FILL-IN_SaldoBD FILL-IN_ImpNac5 FILL-IN_ImpUsa6 FILL-IN_ImpNac6 ~
COMBO-BOX_CodBco7 FILL-IN_ImpUsa7 FILL-IN_Voucher7 FILL-IN_SaldoAR ~
FILL-IN_ImpNac7 FILL-IN_ImpUsa8 FILL-IN_Voucher8 FILL-IN_CodBco8 FILL-IN-8 ~
FILL-IN_ImpNac8 FILL-IN_ImpUsa9 FILL-IN_ImpNac9 FILL-IN_ImpUsa10 ~
FILL-IN_ImpNac10 RADIO-SET_Codmon FILL-IN_VueNac FILL-IN_VueUsa ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD valida-deposito D-Dialog 
FUNCTION valida-deposito RETURNS CHARACTER
...
DEFINE VARIABLE COMBO-BOX_CodBco5 AS CHARACTER FORMAT "x(15)" INITIAL "A/R - Efectivo" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEM-PAIRS "Ninguna","Ninguna"
     DROP-DOWN-LIST
     SIZE 15 BY 1 NO-UNDO.

DEFINE VARIABLE COMBO-BOX_CodBco7 AS CHARACTER FORMAT "x(15)" INITIAL "A/R" 
     VIEW-AS COMBO-BOX INNER-LINES 2
     LIST-ITEM-PAIRS "A/R - Efectivo","A/R",
                     "LPA - Letra pre-aceptada","LPA"
     DROP-DOWN-LIST
     SIZE 15 BY 1 NO-UNDO.
...
DEFINE FRAME D-Dialog
     ...
     FILL-IN_ImpNac1 AT ROW 5.38 COL 15 COLON-ALIGNED
     ...
     FILL-IN_ImpNac2 AT ROW 6.15 COL 15 COLON-ALIGNED
     FILL-IN_Voucher4a AT ROW 6.81 COL 37.57 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     FILL-IN_Voucher4b AT ROW 6.81 COL 41.57 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     FILL-IN_Voucher4c AT ROW 6.81 COL 47.57 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     ...
     FILL-IN_ImpNac4 AT ROW 6.92 COL 15.14 COLON-ALIGNED
     FILL-IN_Voucher4 AT ROW 6.92 COL 88.57 COLON-ALIGNED NO-LABEL
     COMBO-BOX_CodBco5 AT ROW 7.65 COL 1.72 HELP
          "C¢digo de auxiliar" NO-LABEL WIDGET-ID 6
     ...
     FILL-IN_ImpNac5 AT ROW 7.69 COL 15 COLON-ALIGNED NO-LABEL
     FILL-IN_ImpUsa6 AT ROW 8.42 COL 26 COLON-ALIGNED NO-LABEL
     FILL-IN_ImpNac6 AT ROW 8.46 COL 15 COLON-ALIGNED
     COMBO-BOX_CodBco7 AT ROW 9.19 COL 1.72 HELP
          "C¢digo de auxiliar" NO-LABEL WIDGET-ID 2
     ...
     FILL-IN_ImpNac7 AT ROW 9.23 COL 15 COLON-ALIGNED NO-LABEL
...
DEFINE FRAME D-Dialog
     ...
     BUTTON-10 AT ROW 17.54 COL 69 WIDGET-ID 4
     "En S/." VIEW-AS TEXT
...
/* SETTINGS FOR COMBO-BOX COMBO-BOX_CodBco5 IN FRAME D-Dialog
   ALIGN-L                                                              */
/* SETTINGS FOR COMBO-BOX COMBO-BOX_CodBco7 IN FRAME D-Dialog
   ALIGN-L                                                              */
...
*** *ML01*/
    ...
    IF FILL-IN_ImpNac4 <> 0 OR FILL-IN_ImpUsa4 <> 0 THEN DO:
        ...
        IF FILL-IN_Voucher4:SCREEN-VALUE EQ "" THEN DO:
            MESSAGE
                "Ingrese el nro de la tarjeta de crédito/debito"
                VIEW-AS ALERT-BOX ERROR.
        ...
        IF COMBO_TarjCred:SCREEN-VALUE EQ ? OR
            ...
            MESSAGE
                "Seleccione una tarjeta de crédito/debito"
                VIEW-AS ALERT-BOX ERROR.
    ...
    /* Pago con Boletas de Depósito, 04Feb2021 - Ventas WhatsApp */
    IF FILL-IN_ImpNac5 <> 0 OR FILL-IN_ImpUsa5 <> 0 THEN DO:

        DEFINE VAR x-retval AS CHAR.
        /*
        /* Validar los documentos de pago */
        x-retval = valida-deposito().
        ...
        */
        ...
        IF COMBO-BOX_CodBco5 = "BD" AND FILL-IN_ImpNac5 > FILL-IN_SaldoBD THEN DO:
            MESSAGE
            ...
            RETURN NO-APPLY.
        END.
        IF COMBO-BOX_CodBco5 = "BD" AND FILL-IN_ImpUsa5 > FILL-IN_SaldoBD THEN DO:
            MESSAGE
                "El monto es mayor al saldo" SKIP
                "de la Boleta de Depósito"
                VIEW-AS ALERT-BOX ERROR.
    ...
    x-tipo = FILL-IN_CodBco5.
    IF COMBO-BOX_CodBco5 <> "BD" THEN DO:
        x-tipo = COMBO-BOX_CodBco5.    
    END.

    CREATE T-CcbCCaja.
    ASSIGN
        T-CcbCCaja.CodBco[4] = FILL-IN_CodBco4
        T-CcbCCaja.CodBco[5] = x-tipo   /* FILL-IN_CodBco5      /* ???????????????????????? */*/
        T-CcbCCaja.CodBco[7] = SUBSTRING(COMBO-BOX_CodBco7,1,3)
...
ON CHOOSE OF BUTTON-10 IN FRAME D-Dialog /* ASIGNACION MULTIPLE */
DO:
    /* RHC 08/0/2019 Bloqueamos si hay al menos una LETra */
    /* RHC 13/11/2019 NINGUNA LETRA PUEDE SER CANCELADA/AMORTIZADA POR UNA N/C */
    IF s-amortiza-letras = NO THEN DO:
        FOR EACH t-Ccbdcaja WHERE t-Ccbdcaja.CodRef = "LET" 
            AND CAN-FIND(FIRST Ccbcdocu WHERE Ccbcdocu.codcia = s-codcia
                         AND Ccbcdocu.coddoc = "LET"
                         AND Ccbcdocu.nrodoc = t-Ccbdcaja.NroRef):
                         /*AND Ccbcdocu.flgubi <> "C" NO-LOCK):*/
            MESSAGE "NO se puede aplicar una N/C a una Letra" /* que no está en cartera" */
                VIEW-AS ALERT-BOX INFORMATION.
            RETURN NO-APPLY.
        END.
    END.
    RUN ccb/gncpendxcliente.
    RUN dispatch IN h_t-dcaja1-02 ('open-query':U).
    RUN proc_total6.
...
&Scoped-define SELF-NAME COMBO-BOX_CodBco5
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL COMBO-BOX_CodBco5 D-Dialog
ON VALUE-CHANGED OF COMBO-BOX_CodBco5 IN FRAME D-Dialog
DO:
  ASSIGN {&self-name}.

  DO WITH FRAME {&FRAME-NAME}:
      IF COMBO-BOX_codbco5 = "Ninguna" THEN DO:
          ASSIGN FILL-IN_ImpNac5 = 0
          FILL-IN_ImpUsa5 = 0
          fill-in_voucher5 = ""
          FILL-IN_ImpNac5:SENSITIVE = NO
          FILL-IN_ImpUsa5:SENSITIVE = NO
          fill-in_voucher5:SENSITIVE = NO.
      END.
      ELSE DO:
          ASSIGN FILL-IN_ImpNac5 = 0
          FILL-IN_ImpUsa5 = 0
          fill-in_voucher5 = ""
          FILL-IN_ImpNac5:SENSITIVE = YES
          FILL-IN_ImpUsa5:SENSITIVE = YES
          fill-in_voucher5:SENSITIVE = YES.
      END.
...
&Scoped-define SELF-NAME COMBO-BOX_CodBco7
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL COMBO-BOX_CodBco7 D-Dialog
ON VALUE-CHANGED OF COMBO-BOX_CodBco7 IN FRAME D-Dialog
DO:
  ASSIGN {&self-name}.
END.
...
ON LEAVE OF FILL-IN_ImpNac4 IN FRAME D-Dialog /* POS (tarjeta) */
DO:
...
DO:
    ...
    ASSIGN FILL-IN_ImpNac5 COMBO-BOX_CodBco5.
    IF COMBO-BOX_CodBco5 = 'BD' AND FILL-IN_ImpNac5 > FILL-IN_SaldoBD THEN DO:
        MESSAGE
...
ON LEAVE OF FILL-IN_ImpNac7 IN FRAME D-Dialog
DO:
...
ON LEAVE OF FILL-IN_ImpNac8 IN FRAME D-Dialog /* RAPPI */
DO:
...
DO:
    ...
    ASSIGN FILL-IN_ImpUsa5 COMBO-BOX_CodBco5.
    IF COMBO-BOX_CodBco5 = 'BD' AND FILL-IN_ImpUsa5 > FILL-IN_SaldoBD THEN DO:
        MESSAGE
            "Este monto es mayor al saldo" SKIP
            "de la boleta de deposito"
...
DO:
    ...
    ASSIGN FILL-IN_Voucher5 COMBO-BOX_CodBco5.
...
/*
    ...
    /*             IF YEAR(TODAY) <> YEAR(Ccbcdocu.FchDoc)            */
    /*                 AND ABS(TODAY - Ccbcdocu.FchDoc) > 90 THEN DO: */
    ...
    ELSE DO:
        ...
        FIND FIRST x-faccpedi WHERE x-faccpedi.codcia = s-codcia AND
                                    ...
                                    x-faccpedi.nroped = FILL-IN_Voucher5 NO-LOCK NO-ERROR.
        IF NOT AVAILABLE x-faccpedi THEN DO:
            MESSAGE "Nro. de Documento COT - " + FILL-IN_Voucher5 + " Registrado no existe"
            VIEW-AS ALERT-BOX INFORMATION.
            RETURN NO-APPLY.
        END.
        IF x-faccpedi.CodCli <> s-CodCli THEN DO:
            MESSAGE "Nro. de Documento COT - " + FILL-IN_Voucher5 + " No pertenece al cliente"
            VIEW-AS ALERT-BOX INFORMATION.
            RETURN NO-APPLY.
        END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN_Voucher5 D-Dialog
ON LEFT-MOUSE-DBLCLICK OF FILL-IN_Voucher5 IN FRAME D-Dialog
OR f8 OF FILL-IN_Voucher5
DO:
    ASSIGN
        input-var-1 = s-CodCli
        input-var-2 = "P"
        input-var-3 = "Autorizada".  
    RUN lkup/c-boldep-03 ("BOLETAS DE DEPOSITO").
...
DO:
    ...
    ASSIGN 
        ...
        COMBO-BOX_CodBco7.
    ASSIGN
        x-CodDoc = SUBSTRING (COMBO-BOX_CodBco7, 1, 3).     /* A/R o LPA */

    IF FILL-IN_Voucher7 <> '' THEN DO:
        CASE TRUE:
            WHEN s-CodCli = FacCfgGn.CliVar THEN DO:    /* Cliente 1111111111 */
                FIND FIRST CcbCDocu WHERE CcbCDocu.CodCia = s-codcia 
                    AND CcbCDocu.CodDiv = s-coddiv 
                    AND CcbCDocu.CodDoc = x-CodDoc 
                    AND CcbCDocu.NroDoc = FILL-IN_Voucher7
                    NO-LOCK NO-ERROR.
            END.
            OTHERWISE DO:   /* Cliente Registrado */
                FIND FIRST CcbCDocu WHERE CcbCDocu.CodCia = s-codcia 
                    AND CcbCDocu.CodDoc = x-CodDoc 
                    AND CcbCDocu.NroDoc = FILL-IN_Voucher7
                    NO-LOCK NO-ERROR.
        ...
        IF NOT AVAILABLE CcbCDocu THEN DO:
            MESSAGE "Anticipo " + COMBO-BOX_codBco7 + "-" + FILL-IN_Voucher7 + " no registrado" VIEW-AS ALERT-BOX ERROR.
            RETURN NO-APPLY.
        END.
        IF CcbCDocu.Codcli <> s-CodCli THEN DO:
            MESSAGE
                "Anticipo " + COMBO-BOX_codBco7 + "-" + FILL-IN_Voucher7 + " no corresponde al cliente"
                VIEW-AS ALERT-BOX ERROR.
            RETURN NO-APPLY.
        END.
        IF CcbCDocu.FlgEst = 'C' THEN DO:
        ...
        IF s-FlgSit = "YES" THEN DO:
            ...
            END.
            /* Dentro del año comercial */
            /*IF YEAR(Ccbcdocu.FchDoc) <> YEAR(TODAY) THEN DO:*/
            IF YEAR(TODAY) <> YEAR(Ccbcdocu.FchDoc)
                AND ABS(TODAY - Ccbcdocu.FchDoc) > 90 THEN DO:
                MESSAGE 'Solo se permiten anticipos dentro del año comercial'
                    VIEW-AS ALERT-BOX ERROR.
                RETURN NO-APPLY.
            END.
        END.
        ...
        ASSIGN
            ...
            COMBO-BOX_CodBco7:SENSITIVE IN FRAME {&FRAME-NAME} = NO.
    ...
    ELSE DO:
        ASSIGN
            FILL-IN_ImpNac7:SENSITIVE = FALSE
            FILL-IN_ImpUsa7:SENSITIVE = FALSE
            COMBO-BOX_CodBco7:SENSITIVE = TRUE
            FILL-IN_SaldoAR:SCREEN-VALUE = ""
            x-SaldoAR = 0
            FILL-IN_ImpNac7 = 0
            FILL-IN_ImpUsa7 = 0.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL FILL-IN_Voucher7 D-Dialog
ON MOUSE-SELECT-DBLCLICK OF FILL-IN_Voucher7 IN FRAME D-Dialog
DO:
    /*
    &SCOPED-DEFINE CONDICION ( CcbCDocu.CodCia = S-CODCIA AND ~
                           CcbCDocu.CodCli = input-var-2 AND ~
                           CcbCDocu.FlgEst BEGINS input-var-3 AND ~
                           CcbCDocu.CodDoc BEGINS input-var-1 )
     */
       ASSIGN 
           FILL-IN_Voucher7 
           COMBO-BOX_CodBco7.
       ...
       ASSIGN
           input-var-1 = COMBO-BOX_CodBco7
           input-var-2 = s-CodCli
           input-var-3 = "P".  
       RUN lkup/C-DOCFLG.W("Documentos (" + COMBO-BOX_CodBco7 + ")").
       IF output-var-1 <> ?  THEN SELF:SCREEN-VALUE = output-var-2.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_r-dcaja1-02 ( 16.96 , 3.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_t-dcaja1-02 ( 16.96 , 3.00 ) NO-ERROR.
       RUN set-size IN h_t-dcaja1-02 ( 6.50 , 66.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 2,
                     ...
                     AddFunction = One-Record':U ,
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 18.88 , 71.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN_NomCli FILL-IN_MonNac FILL-IN_SaldoNac FILL-IN_MonUSA 
          FILL-IN_SaldoUSA FILL-IN_EmiCheq FILL-IN_ImpUsa1 FILL-IN_ImpNac1 
          FILL-IN_ImpUsa2 FILL-IN_Voucher2 FILL-IN_CodBco2 FILL-IN-NroCta 
          FILL-IN_FecPres FILL-IN_ImpNac2 FILL-IN_Voucher4a FILL-IN_Voucher4b 
          FILL-IN_Voucher4c FILL-IN_ImpUsa4 FILL-IN_CodBco4 COMBO_TarjCred 
          FILL-IN-4 FILL-IN_ImpNac4 FILL-IN_Voucher4 COMBO-BOX_CodBco5 
          FILL-IN_ImpUsa5 FILL-IN_Voucher5 FILL-IN_CodBco5 FILL-IN-5 
          FILL-IN_SaldoBD FILL-IN_ImpNac5 FILL-IN_ImpUsa6 FILL-IN_ImpNac6 
          COMBO-BOX_CodBco7 FILL-IN_ImpUsa7 FILL-IN_Voucher7 FILL-IN_SaldoAR 
          FILL-IN_ImpNac7 FILL-IN_ImpUsa8 FILL-IN_Voucher8 FILL-IN_CodBco8 
          FILL-IN-8 FILL-IN_ImpNac8 FILL-IN_ImpUsa9 FILL-IN_ImpNac9 
          FILL-IN_ImpUsa10 FILL-IN_ImpNac10 RADIO-SET_Codmon FILL-IN_VueNac 
  ...
  ENABLE RECT-8 RECT-32 RECT-9 RECT-7 RECT-5 RECT-4 RECT-10 RECT-6 
         FILL-IN_ImpUsa1 FILL-IN_ImpNac1 FILL-IN_ImpUsa2 FILL-IN_ImpNac2 
         FILL-IN_ImpUsa4 FILL-IN_ImpNac4 COMBO-BOX_CodBco5 FILL-IN_Voucher5 
         COMBO-BOX_CodBco7 FILL-IN_Voucher7 FILL-IN_ImpUsa8 FILL-IN_Voucher8 
         FILL-IN_CodBco8 FILL-IN_ImpNac8 BUTTON-Vales BUTTON-TpoCmb 
         RADIO-SET_Codmon Btn_OK Btn_Cancel BUTTON-10 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
    ...
    DO WITH FRAME {&FRAME-NAME}:
        ...
        IF x-es-rappi = YES THEN DO:
            IF Moneda = 1 THEN FILL-IN_ImpNac8 = Importe - Retencion.
            ELSE FILL-IN_ImpUsa8 = Importe - ROUND((Retencion / FILL-IN_T_Venta),2).
        END.
        ELSE DO:
        ...
        IF Contado THEN DO:
            ...
            WHEN "T" THEN DO:
                FILL-IN_ImpNac4 = 0.
                FILL-IN_ImpUSA4 = 0.
                FILL-IN_ImpNac1 = FILL-IN_ImpNac1.
                FILL-IN_ImpUSA1 = FILL-IN_ImpUSA1.
                DISPLAY
                    FILL-IN_ImpNac4
                    FILL-IN_ImpUSA4
                    FILL-IN_ImpNac1
        ...
        */
        ...
        DEFINE VAR x-flag AS LOG INIT NO.

            COMBO-BOX_CodBco5:DELETE(COMBO-BOX_CodBco5:LIST-ITEM-PAIRS).
            COMBO-BOX_CodBco5:ADD-LAST('Ninguna','Ninguna').
            COMBO-BOX_CodBco5:SCREEN-VALUE = 'Ninguna'.
        
        /* Ic - 04Feb2021, documentos de pago - WhatsApp?????? creo que es ventas RAPPI */
        FOR EACH x-vtatabla WHERE x-vtatabla.codcia = s-codcia AND
            ...
            COMBO-BOX_CodBco5:ADD-LAST(TRIM(x-vtatabla.llave_c5), TRIM(x-vtatabla.llave_c4)).
            x-flag = YES.
        END.
        IF x-flag = NO THEN DO:
            /* Todas las divisiones */
            FOR EACH x-vtatabla WHERE x-vtatabla.codcia = s-codcia AND
                                    x-vtatabla.tabla = "CONFIG-VTAS" AND
                                    x-vtatabla.llave_c1 = "DOC.DE.PAGOS" AND
                                    x-vtatabla.llave_c2 = "DIVISION.DOC" AND 
                                    x-vtatabla.llave_c3 = '*' NO-LOCK:
                COMBO-BOX_CodBco5:ADD-LAST(TRIM(x-vtatabla.llave_c5), TRIM(x-vtatabla.llave_c4)).
...
------------------------------------------------------------------------------*/
    ...
    DO ON ERROR UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
        ...
        IF Moneda = 1 THEN
            ASSIGN
                FILL-IN_SaldoNac = Importe
                FILL-IN_SaldoUSA = ROUND(Importe / ROUND(FILL-IN_T_Compra,3),2).
        ELSE
            ASSIGN
                FILL-IN_SaldoNac = ROUND(Importe * ROUND(FILL-IN_T_Venta,3),2)
                FILL-IN_SaldoUSA = Importe.

        DISPLAY
            FILL-IN_SaldoNac
            FILL-IN_SaldoUSA WITH FRAME {&FRAME-NAME}.
...
------------------------------------------------------------------------------*/
    ...
    CASE HANDLE-CAMPO:name:
        ...
        WHEN "FILL-IN_Voucher7" THEN 
            ASSIGN
                /*input-var-1 = 'A/R'*/
                input-var-1 = SUBSTRING(COMBO-BOX_CodBco7,1,3)
                input-var-2 = s-CodCli
                input-var-3 = 'P'.
    END CASE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION valida-deposito D-Dialog 
FUNCTION valida-deposito RETURNS CHARACTER
...
DO WITH FRAME {&FRAME-NAME}:
    IF COMBO-BOX_codBco5 = 'Nunguna' THEN DO:
        x-retval = "Debe elegir un documento de pago, deje vacio ese campo".
        RETURN x-retval.
    END.
    ...
    IF COMBO-BOX_CodBco5 = 'BD' THEN DO:    
        ...
        IF AVAILABLE CcbCDocu THEN DO:
            IF CcbCDocu.FlgEst = "C" THEN DO:
                x-retval = "Boleta Deposito Nro." + CcbCDocu.nrodoc + " esta cancelado".
                RETURN x-retval.
            END.
            IF CcbCDocu.FlgEst <> "P" THEN DO:
                x-retval = "Boleta Deposito Nro." + CcbCDocu.nrodoc + " no esta aprobada".
                RETURN x-retval.
            END.
            IF CcbCDocu.CodMon = 1 THEN DO:
                ASSIGN
            ...
            IF s-FlgSit = "YES" THEN DO:
                IF s-CodCli = FacCfgGn.CliVar THEN DO:
                    x-retval = 'NO procede para clientes' + FacCfgGn.CliVar.
                    RETURN x-retval.
                END.
                /* Dentro del año comercial */
    /*             IF YEAR(TODAY) <> YEAR(Ccbcdocu.FchDoc)            */
    /*                 AND ABS(TODAY - Ccbcdocu.FchDoc) > 90 THEN DO: */
                IF Ccbcdoc.FchDoc < ADD-INTERVAL(TODAY,-1,'years') THEN DO:
                    x-retval = 'Solo se permiten boletas de depósito dentro del año comercial'.
                    RETURN x-retval.
                END.
            END.
            /* ********************************************* */
        ...
        END.
        ELSE DO:
            x-retval = 'Nro. de Documento no Registrado o no pertenece al Cliente Seleccionado'.
            RETURN x-retval.
        END.
    END.
    ELSE DO:
        ...
        FIND FIRST x-faccpedi WHERE x-faccpedi.codcia = s-codcia AND
                                    ...
                                    x-faccpedi.nroped = FILL-IN_Voucher5 NO-LOCK NO-ERROR.
        IF NOT AVAILABLE x-faccpedi THEN DO:
            x-retval =  "Nro. de pedido comercial - " + FILL-IN_Voucher5 + " no existe".
            RETURN x-retval.
        END.
        IF x-faccpedi.CodCli <> s-CodCli THEN DO:
            x-retval = "Nro. de pedido comercial - " + FILL-IN_Voucher5 + " No pertenece al cliente".
            RETURN x-retval.
        END.
        ASSIGN
            FILL-IN_ImpNac5 = 0
