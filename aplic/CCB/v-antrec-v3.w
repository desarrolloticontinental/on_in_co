...
CcbCCaja.ImpUsa[4] CcbCCaja.CodBco[4] CcbCCaja.ImpNac[3] 
...
CcbCCaja.CodCli CcbCCaja.TpoCmb CcbCCaja.Codcta[10] CcbCCaja.Glosa ~
CcbCCaja.ImpNac[1] CcbCCaja.ImpUsa[1] CcbCCaja.ImpNac[4] CcbCCaja.ImpUsa[4] ~
CcbCCaja.CodBco[4] CcbCCaja.FchDoc CcbCCaja.usuario CcbCCaja.ImpNac[3] 
&Scoped-define DISPLAYED-TABLES CcbCCaja
&Scoped-define FIRST-DISPLAYED-TABLE CcbCCaja
&Scoped-Define DISPLAYED-OBJECTS F-NroDoc FILL-IN_Voucher4a ~
FILL-IN_Voucher4b FILL-IN_Voucher4c COMBO_TarjCred FILL-IN-4 F-NomDiv ~
X-Status F-Descli x-Nombr fSumSol fSumDol FILL-IN_Voucher4 
...
DEFINE VARIABLE moneda AS CHARACTER FORMAT "X(256)":U INITIAL "S/." 
     LABEL "Moneda" 
...
DEFINE FRAME F-Main
     CcbCCaja.NroDoc AT ROW 1.23 COL 10 COLON-ALIGNED FORMAT "XXX-XXXXXXXX"
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .81
          FONT 6
     ...
     CcbCCaja.ImpNac[1] AT ROW 10.54 COL 15.43 COLON-ALIGNED
          LABEL "Efectivo" FORMAT ">>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 0 
     CcbCCaja.ImpUsa[1] AT ROW 10.54 COL 28.14 COLON-ALIGNED NO-LABEL FORMAT ">>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 0 
     CcbCCaja.ImpNac[4] AT ROW 11.38 COL 15.43 COLON-ALIGNED WIDGET-ID 2
          LABEL "Pago con tarjeta" FORMAT ">>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 0 
     CcbCCaja.ImpUsa[4] AT ROW 11.38 COL 28.14 COLON-ALIGNED NO-LABEL WIDGET-ID 4 FORMAT ">>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
          BGCOLOR 11 FGCOLOR 0 
     FILL-IN_Voucher4a AT ROW 11.35 COL 41.14 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     FILL-IN_Voucher4b AT ROW 11.35 COL 45.14 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     FILL-IN_Voucher4c AT ROW 11.35 COL 51.14 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     CcbCCaja.CodBco[4] AT ROW 11.35 COL 59.14 COLON-ALIGNED NO-LABEL WIDGET-ID 32
          VIEW-AS FILL-IN 
          SIZE 5 BY .81
     COMBO_TarjCred AT ROW 11.35 COL 66.14 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     FILL-IN-4 AT ROW 11.35 COL 84.14 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     ...
     CcbCCaja.FchDoc AT ROW 2.08 COL 79 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
     F-Descli AT ROW 2.88 COL 21.86 COLON-ALIGNED NO-LABEL
     CcbCCaja.usuario AT ROW 2.88 COL 79 COLON-ALIGNED
          LABEL "Usuario"
          VIEW-AS FILL-IN 
          SIZE 11 BY .81
     x-Nombr AT ROW 4.5 COL 19 COLON-ALIGNED NO-LABEL
     fSumSol AT ROW 14.46 COL 14 COLON-ALIGNED WIDGET-ID 46
     fSumDol AT ROW 14.46 COL 28.14 COLON-ALIGNED NO-LABEL WIDGET-ID 48
     FILL-IN_Voucher4 AT ROW 14.46 COL 66.14 COLON-ALIGNED WIDGET-ID 44
     CcbCCaja.ImpNac[3] AT ROW 12.31 COL 15.43 COLON-ALIGNED WIDGET-ID 74
          LABEL "Billetera electronica" FORMAT ">>>,>>9.99"
          VIEW-AS FILL-IN 
          SIZE 10.57 BY .81
          BGCOLOR 11 
     "  Modalidades de pago" VIEW-AS TEXT
          SIZE 30 BY .88 AT ROW 8.42 COL 34.14 WIDGET-ID 72
          FGCOLOR 9 FONT 11
...
DEFINE FRAME F-Main
     ...
     "En S/." VIEW-AS TEXT
          SIZE 5 BY .5 AT ROW 9.73 COL 19 WIDGET-ID 24
     "Nro. Cta. Cte./Referencia" VIEW-AS TEXT
          SIZE 17.29 BY .5 AT ROW 9.73 COL 68.14 WIDGET-ID 30
     "F.Presen" VIEW-AS TEXT
          SIZE 8 BY .5 AT ROW 9.73 COL 86 WIDGET-ID 22
     "Numero Documento" VIEW-AS TEXT
          SIZE 15 BY .5 AT ROW 9.77 COL 43 WIDGET-ID 28
     "Banco" VIEW-AS TEXT
          SIZE 5 BY .5 AT ROW 9.77 COL 60.57 WIDGET-ID 20
     "En US$" VIEW-AS TEXT
          SIZE 6 BY .5 AT ROW 9.73 COL 31.14 WIDGET-ID 26
     RECT-6 AT ROW 9.46 COL 3 WIDGET-ID 18
     RECT-33 AT ROW 9.46 COL 3 WIDGET-ID 34
     RECT-34 AT ROW 9.46 COL 29 WIDGET-ID 36
     RECT-35 AT ROW 9.46 COL 42.14 WIDGET-ID 38
     RECT-36 AT ROW 9.46 COL 60.14 WIDGET-ID 40
     RECT-37 AT ROW 9.46 COL 67.14 WIDGET-ID 42
     RECT-39 AT ROW 14.19 COL 3 WIDGET-ID 50
     RECT-40 AT ROW 14.15 COL 29 WIDGET-ID 52
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE 
         FONT 4.
...
DO:
    ...
    APPLY "VALUE-CHANGED":U TO moneda.
END.
...
DO:
    ...
    IF DECI(ccbccaja.impnac[4]:SCREEN-VALUE) > 0 OR DECI(ccbccaja.impusa[4]:SCREEN-VALUE) > 0 THEN DO:
...
&Scoped-define SELF-NAME CcbCCaja.ImpNac[3]
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL CcbCCaja.ImpNac[3] V-table-Win
ON LEAVE OF CcbCCaja.ImpNac[3] IN FRAME F-Main /* Billetera electronica */
DO:
  RUN Calculo.
END.
...
ON LEAVE OF CcbCCaja.ImpNac[4] IN FRAME F-Main /* Pago con tarjeta */
DO:
    /*
...
DO:
    DO WITH FRAME {&FRAME-NAME}:
        ...
        IF Y-CodMon = 1 THEN DO:       
            ...
            CcbCcaja.ImpNac[3]:SENSITIVE = YES.     /* billetera electronica */
        ...
        IF Y-CodMon = 2 THEN DO:
            ...
            DISPLAY 0 @ CcbCcaja.ImpNac[3].     /* billetera electronica */
            ...
            CcbCcaja.ImpNac[3]:SENSITIVE = NO.  /* billetera electronica */
        END.
        RUN Calculo.
    END.
END.
...
DO WITH FRAME {&FRAME-NAME}:
    fSumSol = DECIMAL(CcbCCaja.ImpNac[1]:SCREEN-VALUE) + DECIMAL(CcbCCaja.ImpNac[4]:SCREEN-VALUE) + 
                DECIMAL(CcbCCaja.ImpNac[3]:SCREEN-VALUE).
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    IF Y-CodMon = 2 THEN DO:
        ASSIGN
            CcbCDocu.ImpTot = CcbCcaja.ImpUsa[1] + CcbCcaja.ImpUsa[4] .
            CcbCDocu.SdoAct =  CcbCcaja.ImpUsa[1] + CcbCcaja.ImpUsa[4] .
    END.
    IF Y-CodMon = 1 THEN DO:
        ASSIGN
            CcbCDocu.ImpTot = CcbCcaja.ImpNac[1] + CcbCcaja.ImpNac[4] + ccbccaja.ImpNac[3]. /* Billetera electronica */
            CcbCDocu.SdoAct = CcbCcaja.ImpNac[1] + CcbCcaja.ImpNac[4] + ccbccaja.ImpNac[3]. /* Billetera electronica */
    END.
END.
RETURN 'OK'.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      IF lookup(s-coddiv,'10015,10060,10067,10065') > 0 THEN DO:
          DISPLAY '002' @ ccbccaja.codcta[10].
      END.
  END.
...
/*------------------------------------------------------------------------------
  Purpose:     Override standard ADM method
  Notes:       SOLO SE PUEDE CREAR
                No hay acceso a modificar
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      ASSIGN
          ...
          CcbCCaja.ImpNac[4] = DECI(CcbCCaja.ImpNac[4]:SCREEN-VALUE)
          CcbCCaja.ImpUsa[4] = DECI(CcbCCaja.ImpUsa[4]:SCREEN-VALUE)
          ccbccaja.ImpNac[3] = DECI(ccbccaja.ImpNac[3]:SCREEN-VALUE)  /* Billetera electronica */
          CcbcCaja.Flgest    = "C"
      ...
      IF Y-CodMon = 1 THEN DO:
          CcbDCaja.ImpTot = CcbCCaja.ImpNac[1] + CcbCCaja.ImpNac[4] + CcbCCaja.ImpNac[5] + ccbccaja.ImpNac[3].    /* Billetera electronica */
      END.
      IF Y-CodMon = 2 THEN DO:
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE CcbCCaja THEN DO WITH FRAME {&FRAME-NAME}:
      ...
      ccbccaja.impusa[4]:VISIBLE = YES.
      ccbccaja.impnac[4]:VISIBLE = YES.

      FILL-IN_voucher4a:VISIBLE = YES.
      FILL-IN_voucher4b:VISIBLE = YES.
      FILL-IN_voucher4c:VISIBLE = YES.
      ccbccaja.codbco[4]:VISIBLE = YES.
      combo_tarjcred:VISIBLE = YES.
      ccbccaja.impnac[3]:VISIBLE = YES.     /* Billetera electronica */
      ...
      IF CcbCCaja.ImpNac[1] + CcbCCaja.ImpNac[4] + CcbCCaja.ImpNac[5] + ccbccaja.impnac[3] <> 0 THEN DO:    /* Billetera electronica */
          moneda = "S/.".
      END.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
      ...
      ccbccaja.impnac[4]:VISIBLE = NO.
      ccbccaja.impusa[4]:VISIBLE = NO.
      
      FILL-IN_voucher4a:VISIBLE = NO.
      FILL-IN_voucher4b:VISIBLE = NO.
      FILL-IN_voucher4c:VISIBLE = NO.
      ccbccaja.codbco[4]:VISIBLE = NO.
      combo_tarjcred:VISIBLE = NO.
      ccbccaja.impnac[3]:VISIBLE = NO.      /* Billetera electronica */
      fill-in-4:VISIBLE = NO.

      /*
        Modalidades de pago para expolibreria  
        Codigo duro autorizado por Daniel Llican 
      */
      IF lookup(s-coddiv,'10015,10060,10065,10067') > 0 THEN DO:      
          ...
          ccbccaja.impnac[4]:SENSITIVE = YES.
          FILL-IN_voucher4a:SENSITIVE = YES.
          FILL-IN_voucher4b:SENSITIVE = YES.
          FILL-IN_voucher4c:SENSITIVE = YES.
          ccbccaja.codbco[4]:SENSITIVE = YES.
          combo_tarjcred:SENSITIVE = YES.
          fill-in-4:SENSITIVE = YES.    
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME} :
      ...
      IF DECI(CcbCCaja.ImpNac[1]:SCREEN-VALUE) + 
          ...
          DECI(ccbccaja.ImpNac[3]:SCREEN-VALUE) +   /* Billetera electronica */
          DECI(CcbCCaja.ImpUsa[4]:SCREEN-VALUE) = 0
          THEN DO:
