...
FIND FIRST x-faccpedi WHERE x-faccpedi.codcia = 1 AND x-faccpedi.coddoc = 'PED' AND 
                        x-faccpedi.nroped = x-ccbcdocu.nroped NO-LOCK NO-ERROR.
IF AVAILABLE x-faccpedi THEN DO:
    cNroCotizacion = x-faccpedi.nroref.
END.
FIND FIRST x-faccpedi WHERE x-faccpedi.codcia = 1 AND x-faccpedi.coddoc = 'COT' AND 
                        x-faccpedi.nroped = cNroCotizacion NO-LOCK NO-ERROR.
IF AVAILABLE x-faccpedi THEN DO:
...
{sunat/sunat-calculo-importes-calcular.i ~
