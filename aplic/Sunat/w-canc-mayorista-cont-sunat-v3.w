...
DEFINE VARIABLE h_b-canc-mayorista-cont-sunat-v3 AS HANDLE NO-UNDO.
...
DO:
    ...
    RUN proc_CanPed IN h_b-canc-mayorista-cont-sunat-v3.
    RUN dispatch IN h_b-canc-mayorista-cont-sunat-v3 ('open-query':U).
...
DO:
    RUN dispatch IN h_b-canc-mayorista-cont-sunat-v3 ('open-query-cases':U).
    RUN proc_CalTot IN h_b-canc-mayorista-cont-sunat-v3.
END.
...
&IF {&ARITMETICA-SUNAT} &THEN
    {&WINDOW-NAME}:TITLE = 'CANCELACION DE PEDIDOS PENDIENTES - SUNAT'.
&ELSE
    {&WINDOW-NAME}:TITLE = 'CANCELACION DE PEDIDOS PENDIENTES'.
&ENDIF
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'Sunat/b-canc-mayorista-cont-sunat-v3.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Hora':U ,
             OUTPUT h_b-canc-mayorista-cont-sunat-v3 ).
       RUN set-position IN h_b-canc-mayorista-cont-sunat-v3 ( 1.27 , 2.00 ) NO-ERROR.
       RUN set-size IN h_b-canc-mayorista-cont-sunat-v3 ( 15.77 , 86.00 ) NO-ERROR.

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b-canc-mayorista-cont-sunat-v3 ,
