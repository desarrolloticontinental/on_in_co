...
DEFINE TEMP-TABLE tt-DI-RutaC NO-UNDO LIKE DI-RutaC
       FIELD Libre_d06 AS dec /* Volumen */
       FIELD Libre_d07 AS INT /* Ptos Entrega */
       FIELD Libre_d08 AS INT /* Items sin chequear */
       field importe as dec init 0
       field bultos as int init 0
       field clientes as int init 0.
...
fEstado() @ x-Estado tt-DI-RutaC.Libre_d04 @ x-Peso ~
tt-DI-RutaC.importe @ x-Importe tt-DI-RutaC.Libre_d06 @ x-Volumen ~
tt-di-rutaC.clientes @ x-Clientes tt-di-rutac.libre_d07 @ x-ptos-entrega ~
tt-DI-RutaC.bultos @ x-Bultos tt-DI-RutaC.Libre_d05 @ x-SKU ~
tt-DI-RutaC.Libre_d08 @ x-SKUnochk DI-RutaC.Observ DI-RutaC.Libre_d01 ~
DI-RutaC.Libre_d02 DI-RutaC.Libre_d03 DI-RutaC.Libre_c05 DI-RutaC.Libre_f05 ~
DI-RutaC.Libre_c04 DI-RutaC.CodCob 
...
FILL-IN-Hasta FILL-IN-bultos FILL-IN-skus FILL-IN-SKUnochk FILL-IN-peso ~
...
DEFINE VARIABLE FILL-IN-bultos AS DECIMAL FORMAT ">,>>>,>>9":U INITIAL 0 
      VIEW-AS TEXT 
     SIZE 9 BY .62
     FGCOLOR 9  NO-UNDO.
...
DEFINE VARIABLE FILL-IN-SKUnochk AS DECIMAL FORMAT ">,>>>,>>9":U INITIAL 0 
      VIEW-AS TEXT 
     SIZE 9 BY .62
     FGCOLOR 9  NO-UNDO.

DEFINE VARIABLE FILL-IN-skus AS DECIMAL FORMAT ">,>>>,>>9":U INITIAL 0 
      VIEW-AS TEXT 
     SIZE 9 BY .62
     FGCOLOR 9  NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      fEstado() @ x-Estado COLUMN-LABEL "Estado" FORMAT "x(15)":U
            WIDTH 13.86
      tt-DI-RutaC.Libre_d04 @ x-Peso COLUMN-LABEL "Peso" FORMAT ">>,>>>,>>9.99":U
      tt-DI-RutaC.importe @ x-Importe COLUMN-LABEL "Importe" FORMAT ">>,>>>,>>9.99":U
      tt-DI-RutaC.Libre_d06 @ x-Volumen COLUMN-LABEL "Volumen" FORMAT ">>,>>>,>>9.99":U
      tt-di-rutaC.clientes @ x-Clientes COLUMN-LABEL "Clientes" FORMAT ">>,>>9":U
      tt-di-rutac.libre_d07 @ x-ptos-entrega COLUMN-LABEL "Ptos!Entrega" FORMAT "->,>>9":U
      tt-DI-RutaC.bultos @ x-Bultos COLUMN-LABEL "Bultos" FORMAT ">,>>>,>>9":U
      tt-DI-RutaC.Libre_d05 @ x-SKU COLUMN-LABEL "SKUs" FORMAT ">,>>>,>>9":U
            WIDTH 8.57
      tt-DI-RutaC.Libre_d08 @ x-SKUnochk COLUMN-LABEL "SKUs!No Cheq." FORMAT ">,>>>,>>9":U
            WIDTH 8.43
...
DEFINE FRAME F-Main
     ...
     br_table AT ROW 3.96 COL 1.14
     FILL-IN-bultos AT ROW 10.65 COL 80.86 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     FILL-IN-skus AT ROW 10.65 COL 90 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     FILL-IN-SKUnochk AT ROW 10.65 COL 99.29 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     FILL-IN-peso AT ROW 10.73 COL 34.14 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     FILL-IN-importe AT ROW 10.73 COL 46.14 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     FILL-IN-volumen AT ROW 10.73 COL 58.72 COLON-ALIGNED NO-LABEL WIDGET-ID 20
...
"tt-DI-RutaC.Libre_d04 @ x-Peso" "Peso" ">>,>>>,>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > "_<CALC>"
"tt-DI-RutaC.importe @ x-Importe" "Importe" ">>,>>>,>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > "_<CALC>"
"tt-DI-RutaC.Libre_d06 @ x-Volumen" "Volumen" ">>,>>>,>>9.99" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"tt-di-rutaC.clientes @ x-Clientes" "Clientes" ">>,>>9" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > "_<CALC>"
"tt-di-rutac.libre_d07 @ x-ptos-entrega" "Ptos!Entrega" "->,>>9" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > "_<CALC>"
"tt-DI-RutaC.bultos @ x-Bultos" "Bultos" ">,>>>,>>9" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > "_<CALC>"
"tt-DI-RutaC.Libre_d05 @ x-SKU" "SKUs" ">,>>>,>>9" ? ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > "_<CALC>"
"tt-DI-RutaC.Libre_d08 @ x-SKUnochk" "SKUs!No Cheq." ">,>>>,>>9" ? ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > INTEGRAL.DI-RutaC.Observ
"DI-RutaC.Observ" "Glosa" "x(40)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > INTEGRAL.DI-RutaC.Libre_d01
"DI-RutaC.Libre_d01" "Clientes Máximo" ">>>,>>9" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > INTEGRAL.DI-RutaC.Libre_d02
"DI-RutaC.Libre_d02" "Peso Máximo" ">>>,>>9.99" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > INTEGRAL.DI-RutaC.Libre_d03
"DI-RutaC.Libre_d03" "Volumen Máximo" ">>>,>>9.99" "decimal" 11 0 ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > INTEGRAL.DI-RutaC.Libre_c05
"DI-RutaC.Libre_c05" "Usuario Modifición" "x(10)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[17]   > INTEGRAL.DI-RutaC.Libre_f05
"DI-RutaC.Libre_f05" "Fecha Modificación" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   > INTEGRAL.DI-RutaC.Libre_c04
"DI-RutaC.Libre_c04" "Glosa de Anulación" "x(30)" "character" 2 15 ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[19]   > INTEGRAL.DI-RutaC.CodCob
...
DO:
    ...
    RUN refrescar-detalle IN lh_handle(INPUT x-rowid).
...
DO:
  ...
  DO k = 1 TO {&BROWSE-NAME}:NUM-SELECTED-ROWS:
      IF {&BROWSE-NAME}:FETCH-SELECTED-ROW(k) THEN 
          ASSIGN
          FILL-IN-Peso = FILL-IN-Peso + tt-DI-RutaC.Libre_d04
          FILL-IN-Volumen = FILL-IN-Volumen + tt-DI-RutaC.Libre_d06
          FILL-IN-Importe = FILL-IN-Importe + tt-DI-RutaC.importe
          FILL-IN-Bultos = FILL-IN-Bultos + tt-DI-RutaC.bultos
...
DO:
  ...
  APPLY "ENTRY" TO br_table IN FRAME {&FRAME-NAME}.
...
ON FIND OF di-rutaC DO:
    ...
    IF NOT AVAILABLE tt-di-rutaC THEN DO:
        ...
        ASSIGN 
            ...
            tt-di-rutaC.libre_d08 = 0       /* SKUs pendientes */
            tt-di-rutaC.libre_d04 = 0       /* Peso */
            tt-di-rutaC.libre_d05 = 0       /* Item */
            tt-di-rutaC.libre_d06 = 0       /* Volumen */
            tt-di-rutaC.importe = 0       /* Importe */
            tt-di-rutaC.bultos = 0       /* Bultos */
            tt-di-rutaC.clientes = fClientes()       /* clientes */
            .
        ...
        FOR EACH Di-RutaD OF Di-RutaC NO-LOCK ,
            ...
            */
            ...
            END.
            /* Ic - 23Mar2022, Fernan adiciono SKUs y SKUs pendientes  */
            ...
            END.
            ASSIGN tt-Di-Rutac.Libre_d04 = tt-Di-Rutac.Libre_d04 + Faccpedi.Peso
            tt-Di-Rutac.Libre_d06 = tt-Di-Rutac.Libre_d06 + Faccpedi.Volumen
            tt-Di-Rutac.Libre_d05 = tt-Di-Rutac.Libre_d05 + Faccpedi.Items
            tt-Di-RutaC.importe = tt-Di-RutaC.importe + Faccpedi.AcuBon[8] /*fImporte()*/.
            tt-Di-Rutac.bultos = tt-Di-Rutac.bultos + Faccpedi.AcuBon[9].
...
GET FIRST br_table.
DO WHILE AVAILABLE DI-RutaC :   /*NOT QUERY-OFF-END('br_table'):*/
    CREATE T-RutaC.
    BUFFER-COPY DI-RutaC TO T-RutaC.
    ASSIGN
        T-RutaC.Libre_d01 = tt-DI-RutaC.Libre_d04
        T-RutaC.Libre_d06 = tt-DI-RutaC.Libre_d06
        T-RutaC.Libre_d02 = tt-DI-RutaC.importe
        T-RutaC.Libre_d03 = tt-DI-RutaC.clientes
...
/* Capturamos el Excel */
SESSION:SET-WAIT-STATE('GENERAL').
RUN Captura-Temporal IN lh_handle (rowid(Di-RutaC), INPUT-OUTPUT TABLE T-RUTAD).
