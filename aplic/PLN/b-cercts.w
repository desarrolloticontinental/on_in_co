...
FIND FIRST VtaTabla WHERE Vtatabla.codcia = s-codcia AND
    Vtatabla.tabla = "CFG_RRHH_Certificado_CTS"
    NO-LOCK NO-ERROR.
...
IF cPlantilla = ? THEN DO:
    MESSAGE 'No se encontró la plantilla' cNomPlantilla 'en la carpeta' x-Ruta
...
x_archivo = x-Ruta + "CertCTSCONTI" + pl-pers.codper.
