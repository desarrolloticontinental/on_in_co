...
&SCOPED-DEFINE l-lookup h_lt-asistentes
...
DEFINE VARIABLE h_lt-asistentes AS HANDLE NO-UNDO.

/* Definitions of the field level widgets                               */
DEFINE BUTTON Btn_Cancel AUTO-END-KEY 
     IMAGE-UP FILE "32x32/cancel32.jpg":U NO-FOCUS FLAT-BUTTON
     LABEL "&Cancelar" 
     SIZE 6 BY 1.54 TOOLTIP "Cancelar"
     BGCOLOR 8 .

DEFINE BUTTON Btn_OK AUTO-GO 
     IMAGE-UP FILE "32x32/check_box32.jpg":U NO-FOCUS FLAT-BUTTON
     LABEL "&Aceptar" 
     SIZE 6 BY 1.73 TOOLTIP "Aceptar"
     BGCOLOR 8 .
...
DEFINE FRAME C-Dialog
     Btn_Cancel AT ROW 3.12 COL 70
     Btn_OK AT ROW 1.19 COL 70
     SPACE(1.85) SKIP(9.45)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtaexp/lt-asistentes.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_lt-asistentes ).
       RUN set-position IN h_lt-asistentes ( 1.00 , 1.00 ) NO-ERROR.
       RUN set-size IN h_lt-asistentes ( 10.92 , 68.00 ) NO-ERROR.
