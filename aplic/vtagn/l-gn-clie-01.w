...
&SCOPED-DEFINE CONDICION ( gn-clie.CodCia = cl-CODCIA ~
AND gn-clie.flgsit = 'A' ~
AND gn-clie.canal BEGINS input-var-1  )
...
&Scoped-define FIELDS-IN-QUERY-br_table gn-clie.NomCli gn-clie.CodCli 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table gn-clie.CodCli 
&Scoped-define ENABLED-TABLES-IN-QUERY-br_table gn-clie
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br_table gn-clie
&Scoped-define QUERY-STRING-br_table FOR EACH gn-clie WHERE ~{&KEY-PHRASE} ~
...
<SORTBY-OPTIONS>
Codigo|y||integral.gn-clie.CodCia|yes,integral.gn-clie.CodCli|yes
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table L-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      gn-clie.CodCli FORMAT "x(13)":U
  ENABLE
      gn-clie.CodCli
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 59.14 BY 13.19
...
DEFINE FRAME F-Main
     br_table AT ROW 3.04 COL 1.86
     FILL-IN-codigo AT ROW 1.15 COL 20.57 COLON-ALIGNED
     CMB-filtro AT ROW 2.08 COL 1.86 NO-LABEL
     FILL-IN-filtro AT ROW 2.12 COL 22.57 NO-LABEL
     "Buscar x :" VIEW-AS TEXT
          SIZE 8.14 BY .54 AT ROW 1.35 COL 7.43
          FONT 6
     RECT-1 AT ROW 1.08 COL 1.14
...
ASSIGN 
       br_table:MAX-DATA-GUESS IN FRAME F-Main         = 140.
...
/* Query rebuild information for BROWSE br_table
     ...
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   > integral.gn-clie.NomCli
"gn-clie.NomCli" ? "x(60)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > integral.gn-clie.CodCli
"gn-clie.CodCli" ? "x(13)" "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Codigo':U THEN DO:
           &Scope SORTBY-PHRASE BY gn-clie.CodCia BY gn-clie.CodCli
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.codcli
