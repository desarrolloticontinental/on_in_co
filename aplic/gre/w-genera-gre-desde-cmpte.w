...
DEFINE FRAME F-Main
     ...
     BUTTON-generar-pre-gre AT ROW 20.92 COL 2 WIDGET-ID 6
     BUTTON-Invalidar AT ROW 20.92 COL 25 WIDGET-ID 18
     BUTTON-est-sunat AT ROW 21.19 COL 65 WIDGET-ID 4
     BUTTON-NO-generar-pre-gre AT ROW 21.19 COL 88 WIDGET-ID 16
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 121.14 BY 21.46 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_b-genera-gre-desde-cmpte ( 18.31 , 117.86 ) NO-ERROR.
