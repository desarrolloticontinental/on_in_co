...
<<<<<<< .mine
<<<<<<< .mine
  RUN lib/p-write-log-txt.p("P-CODIGO-PRODUCTO",pCodMat + " buscar en Almmmat1").
  DO x-Item = 1 TO 6:
      /*
      FIND FIRST Almmmat1 WHERE Almmmat1.codcia = s-CodCia 
      ...
      END.
      */
    FIND FIRST Almmmat1 WHERE Almmmat1.Barras[x-Item] = pCodMat NO-LOCK NO-ERROR.
      IF AVAILABLE Almmmat1 THEN DO:
          FIND FIRST Almmmatg OF almmmat1 WHERE Almmmatg.TpoArt = 'A' NO-LOCK NO-ERROR.
          IF AVAILABLE almmmatg THEN DO:
              RUN lib/p-write-log-txt.p("P-CODIGO-PRODUCTO",pCodMat + " OK " + Almmmat1.CodMat).
              pCodMat = Almmmat1.CodMat.
              RETURN 'OK'.
          END.
      END.      
...
<<<<<<< .mine
<<<<<<< .mine
  RUN lib/p-write-log-txt.p("P-CODIGO-PRODUCTO",pCodMat + " buscar en Almmmat1 - FIN").
||||||| .r1409
