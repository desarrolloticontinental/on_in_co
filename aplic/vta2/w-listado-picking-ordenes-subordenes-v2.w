...
BUTTON-16 RADIO-SET-CodDoc txtDesde txtHasta txtOrdenCompra rsSectores ~
txtOrden BUTTON-13 txtCliente cboCanal BROWSE-5 BUTTON-15 BtnDone BUTTON-17 ~
...
txtCliente cboCanal txtSectores txtSectoresImprimir txtLeyenda ~
txtArtSinPeso 
...
DEFINE FRAME F-Main
     ...
     BUTTON-16 AT ROW 4.77 COL 79 WIDGET-ID 96
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME Custom                                                    */
/* BROWSE-TAB BROWSE-5 cboCanal F-Main */
...
DO:
  ...
  ASSIGN txtCliente cboCanal .

  RUN filtar-datos IN h_b-picking-ordenes-todos(txtCliente, cboCanal).
  RUN muestra-totales IN h_b-picking-ordenes-todos.
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-dias rdsMostrar rdsPickeado RADIO-SET-CodDoc txtDesde txtHasta 
          txtOrdenCompra rsSectores txtOrden txtCliente cboCanal txtSectores 
          txtSectoresImprimir txtLeyenda txtArtSinPeso 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE FILL-IN-dias rdsMostrar rdsPickeado BUTTON-16 RADIO-SET-CodDoc 
         txtDesde txtHasta txtOrdenCompra rsSectores txtOrden BUTTON-13 
         txtCliente cboCanal BROWSE-5 BUTTON-15 BtnDone BUTTON-17 RECT-2 RECT-4 
         RECT-5 
      WITH FRAME F-Main IN WINDOW W-Win.
