...
PEDI.UndVta PEDI.CanPed PEDI.canate 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table PEDI.canate 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      PEDI.UndVta COLUMN-LABEL "Unidad" FORMAT "x(8)":U WIDTH 5.43
      PEDI.CanPed COLUMN-LABEL "Cantidad!Actual OD" FORMAT ">,>>>,>>9.9999":U
            WIDTH 12.43 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 14 LABEL-FGCOLOR 0 LABEL-BGCOLOR 14
      PEDI.canate COLUMN-LABEL "Cantidad para la!Nueva OD" FORMAT ">,>>>,>>9.9999":U
            WIDTH 10.72 COLUMN-FGCOLOR 0 COLUMN-BGCOLOR 11 LABEL-FGCOLOR 0 LABEL-BGCOLOR 11
  ENABLE
      PEDI.canate
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"PEDI.UndVta" "Unidad" ? "character" ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.PEDI.CanPed
"PEDI.CanPed" "Cantidad!Actual OD" ? "decimal" 14 0 ? 14 0 ? no ? no no "12.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.PEDI.canate
"PEDI.canate" "Cantidad para la!Nueva OD" ? "decimal" 11 0 ? 11 0 ? yes ? no no "10.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
  RUN Procesa-Handle IN lh_handle ('Enable-All').
...
------------------------------------------------------------------------------*/
  ...
  IF DECIMAL (PEDI.canate:SCREEN-VALUE IN BROWSE {&BROWSE-NAME}) > PEDI.canped THEN DO:
      MESSAGE 'No puede despachar más de lo solicitado'
          VIEW-AS ALERT-BOX ERROR.
      APPLY 'ENTRY':U TO PEDI.canate.
      RETURN 'ADM-ERROR'.
  END.
...
RUN Procesa-Handle IN lh_handle ('Disable-All').
