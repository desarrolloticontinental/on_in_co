...
"Sin clasificación", " ":U
          SIZE 37 BY .81
     "Clasificación o Segmentación:" VIEW-AS TEXT
...
ON LEAVE OF gn-clie.clfCli IN FRAME F-Main /* Clasificación Productos Propios */
DO:
  SELF:SCREEN-VALUE = CAPS(SELF:SCREEN-VALUE).
...
ON LEAVE OF gn-clie.ClfCli2 IN FRAME F-Main /* Clasificación Productos de Terceros */
DO:
    SELF:SCREEN-VALUE = CAPS(SELF:SCREEN-VALUE).
  ...
  DO WITH FRAME {&FRAME-NAME} :
    IF gn-clie.clfCli:SCREEN-VALUE <> '' THEN DO:
        ...
        IF NOT (CAPS(gn-clie.clfCli:SCREEN-VALUE) >= "A" AND 
            ...
            THEN DO:
            MESSAGE 'La clasificación debe estar entre A y L' VIEW-AS ALERT-BOX ERROR.
            APPLY 'ENTRY':U TO gn-clie.clfCli.
            RETURN 'ADM-ERROR'.
        END.
    END.
    ...
    IF gn-clie.CM_ClfCli_P:SCREEN-VALUE <> '' THEN DO:
        ...
        IF NOT (CAPS(gn-clie.CM_ClfCli_P:SCREEN-VALUE) >= "M" AND 
            ...
            THEN DO:
            MESSAGE 'La clasificación debe estar entre M y Z' VIEW-AS ALERT-BOX ERROR.
            APPLY 'ENTRY':U TO gn-clie.CM_ClfCli_P.
            RETURN 'ADM-ERROR'.
        END.
    END.
