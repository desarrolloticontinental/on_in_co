...
almmserv.MonVta almmserv.CatConta 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table almmserv.CatConta 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 87 BY 13.85
         FONT 4
...
"almmserv.codmat" "Cuenta" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"almmserv.AftIgv" ? ? "logical" ? ? ? ? ? ? no "Incluido IGV" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.almmserv.MonVta
"almmserv.MonVta" ? ? "integer" ? ? ? ? ? ? no "1: Soles   2: Dólares" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.almmserv.CatConta
"almmserv.CatConta" "Cuenta Contable" "x(15)" "character" ? ? ? ? ? ? yes ? no no "14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
