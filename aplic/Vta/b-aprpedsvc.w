...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.NroPed COLUMN-LABEL "Numero de Pedido" FORMAT "X(9)":U
...
/* Query rebuild information for BROWSE br_table
 ...
 AND FacCPedi.CodDiv = s-coddiv
 AND FacCPedi.CodDoc = s-coddoc
 AND FacCPedi.FlgEst = ""X"""
     _FldNameList[1]   > INTEGRAL.FacCPedi.FchPed
"FacCPedi.FchPed" "Fecha Pedido" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > INTEGRAL.FacCPedi.NroPed
"FacCPedi.NroPed" "Numero de Pedido" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Aprobar-Pedido B-table-Win 
PROCEDURE Aprobar-Pedido :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  MESSAGE 'Desea aprobar el Pedido' Faccpedi.nroped '?'
