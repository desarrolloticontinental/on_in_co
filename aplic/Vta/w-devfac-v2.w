...
DEFINE VARIABLE h_v-devfac-v2 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'vta/v-devfac-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-devfac-v2 ).
       RUN set-position IN h_v-devfac-v2 ( 2.54 , 3.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_v-devfac-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-updv05 , 'TableIO':U , h_v-devfac-v2 ).
       RUN add-link IN adm-broker-hdl ( h_q-devfac , 'Record':U , h_v-devfac-v2 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navico ,
             h_p-updv05 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_v-devfac-v2 ,
             h_p-navico , 'AFTER':U ).
