...
DEF TEMP-TABLE tmp-tempo
    ...
    FIELD t-canate LIKE FacDPedi.canate
    FIELD t-implin LIKE FacDPedi.ImpLin
    FIELD t-canpco LIKE FacDPedi.canate
    FIELD t-codcli LIKE faccpedi.codcli
    FIELD t-fmapgo LIKE Faccpedi.fmapgo
...
cRange = "L" + cColumn.                                                                                                                                
chWorkSheet:Range(cRange):Value = "Cant.PreCotizacion".
cRange = "M" + cColumn.                                                                                                                                
chWorkSheet:Range(cRange):Value = "Pendiente por atender".
cRange = "N" + cColumn.                                                                                                                                
chWorkSheet:Range(cRange):Value = "Valorizado".
cRange = "O" + cColumn.                                                                                                                                
chWorkSheet:Range(cRange):Value = "Condic. Pago".

FOR EACH tmp-tempo BY t-nrodoc BY t-fchped :
    FIND FIRST gn-ven WHERE gn-ven.codcia = s-codcia
        AND gn-ven.codven = tmp-tempo.t-codven
        NO-LOCK NO-ERROR.
    FIND FIRST gn-ConVt WHERE gn-ConVt.Codig = t-fmapgo NO-LOCK NO-ERROR.
    t-column = t-column + 1.                                                                                  
    cColumn = STRING(t-Column).                                           
    cRange = "A" + cColumn.                                                                                             
    ...
    cRange = "D" + cColumn.                                                                                             
    chWorkSheet:Range(cRange):Value = tmp-tempo.t-codven + ' ' + (IF AVAILABLE gn-ven THEN gn-ven.nomven ELSE '').
    cRange = "E" + cColumn.                                                                                             
    ...
    cRange = "L" + cColumn.                                                                                    
    chWorkSheet:Range(cRange):Value = t-canpco.
    cRange = "M" + cColumn.                                                                                    
    chWorkSheet:Range(cRange):Value = (t-canped + t-canpco - t-canate).
    cRange = "N" + cColumn.                                                                                    
    chWorkSheet:Range(cRange):Value = ROUND((t-canped + t-canpco - t-canate) * (t-implin / t-canped), 2).
    cRange = "O" + cColumn.                                                                                    
    chWorkSheet:Range(cRange):Value = t-fmapgo + ' ' + (IF AVAILABLE gn-convt THEN gn-ConVt.Nombr ELSE '').
END.
