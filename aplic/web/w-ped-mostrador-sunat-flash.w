...
CASE s-TpoPed:
    ...
    OTHERWISE DO:
        ...
        /* 
            Ic 28Jun2024 - Que el almacen pertenezca a la misma division de venta,
                            este activo y sea un almacen de despacho
         */
        FOR EACH VtaAlmDiv NO-LOCK WHERE Vtaalmdiv.codcia = s-codcia
            AND Vtaalmdiv.coddiv = s-coddiv,
            FIRST Almacen OF Vtaalmdiv NO-LOCK WHERE Almacen.Campo-C[3] <> 'Si'
...
&Scoped-Define ENABLED-OBJECTS RECT-29 BTN-Excel COMBO-NroSer 
...
DEFINE FRAME F-Main
     BTN-Excel AT ROW 1 COL 172 WIDGET-ID 16
     COMBO-NroSer AT ROW 1.27 COL 73.71 WIDGET-ID 6
     RECT-29 AT ROW 2.35 COL 2 WIDGET-ID 18
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 183.57 BY 26.12
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'src/adm-vm/objects/p-updv03.w':U ,
       ...
       RUN set-size IN h_p-updv03 ( 1.42 , 66.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-navico ).
       RUN set-position IN h_p-navico ( 1.00 , 100.00 ) NO-ERROR.
       RUN set-size IN h_p-navico ( 1.35 , 18.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'web/v-ped-mostrador-flash.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v-ped-mostrador-unificado ).
       RUN set-position IN h_v-ped-mostrador-unificado ( 2.88 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.35 , 127.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vta2/qpedidocontadomay.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q-pedido ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtagn/b-ped-mostrador-sunat.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-pedido-cont ).
       RUN set-position IN h_b-pedido-cont ( 11.50 , 2.00 ) NO-ERROR.
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_f-cot-gral-imp-ped-excel ( 2.62 , 156.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.12 , 25.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/vtagn/t-ped-mostrador-sunat-v2.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_t-ped-mostrador-unificado ).
       RUN set-position IN h_t-ped-mostrador-unificado ( 11.50 , 2.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-updv12 ).
       RUN set-position IN h_p-updv12 ( 25.50 , 3.00 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-29 BTN-Excel COMBO-NroSer 
      WITH FRAME F-Main IN WINDOW W-Win.
...
CASE L-Handle:
    WHEN "Importar-Excel-2015" THEN DO:
        RUN Importar-Excel-2015 IN h_v-ped-mostrador-unificado.
    END.
END CASE.
...
CASE L-Handle:
    WHEN "Pagina1"  THEN DO WITH FRAME {&FRAME-NAME}:
         ...
         RUN dispatch IN h_v-ped-mostrador-unificado ('enable':U).
    ...
    WHEN "Disable-Head" THEN DO:
        ...
        /*RUN dispatch IN h_v-ped-mostrador-unificado ('disable':U).*/
