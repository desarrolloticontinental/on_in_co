...
FacCPedi.CodCli FacCPedi.NomCli FacCPedi.ordcmp FacCPedi.FmaPgo ~
gn-ConVt.Nombr FacCPedi.ImpTot 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      FacCPedi.ordcmp COLUMN-LABEL "Orden de Compra" FORMAT "X(12)":U
      FacCPedi.FmaPgo COLUMN-LABEL "Condicion! de Venta" FORMAT "X(8)":U
            WIDTH 7.14
      gn-ConVt.Nombr FORMAT "X(30)":U WIDTH 48.43
      FacCPedi.ImpTot COLUMN-LABEL "Importe!Total" FORMAT ">>>,>>9.99":U
            WIDTH 10.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 161 BY 6.69
...
"FacCPedi.NomCli" ? "x(60)" "character" ? ? ? ? ? ? no ? no no "45.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > INTEGRAL.FacCPedi.ordcmp
"FacCPedi.ordcmp" "Orden de Compra" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > INTEGRAL.FacCPedi.FmaPgo
"FacCPedi.FmaPgo" "Condicion! de Venta" ? "character" ? ? ? ? ? ? no ? no no "7.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > INTEGRAL.gn-ConVt.Nombr
"gn-ConVt.Nombr" ? "X(30)" "character" ? ? ? ? ? ? no ? no no "48.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > INTEGRAL.FacCPedi.ImpTot
"FacCPedi.ImpTot" "Importe!Total" ">>>,>>9.99" "decimal" ? ? ? ? ? ? no ? no no "10.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
IF AVAILABLE Faccpedi THEN DO:
    ...
    CASE s-FlgEst:
        WHEN "PA" THEN ASSIGN FacCPedi.FlgEst = "E".
        WHEN "E" THEN ASSIGN FacCPedi.FlgEst = "P".
    END CASE.
