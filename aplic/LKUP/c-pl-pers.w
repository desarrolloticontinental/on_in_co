...
&SCOPED-DEFINE l-lookup h_l-pl-pers
...
DEFINE VARIABLE h_l-pl-pers AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'aplic/lkup/l-pl-pers.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-pl-pers ).
       RUN set-position IN h_l-pl-pers ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-pl-pers ( 10.92 , 93.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-pl-pers. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-pl-pers ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-pl-pers ,
