...
&SCOPED-DEFINE l-lookup h_l-pl-pers-v2
...
DEFINE VARIABLE h_l-pl-pers-v2 AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 7.19 COL 97.43
     Btn_Cancel AT ROW 8.38 COL 97.43
     SPACE(2.28) SKIP(2.91)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'lkup/l-pl-pers-v2.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-pl-pers-v2 ).
       RUN set-position IN h_l-pl-pers-v2 ( 1.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_l-pl-pers-v2 ( 10.92 , 93.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Style = Combo-Box,
                     ...
                     Font = 4':U ,
             OUTPUT h_p-option ).
       RUN set-position IN h_p-option ( 1.00 , 95.00 ) NO-ERROR.
       RUN set-size IN h_p-option ( 1.92 , 16.43 ) NO-ERROR.

       /* Links to SmartLookup h_l-pl-pers-v2. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-pl-pers-v2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-pl-pers-v2 ,
             Btn_OK:HANDLE , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-option ,
             h_l-pl-pers-v2 , 'AFTER':U ).
    END. /* Page 0 */
