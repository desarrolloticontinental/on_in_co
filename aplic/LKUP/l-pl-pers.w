...
&SCOPED-DEFINE FILTRO1 ( pl-pers.patper BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( pl-pers.patper , FILL-IN-filtro ) <> 0 )
...
&Scoped-define QUERY-STRING-br_table FOR EACH PL-PERS WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH PL-PERS WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.PL-PERS.patper
Nombres que contengan|y||INTEGRAL.PL-PERS.patper
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
