...
&Scoped-Define ENABLED-OBJECTS Rect-Left Rect-Main Rect-Top Rect-Bottom ~
Rect-Right 
...
DEFINE FRAME Folder-Frm
     ...
     Rect-Main AT ROW 1.65 COL 1
     Rect-Top AT ROW 1.69 COL 1.14
     Rect-Bottom AT ROW 6 COL 1
     Rect-Right AT ROW 1.85 COL 34.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SCROLLABLE SIZE 49.14 BY 6.65.
