...
DO ON ERROR UNDO, LEAVE:
  ...
  RUN addNode IN h_pure4gltv  ("n2"   ,""    ,"node 2"   ,""                    ,"expanded") NO-ERROR.
  RUN addNode IN h_pure4gltv  ("n21"  ,"n2"  ,"node 21"  ,""                    ,"")             NO-ERROR.
  RUN addNode IN h_pure4gltv  ("n22"  ,"n2"  ,"node 22"  ,"tvpics/book02.bmp"  ,"expanded") NO-ERROR.
  RUN addNode IN h_pure4gltv  ("n221" ,"n22" ,"221 dummy addOnExpand" ,"tvpics/book02.bmp"  ,"addOnExpand")             NO-ERROR.
  RUN addNode IN h_pure4gltv  ("n222" ,"n22" ,"222 real addOnExpand","tvpics/book02.bmp"  ,"addOnExpand")             NO-ERROR.
  ...
  RUN addNode IN h_pure4gltv  ("n4"   ,""    ,"node 4  returns cancelDrag"   ,"tvpics/smile56.bmp"  ,"")             NO-ERROR.
...
DO ON ERROR UNDO, LEAVE:
  ...
  RUN addNode IN h_pure4gltv-2  ("n22"  ,"n2"  ,"node 22"  ,"tvpics/book02.bmp"  ,"expanded") NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n221" ,"n22" ,"221 dummy addOnExpand" ,"tvpics/book02.bmp"  ,"addOnExpand")             NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n222" ,"n22" ,"222 real addOnExpand","tvpics/book02.bmp"  ,"addOnExpand")             NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n3"   ,""    ,"node 3  dragSource option"   ,"tvpics/present1.bmp" ,"expanded" + CHR(1) + "dragSource") NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n31"  ,"n3"  ,"node 31 nodragSource option"  ,"tvpics/$.bmp"        ,"noDragSource")             NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n4"   ,""    ,"node 4  returns cancelDrag"   ,"tvpics/smile56.bmp"  ,"")             NO-ERROR.
  RUN addNode IN h_pure4gltv-2  ("n5"   ,""    ,"node 5  with unvalid picture file"   ,"tvpics/ThereIsNoSuchPicFile.bmp"  ,"")             NO-ERROR.
END.
