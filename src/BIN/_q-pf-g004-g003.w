...
&Scoped-define QUERY-STRING-Query-Main FOR EACH PF-G004 OF PF-G003 WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH PF-G004 OF PF-G003 WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main PF-G004
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main PF-G004
...
DEFINE BUTTON BUTTON-1 
     IMAGE-UP FILE "img/pvbuscar.ico":U
     LABEL "Button 1" 
     SIZE 5 BY 1.12.
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: b-G004 B "?" ? INTEGRAL PF-G004
   END-TABLES.
 */
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "INTEGRAL.PF-G004 OF INTEGRAL.PF-G003"
...
------------------------------------------------------------------------------*/
  ...
  list-user = ''.
  FOR EACH b-G004 WHERE b-G004.Aplic-Id = PF-G003.Aplic-Id NO-LOCK:
  ...
  DO ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
      RUN bin/_hlista.r(
          INPUT list-user ,
          INPUT "USUARIOS: APLICACION " + PF-G003.Detalle ,
          OUTPUT usuario ).
      IF usuario <> ? OR usuario <> "" THEN DO:
          FIND FIRST B-G004 WHERE B-G004.Aplic-Id = PF-G003.Aplic-Id 
              AND B-G004.User-Id = usuario NO-LOCK NO-ERROR.
          IF AVAILABLE B-G004 THEN DO:
              REPOSITION {&QUERY-NAME}  TO ROWID ROWID(B-G004).
