...
"Query de Aplicaciones para el generador de Menús"
*/
&ANALYZE-RESUME
/* Connected Databases 
          integral         PROGRESS
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH PF-G003 NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH PF-G003 NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main PF-G003
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main PF-G003


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS Btn-UP Btn-DOWN 
...
DEFINE FRAME F-MAIN
     Btn-UP AT ROW 1 COL 1.14
     Btn-DOWN AT ROW 1.62 COL 1.14
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Design-Parent    is WINDOW q-tables @ ( 1.12 , 6.29 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn-DOWN q-tables
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn-UP q-tables
...
------------------------------------------------------------------------------*/
  ...
  THEN DO:
      REG-ACT = ROWID( PF-G003 ).
      REPOSITION {&QUERY-NAME} TO ROWID reg-act.
      RUN dispatch('get-next':U). 
  END.
END PROCEDURE.
