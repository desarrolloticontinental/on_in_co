...
DEFINE VARIABLE l_Enable AS LOGICAL INITIAL no 
     ...
     VIEW-AS TOGGLE-BOX
     SIZE 20 BY 1.12 NO-UNDO.

DEFINE VARIABLE l_View AS LOGICAL INITIAL no 
     LABEL "Dispatch '&View'" 
     VIEW-AS TOGGLE-BOX
     SIZE 21 BY .85 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME Attribute-Dlg
     c_SortBy AT ROW 2.12 COL 3.28
     c_Lock AT ROW 2.12 COL 42 NO-LABEL
     c_Key AT ROW 3.15 COL 1.71
     l_Enable AT ROW 5.85 COL 4
     c_Layout AT ROW 5.85 COL 24.28
     l_View AT ROW 6.92 COL 4
     c_create AT ROW 8.81 COL 4 NO-LABEL
     "  Advanced Query Options" VIEW-AS TEXT
          SIZE 39 BY .62 AT ROW 1.31 COL 2
          BGCOLOR 1 FGCOLOR 15 
     " Record Retrieval" VIEW-AS TEXT
          SIZE 20 BY .62 AT ROW 1.31 COL 42
          BGCOLOR 1 FGCOLOR 15 
     "  Behavior During 'Initialize'" VIEW-AS TEXT
          SIZE 60 BY .62 AT ROW 5.04 COL 2
          BGCOLOR 1 FGCOLOR 15 
     "  Create new record immediately on 'Add'?" VIEW-AS TEXT
          SIZE 60 BY .62 AT ROW 8 COL 2
          BGCOLOR 1 FGCOLOR 15 
     SPACE(0.99) SKIP(1.10)
