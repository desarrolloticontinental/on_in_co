...
DEFINE FRAME SP-attr-dialog
     ...
     v-type AT ROW 6.46 COL 22 NO-LABEL
     v-add AT ROW 10.04 COL 17 NO-LABEL
     v-divider1 AT ROW 1.65 COL 2.57 NO-LABEL
     v-divider2 AT ROW 5.54 COL 2 NO-LABEL
     v-divider-3 AT ROW 9.12 COL 2 NO-LABEL
     SPACE(0.57) SKIP(2.72)
