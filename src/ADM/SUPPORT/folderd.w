...
&Scoped-define QUERY-STRING-Tab-Browse-1 FOR EACH tab-label NO-LOCK     BY tab-label.tab-number
...
&Scoped-define QUERY-STRING-Tab-Browse-2 FOR EACH tab-label NO-LOCK     BY tab-label.tab-number
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 28.86 BY 5.65.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 24 BY 5.65.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME SmartFolder-Dlg
     F-Tab-Type AT ROW 1.35 COL 18 NO-LABEL
     Btn-Add AT ROW 3.85 COL 38
     Tab-Browse-2 AT ROW 3.96 COL 7
     Tab-Browse-1 AT ROW 3.96 COL 7
     Btn-Remove AT ROW 5.23 COL 38
     "Tab width:" VIEW-AS TEXT
          SIZE 10 BY 1 AT ROW 1.35 COL 7
     "Tab Labels:" VIEW-AS TEXT
          SIZE 12 BY .81 AT ROW 2.85 COL 7
     SPACE(34.99) SKIP(6.33)
...
/* SETTINGS FOR DIALOG-BOX SmartFolder-Dlg
   FRAME-NAME                                                           */
/* BROWSE-TAB Tab-Browse-2 Btn-Add SmartFolder-Dlg */
/* BROWSE-TAB Tab-Browse-1 Tab-Browse-2 SmartFolder-Dlg */
ASSIGN 
