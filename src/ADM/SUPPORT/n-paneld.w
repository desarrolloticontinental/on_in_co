...
&Scoped-Define ENABLED-OBJECTS v-show v-edge-pixels v-rtl v-divider1 
&Scoped-Define DISPLAYED-OBJECTS v-show v-edge-pixels v-rtl v-divider1 ~
v-divider2 
...
DEFINE FRAME SP-attr-dialog
     v-show AT ROW 2.65 COL 20
     v-edge-pixels AT ROW 3.85 COL 29 COLON-ALIGNED
     v-rtl AT ROW 6.69 COL 18 NO-LABEL
     v-divider1 AT ROW 1.62 COL 2.57 NO-LABEL
     v-divider2 AT ROW 5.81 COL 2.57 NO-LABEL
     SPACE(0.00) SKIP(2.76)
...
------------------------------------------------------------------------------*/
  DISPLAY v-show v-edge-pixels v-rtl v-divider1 v-divider2 
      WITH FRAME SP-attr-dialog.
  ENABLE v-show v-edge-pixels v-rtl v-divider1 
      WITH FRAME SP-attr-dialog.
