...
DEFINE FRAME Panel-Frame
     Btn-Save AT ROW 1.19 COL 2
     Btn-Add AT ROW 1.19 COL 15
     Btn-Delete AT ROW 1.19 COL 32
     Btn-Cancel AT ROW 1.19 COL 47
...
ON CHOOSE OF Btn-Add IN FRAME Panel-Frame /* Adicionar */
DO:
  add-active = YES.
...
ON CHOOSE OF Btn-Delete IN FRAME Panel-Frame /* Eliminar */
DO:
   MESSAGE "Esta seguro"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Cambia-Font C-WIn 
PROCEDURE Cambia-Font :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
DEF INPUT PARAMETER pFont AS INT.

DO WITH FRAME {&FRAME-NAME}:
    ASSIGN
        Btn-Add:FONT = pFont
        Btn-Cancel:FONT = pFont
        Btn-Delete :FONT = pFont
        Btn-Save:FONT = pFont.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Proceso1 C-WIn 
PROCEDURE Proceso1 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Proceso2 C-WIn 
PROCEDURE Proceso2 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
------------------------------------------------------------------------------*/
DO WITH FRAME Panel-Frame:
    IF Btn-Delete:SENSITIVE = TRUE THEN DO:
    APPLY "CHOOSE":U TO Btn-Delete.
    RETURN NO-APPLY.
    END.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Proceso3 C-WIn 
PROCEDURE Proceso3 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Proceso4 C-WIn 
PROCEDURE Proceso4 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
------------------------------------------------------------------------------*/
DO WITH FRAME Panel-Frame:
    IF Btn-Cancel:SENSITIVE = TRUE THEN DO:
    MESSAGE "ACTIVO" VIEW-AS ALERT-BOX.
    APPLY "CHOOSE":U TO Btn-Cancel.
    RUN dispatch IN THIS-PROCEDURE ('initialize':U).
    RUN dispatch IN THIS-PROCEDURE ('view':U).
/*    RUN notify IN THIS-PROCEDURE ('enable':U).*/
