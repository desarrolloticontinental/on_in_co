...
/* @VM 20/02/97 JORGE MIESES: NUEVOS METODOS NOTIFY */
&GLOB adm-vm-notify-methods imprime,busca,qbusca,qimprime
&GLOB adm-vm-notify-links TABLEIO-TARGET,TABLEIO-TARGET,RECORD-SOURCE,RECORD-SOURCE
/* FIN DE CAMBIOS VALMIESA */
...
/* @VM 20/02/97 JORGE MIESES: usando adm-vm-notify-methods */
...
reposition-query,reset-record,cancel-record,~
{&adm-vm-notify-methods},{&adm-user-notify-methods}":U
&ENDIF
DEFINE VARIABLE adm-notify-methods AS CHARACTER 
  INIT {&adm-notify-methods} NO-UNDO.

/* @VM 20/02/97 JORGE MIESES: usando adm-vm-notify-links */
...
RECORD-SOURCE,TABLEIO-TARGET,TABLEIO-TARGET,~
{&adm-vm-notify-links},{&adm-user-notify-links}":U
&ENDIF
