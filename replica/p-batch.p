...
REPEAT :
      FOR EACH integral.replog NO-LOCK WHERE integral.replog.FlgEst = NO 
          USE-INDEX llave01:
        ...
        IF NOT AVAILABLE b-replog THEN DO:
            ...
            NEXT.
        END.
        DISPLAY integral.replog.LogDate integral.replog.LogTime 
            integral.replog.TableName integral.replog.Event 
