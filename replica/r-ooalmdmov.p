...
DISABLE TRIGGERS FOR LOAD OF base1.OOAlmdmov.
...
DO TRANSACTION ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE:
    CASE pEvent:
        WHEN 'CREATE' THEN DO:
            CREATE base1.OOAlmdmov.
            RAW-TRANSFER pDataRecord TO base1.OOAlmdmov.
            ASSIGN base1.OOAlmdmov.FlagNumero = INTEGER(RECID(base1.OOAlmdmov)).
            L-FLG = YES.    
        END.
    END CASE.
    ...
    END CATCH.
END.
IF AVAILABLE(base1.OOAlmdmov) THEN RELEASE base1.OOAlmdmov.
