...
DISABLE TRIGGERS FOR LOAD OF base1.FeLogErrores.
...
DO TRANSACTION ON ERROR UNDO, LEAVE ON STOP UNDO, LEAVE:
    CASE pEvent:
        WHEN 'CREATE' THEN DO:
            CREATE base1.FeLogErrores.
            RAW-TRANSFER pDataRecord TO base1.FeLogErrores.
            L-FLG = YES.    
        END.
    END CASE.
    ...
    END CATCH.
END.
IF AVAILABLE(base1.FeLogErrores) THEN RELEASE base1.FeLogErrores.
