...
DEFINE SHARED TEMP-TABLE T-CcbDDocu NO-UNDO LIKE INTEGRAL.CcbDDocu.
...
Almmmatg.DesMat T-CcbDDocu.CanDes T-CcbDDocu.PreUni 
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: T-CcbDDocu T "SHARED" NO-UNDO INTEGRAL CcbDDocu
   END-TABLES.
 */
...
"INTEGRAL.T-CcbDDocu.codmat" ? ? "character" ? ? ? ? ? ? yes ?
     _FldNameList[3]   = INTEGRAL.Almmmatg.DesMat
     _FldNameList[4]   > Temp-Tables.T-CcbDDocu.CanDes
"INTEGRAL.T-CcbDDocu.CanDes" ? ? "decimal" ? ? ? ? ? ? yes ?
     _FldNameList[5]   > Temp-Tables.T-CcbDDocu.PreUni
"INTEGRAL.T-CcbDDocu.PreUni" ? ? "decimal" ? ? ? ? ? ? yes ?
