...
&Scoped-define FIELDS-IN-QUERY-br_table codmat DesMat 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      codmat FORMAT "X(6)":U
      DesMat FORMAT "X(45)":U WIDTH 49.14
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN NO-AUTO-VALIDATE NO-ROW-MARKERS SEPARATORS SIZE 66 BY 15.58 FIT-LAST-COLUMN.
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.codmat
     _FldNameList[2]   > _<SDO>.rowObject.DesMat
"DesMat" ? ? "character" ? ? ? ? ? ? no ? no no "49.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
