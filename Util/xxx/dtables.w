...
&Scoped-Define ENABLED-FIELDS  CodAlm Descripcion CodCia
&Scoped-define ENABLED-FIELDS-IN-Almacen CodAlm Descripcion CodCia 
&Scoped-Define DATA-FIELDS  CodAlm Descripcion CodCia
&Scoped-define DATA-FIELDS-IN-Almacen CodAlm Descripcion CodCia 
&Scoped-Define MANDATORY-FIELDS 
&Scoped-Define APPLICATION-SERVICE 
&Scoped-Define ASSIGN-LIST 
&Scoped-Define DATA-FIELD-DEFS "Util/xxx/dtables.i"
...
"Descripcion" "Descripcion" ? ? "character" ? ? ? ? ? ? yes ? no 40 yes ?
     _FldNameList[3]   > INTEGRAL.Almacen.CodCia
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE bufferCommit dTables  _DB-REQUIRED
...
------------------------------------------------------------------------------*/
  ...
  RUN SUPER( OUTPUT pocMessages, OUTPUT pocUndoIds).

  /* Code placed here will execute AFTER standard behavior.    */
  ASSIGN
      almacen.codcia = s-codcia.
