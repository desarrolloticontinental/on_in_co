...
DEFINE FRAME fMain
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 74.72 BY 10.19 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             INPUT  'util/dalmacen.wDB-AWARE':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'AppServiceASInfoASUsePrompt?CacheDuration0CheckCurrentChangedyesDestroyStatelessyesDisconnectAppServernoServerOperatingModeNONEShareDatanoUpdateFromSourcenoForeignFieldsObjectNamedalmacenOpenOnInityesPromptColumns(NONE)PromptOnDeleteyesRowsToBatch200RebuildOnReposnoToggleDataTargetsyes':U ,
             OUTPUT h_dalmacen ).
       RUN repositionObject IN h_dalmacen ( 6.65 , 58.00 ) NO-ERROR.
       /* Size in AB:  ( 1.50 , 7.72 ) */

       RUN constructObject (
             INPUT  'util/valmacen.w':U ,
             INPUT  FRAME fMain:HANDLE ,
             INPUT  'EnabledObjFldsToDisable?ModifyFields(All)DataSourceNamesUpdateTargetNamesLogicalObjectNameLogicalObjectNamePhysicalObjectNameDynamicObjectnoRunAttributeHideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_valmacen ).
       RUN repositionObject IN h_valmacen ( 1.81 , 3.00 ) NO-ERROR.
       /* Size in AB:  ( 4.23 , 55.43 ) */
       ...
       RUN constructObject (
             ...
             OUTPUT h_pnavico ).
       RUN repositionObject IN h_pnavico ( 6.38 , 2.00 ) NO-ERROR.
       ...
       RUN constructObject (
             ...
             OUTPUT h_pupdsav ).
       RUN repositionObject IN h_pupdsav ( 8.27 , 2.00 ) NO-ERROR.
       RUN resizeObject IN h_pupdsav ( 1.77 , 65.57 ) NO-ERROR.

       /* Links to SmartDataObject h_dalmacen. */
       RUN addLink ( h_pnavico , 'Navigation':U , h_dalmacen ).

       /* Links to SmartDataViewer h_valmacen. */
       RUN addLink ( h_dalmacen , 'Data':U , h_valmacen ).
       RUN addLink ( h_valmacen , 'Update':U , h_dalmacen ).
       RUN addLink ( h_pupdsav , 'TableIO':U , h_valmacen ).
