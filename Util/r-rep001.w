...
&Scoped-Define ENABLED-OBJECTS x-Periodo x-NroMes BUTTON-3 Btn_Done 
&Scoped-Define DISPLAYED-OBJECTS x-Periodo x-NroMes 
...
DEFINE VARIABLE x-NroMes AS CHARACTER FORMAT "X(8)":U INITIAL "0" 
     LABEL "Mes" 
...
DEFINE FRAME F-Main
     x-Periodo AT ROW 1.58 COL 16 COLON-ALIGNED
     x-NroMes AT ROW 2.54 COL 16 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  DISPLAY x-Periodo x-NroMes 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE x-Periodo x-NroMes BUTTON-3 Btn_Done 
      WITH FRAME F-Main IN WINDOW W-Win.
...
------------------------------------------------------------------------------*/
  ...
  DO WITH FRAME {&FRAME-NAME}:
    x-NroMes:SCREEN-VALUE = ENTRY(s-NroMes, x-NroMes:LIST-ITEMS).
