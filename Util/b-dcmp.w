...
DEFINE TEMP-TABLE DCMP NO-UNDO LIKE lima.FacDPedi.
...
&Scoped-define INTERNAL-TABLES DCMP

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table DCMP.codmat DCMP.CanPed DCMP.ImpLin 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH DCMP WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table DCMP
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: DCMP T "?" NO-UNDO lima FacDPedi
   END-TABLES.
 */
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "Temp-Tables.DCMP"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = Temp-Tables.DCMP.codmat
     _FldNameList[2]   = Temp-Tables.DCMP.CanPed
     _FldNameList[3]   = Temp-Tables.DCMP.ImpLin
