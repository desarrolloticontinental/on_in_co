...
&SCOPED-DEFINE l-lookup h_l-SubFam
...
DEFINE VARIABLE h_l-subfam AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'util/rosa/l-subfam.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-subfam ).
       RUN set-position IN h_l-subfam ( 1.19 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-subfam. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-subfam ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-subfam ,
