...
&Scoped-define INTERNAL-TABLES Deta almmserv
...
almmserv.DesMat Deta.CanDes Deta.UndVta Deta.PreUni Deta.PorDto Deta.ImpLin 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH Deta WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH almmserv OF Deta NO-LOCK ~
    BY Deta.NroItm.
&Scoped-define TABLES-IN-QUERY-br_table Deta almmserv
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table B-table-Win _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      Deta.NroItm
      Deta.codmat COLUMN-LABEL "Codigo Servicio"
      almmserv.DesMat
      Deta.CanDes
      Deta.UndVta
      Deta.PreUni
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 97 BY 6.92
         FONT 4.
