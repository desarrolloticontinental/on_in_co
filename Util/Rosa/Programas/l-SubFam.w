...
&SCOPED-DEFINE CONDICION ( almsfami.codcia = s-codcia and almsfami.codfam = input-var-1 )
&SCOPED-DEFINE CODIGO almsfami.subfam

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( almsfami.dessub BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( almsfami.dessub , FILL-IN-filtro ) <> 0 )
...
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH AlmSFami WHERE ~{&KEY-PHRASE} ~
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.AlmSFami.dessub
Nombres que contengan|y||INTEGRAL.AlmSFami.dessub
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.AlmSFami.subfam|yes
Descripción|||INTEGRAL.AlmSFami.dessub|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
DEFINE VARIABLE FILL-IN-codigo AS CHARACTER FORMAT "X(3)":U 
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY AlmSFami.subfam
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY AlmSFami.dessub
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.SubFam
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.DesSub.
