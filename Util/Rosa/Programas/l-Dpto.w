...
&SCOPED-DEFINE CODIGO TabDepto.CodDepto

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( TabDepto.NomDepto BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( TabDepto.NomDepto, FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES TabDepto

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table TabDepto.CodDepto TabDepto.NomDepto 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH TabDepto WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table TabDepto
&Scoped-define FIRST-TABLE-IN-QUERY-br_table TabDepto
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.TabDepto.NomDepto
Nombres que contengan|y||INTEGRAL.TabDepto.NomDepto
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.TabDepto"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   = INTEGRAL.TabDepto.CodDepto
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.CodDepto
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.NomDepto.
