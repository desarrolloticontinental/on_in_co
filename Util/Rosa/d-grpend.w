...
DEFINE OUTPUT PARAMETER p-NroRef AS CHAR.
DEFINE SHARED VAR s-CodDoc AS CHAR.
DEFINE VAR s-TipVta AS CHAR NO-UNDO.

s-TipVta = IF s-CodDoc = "FAC"
	THEN "1"
	ELSE "2".
...
&Scoped-define OPEN-QUERY-BROWSE-3 OPEN QUERY BROWSE-3 FOR EACH CcbCDocu ~
 ...
 AND CcbCDocu.TpoFac = "S" ~
 AND CcbCDocu.TipVta = s-TipVta NO-LOCK.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 63 BY 10.19
         FONT 4
         TITLE "Guias Pendientes de Facturar".


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME D-Dialog
     BROWSE-3 AT ROW 1.38 COL 3
     Btn_OK AT ROW 1.58 COL 67
     Btn_Cancel AT ROW 2.77 COL 67
     SPACE(1.13) SKIP(8.14)
