...
&SCOPED-DEFINE l-lookup h_l-Dpto
...
DEFINE VARIABLE h_l-dpto AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 7.35 COL 48
     Btn_Cancel AT ROW 8.54 COL 48
     Btn_Help AT ROW 10.35 COL 48
     SPACE(6.42) SKIP(0.94)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'util/rosa/l-dpto.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_l-dpto ).
       RUN set-position IN h_l-dpto ( 1.19 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-dpto. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-dpto ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-dpto ,
