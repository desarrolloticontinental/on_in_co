...
&SCOPED-DEFINE CONDICION ( almtabla.Tabla = input-var-1 )
&SCOPED-DEFINE CODIGO almtabla.Codigo

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( Almtabla.Nombre  BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( almtabla.Nombre , FILL-IN-filtro ) <> 0 )
...
&Scoped-define FIELDS-IN-QUERY-br_table almtabla.Codigo almtabla.Nombre ~
almtabla.NomAnt 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH almtabla WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table almtabla
&Scoped-define FIRST-TABLE-IN-QUERY-br_table almtabla
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.almtabla.Nombre
Nombres que contengan|y||INTEGRAL.almtabla.Nombre
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.almtabla.Tabla|yes,INTEGRAL.almtabla.Codigo|yes
Descripción|||INTEGRAL.almtabla.Tabla|yes,INTEGRAL.almtabla.Nombre|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 53.14 BY 8.62
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[3]   = INTEGRAL.almtabla.NomAnt
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY almtabla.Tabla BY almtabla.Codigo
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY almtabla.Tabla BY almtabla.Nombre
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.Codigo
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.Nombre.
