...
&SCOPED-DEFINE l-lookup h_l-Facsvc
...
DEFINE VARIABLE h_l-facsvc AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     Btn_OK AT ROW 7.54 COL 62
     Btn_Cancel AT ROW 8.73 COL 62
     Btn_Help AT ROW 10.54 COL 62
     SPACE(1.28) SKIP(0.75)
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'util/rosa/l-facsvc.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-facsvc ).
       RUN set-position IN h_l-facsvc ( 1.19 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-facsvc. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-facsvc ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-facsvc ,
