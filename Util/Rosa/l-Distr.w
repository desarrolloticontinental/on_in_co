...
&SCOPED-DEFINE CONDICION ( TabDistr.CodDepto = input-var-1 ~
            AND TabDistr.CodProvi = input-var-2 )
&SCOPED-DEFINE CODIGO TabDistr.CodDistr

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( TabDistr.NomDistr BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( TabDistr.NomDistr, FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES TabDistr

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table TabDistr.CodDistr TabDistr.NomDistr 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH TabDistr WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table TabDistr
&Scoped-define FIRST-TABLE-IN-QUERY-br_table TabDistr
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.TabDistr.NomDistr
Nombres que contengan|y||INTEGRAL.TabDistr.NomDistr
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.TabDistr.CodDistr|yes
Descripción|||INTEGRAL.TabDistr.NomDistr|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 44.14 BY 8.62
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.TabDistr"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   = INTEGRAL.TabDistr.CodDistr
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY TabDistr.CodDistr
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY TabDistr.NomDistr
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.CodDistr
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.NomDistr.
