...
&SCOPED-DEFINE l-lookup h_l-Marcas
...
DEFINE VARIABLE h_l-marcas AS HANDLE NO-UNDO.
...
DEFINE FRAME C-Dialog
     ...
     Btn_Cancel AT ROW 8.73 COL 61
     Btn_Help AT ROW 10.54 COL 61
     SPACE(2.71) SKIP(0.75)
...
ON WINDOW-CLOSE OF FRAME C-Dialog /* Marcas */
DO:  
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'util/rosa/l-marcas.w':U ,
             INPUT  FRAME C-Dialog:HANDLE ,
             INPUT  'Layout = ,
                     SortBy-Case = Código':U ,
             OUTPUT h_l-marcas ).
       RUN set-position IN h_l-marcas ( 1.19 , 2.00 ) NO-ERROR.
       ...
       /* Links to SmartLookup h_l-marcas. */
       RUN add-link IN adm-broker-hdl ( h_p-option , 'SortBy':U , h_l-marcas ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_l-marcas ,
