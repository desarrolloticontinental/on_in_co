...
&SCOPED-DEFINE CONDICION ( TabProvi.CodDepto = input-var-1)
&SCOPED-DEFINE CODIGO TabProvi.CodProvi

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( TabProvi.NomProvi BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( TabProvi.NomProvi , FILL-IN-filtro ) <> 0 )
...
&Scoped-define INTERNAL-TABLES TabProvi

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br_table                                      */
&Scoped-define FIELDS-IN-QUERY-br_table TabProvi.CodProvi TabProvi.NomProvi 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br_table 
&Scoped-define FIELD-PAIRS-IN-QUERY-br_table
&Scoped-define OPEN-QUERY-br_table OPEN QUERY br_table FOR EACH TabProvi WHERE ~{&KEY-PHRASE} ~
      AND {&CONDICION} NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br_table TabProvi
&Scoped-define FIRST-TABLE-IN-QUERY-br_table TabProvi
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.TabProvi.NomProvi
Nombres que contengan|y||INTEGRAL.TabProvi.NomProvi
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.TabProvi.CodProvi|yes
Descripción|||INTEGRAL.TabProvi.NomProvi|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 43.14 BY 8.62
...
/* Query rebuild information for BROWSE br_table
     _TblList          = "INTEGRAL.TabProvi"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _Where[1]         = "{&CONDICION}"
     _FldNameList[1]   = INTEGRAL.TabProvi.CodProvi
     _FldNameList[2]   = INTEGRAL.TabProvi.NomProvi
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY TabProvi.CodProvi
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY TabProvi.NomProvi
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
...
IF AVAILABLE {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}} THEN
    ASSIGN
        ...
        output-var-2 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.CodProvi
        output-var-3 = {&FIRST-TABLE-IN-QUERY-{&BROWSE-NAME}}.NomProvi.
