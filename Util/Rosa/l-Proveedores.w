...
&SCOPED-DEFINE CONDICION ( Gn-Prov.CodCia = s-codcia )
...
Descripción|||INTEGRAL.gn-prov.CodCia|yes,INTEGRAL.gn-prov.NomPro|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         ...
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY gn-prov.CodCia BY gn-prov.NomPro
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
