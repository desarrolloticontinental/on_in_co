...
&SCOPED-DEFINE CONDICION Almmserv.CodCia = INTEGER(input-var-1) /*( TRUE )*/
&SCOPED-DEFINE CODIGO Almmserv.CodMat /*GN-CIAS.codcia*/

/* Preprocesadores para cada campo filtro */
&SCOPED-DEFINE FILTRO1 ( Almmserv.DesMat BEGINS FILL-IN-filtro )
&SCOPED-DEFINE FILTRO2 ( INDEX ( Almmserv.DesMat , FILL-IN-filtro ) <> 0 )
...
&Scoped-define FIELDS-IN-QUERY-br_table almmserv.codmat almmserv.DesMat 
...
<FOREIGN-KEYS>
Nombres que inicien con|y||INTEGRAL.almmserv.DesMat
Nombres que contengan|y||INTEGRAL.almmserv.DesMat
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
<SORTBY-OPTIONS>
Código|y||INTEGRAL.almmserv.codmat|yes
Descripción|||INTEGRAL.almmserv.DesMat|yes
</SORTBY-OPTIONS> 
<SORTBY-RUN-CODE>
************************
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[2]   = INTEGRAL.almmserv.DesMat
    ...
    WHEN 'Nombres que inicien con':U THEN DO:
       ...
       CASE RETURN-VALUE:
         WHEN 'Código':U THEN DO:
           &Scope SORTBY-PHRASE BY almmserv.codmat
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         WHEN 'Descripción':U THEN DO:
           &Scope SORTBY-PHRASE BY almmserv.DesMat
           {&OPEN-QUERY-{&BROWSE-NAME}}
         END.
         OTHERWISE DO:
