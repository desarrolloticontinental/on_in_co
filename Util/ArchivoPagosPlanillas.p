...
DEFINE TEMP-TABLE tempo
    FIELDS codcia  like pl-flg-mes.codcia
    FIELDS periodo like pl-flg-mes.periodo
    fields nromes like pl-flg-mes.nromes
    fields codper like pl-flg-mes.codper
    fields codpln like PL-FLG-MES.codpln
    fields valcal-mes as decimal.

INPUT FROM C:\SIE\GRATIJULIO2007.CSV.
REPEAT:
    CREATE tempo.
    IMPORT DELIMITER "," tempo.codper tempo.valcal-mes.
    assign
        tempo.codcia = 1
        tempo.codpln = 1
        tempo.periodo = 2007
...
for each tempo:
    find first pl-flg-mes where
        pl-flg-mes.codcia  = tempo.codcia  
...
for each tempo :
    ...
    find first pl-flg-mes where pl-flg-mes.codcia  = tempo.codcia  and
                      ...
                      /*
                      pl-flg-mes.codpln = tempo.codpln and
                      */
