...
REPEAT:
    ...
    IF x-linea <> '' THEN DO:
        ...
        ASSIGN
            ...
            t-matg.aftisc = NO
            t-matg.tpoart = 'A'
            t-matg.usuario = 'SIRA-00'
            t-matg.DEC__03 = 1
            t-matg.stkmin = 1
            t-matg.canemp = DEC(SUBSTRING(x-linea,86,5))
            t-matg.stkrep = DEC(SUBSTRING(x-linea,91,5))
            t-matg.codbrr = SUBSTRING(x-linea,96,15)
            .
