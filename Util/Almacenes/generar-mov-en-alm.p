...
FOR EACH detalle ,
    ...
    BREAK BY detalle.codcia BY detalle.codalm BY detalle.tipmov BY detalle.codmov BY detalle.fchdoc BY detalle.codmat:
    /* CABECERA */
    IF FIRST-OF(detalle.codalm) OR FIRST-OF(detalle.tipmov) OR FIRST-OF(detalle.codmov) OR FIRST-OF(detalle.fchdoc) THEN DO:
        CREATE almcmov.
        ASSIGN 
