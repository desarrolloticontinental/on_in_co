...
&Scoped-define QUERY-STRING-Query-Main FOR EACH almmserv WHERE ~{&KEY-PHRASE} ~
      AND almmserv.CodCia = s-codcia NO-LOCK ~
    BY almmserv.codmat DESCENDING
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH almmserv WHERE ~{&KEY-PHRASE} ~
      AND almmserv.CodCia = s-codcia NO-LOCK ~
    BY almmserv.codmat DESCENDING.
&Scoped-define TABLES-IN-QUERY-Query-Main almmserv
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main almmserv
...
/* Query rebuild information for QUERY Query-Main
     ...
     _OrdList          = "INTEGRAL.almmserv.codmat|no"
     _Where[1]         = "almmserv.CodCia = s-codcia"
