...
ON END-ERROR OF W-Win /* Reporte de Planillas */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Reporte de Planillas */
DO:
...
FOR EACH Pl-Calc NO-LOCK WHERE 
    Pl-Calc.CodPln = 01:
    FOR EACH Pl-Bole OF Pl-Calc NO-LOCK WHERE
        LOOKUP (TRIM(Pl-Bol.TpoBol),"Remuneraciones,Descuentos,Apuntes") > 0,
        Pl-Conc OF Pl-Bole NO-LOCK:
