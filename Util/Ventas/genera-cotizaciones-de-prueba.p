...
DEF VAR s-coddiv AS CHAR INIT '00060' NO-UNDO.
DEF VAR pcoddiv  AS CHAR INIT '00060' NO-UNDO.
...
DEF VAR s-nroser AS INT INIT 060 NO-UNDO.
DEF VAR s-codalm AS CHAR INIT '03' NO-UNDO.
DEF VAR s-TpoPed AS CHAR INIT 'N' NO-UNDO.
...
DO  k = 1 TO NUM-ENTRIES(x-fmapgo):
    ...
    DO j = 1 TO NUM-ENTRIES(x-clfcli):
        ...
        FOR EACH almmmatg NO-LOCK WHERE almmmatg.codcia = s-codcia
            ...
            DISPLAY faccpedi.coddiv faccpedi.nroped almmmatg.codmat.
            PAUSE 0.
            I-NITEM = I-NITEM + 1.
            CREATE Facdpedi.
            ASSIGN
            ...
            END.
            IF Facdpedi.PreUni = 0 THEN DELETE Facdpedi.
        END.
