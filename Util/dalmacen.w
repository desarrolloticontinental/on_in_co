...
&Scoped-Define ENABLED-FIELDS  CodCia CodAlm Descripcion CodDiv
&Scoped-define ENABLED-FIELDS-IN-Almacen CodCia CodAlm Descripcion CodDiv 
&Scoped-Define DATA-FIELDS  CodCia CodAlm Descripcion CodDiv
&Scoped-define DATA-FIELDS-IN-Almacen CodCia CodAlm Descripcion CodDiv 
...
"Descripcion" "Descripcion" ? ? "character" ? ? ? ? ? ? yes ? no 40 yes ?
     _FldNameList[4]   > INTEGRAL.Almacen.CodDiv
"CodDiv" "CodDiv" ? ? "character" ? ? ? ? ? ? yes ? no 10.14 yes ?
