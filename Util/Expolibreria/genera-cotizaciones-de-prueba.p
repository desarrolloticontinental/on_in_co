...
DEF VAR x-fmapgo AS CHAR INIT '001,403' NO-UNDO.
DEF VAR s-cndvta AS CHAR NO-UNDO.
DEF VAR s-coddoc AS CHAR INIT 'COT' NO-UNDO.
DEF VAR s-nroser AS INT INIT 015 NO-UNDO.
DEF VAR s-codalm AS CHAR INIT '11e' NO-UNDO.
DEF VAR s-TpoPed AS CHAR INIT 'E' NO-UNDO.
DEF VAR x-clfcli AS CHAR INIT 'A,B,C' NO-UNDO.
...
DO  k = 1 TO NUM-ENTRIES(x-fmapgo):
    s-cndvta = ENTRY(k, x-fmapgo).
    ...
    DO j = 1 TO 3:
        ...
        ASSIGN
            ...
            Faccpedi.nomcli = 'CONDICION DE VENTA ' + s-cndvta + ' CLASIFICACION CLIENTE: ' + s-clfcli
...
/*         MESSAGE faccpedi.coddoc faccpedi.nroped SKIP faccpedi.nomcli */
/*             VIEW-AS ALERT-BOX INFORMATION.                           */
        ASSIGN
            FacCorre.Correlativo = FacCorre.Correlativo + 1.
        I-NITEM = 0.
        FOR EACH vtacatventa NO-LOCK WHERE vtacatventa.codcia = s-codcia AND vtacatventa.coddiv = s-coddiv,
