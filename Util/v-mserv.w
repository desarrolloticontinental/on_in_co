...
&Scoped-Define ENABLED-FIELDS almmserv.codmat almmserv.DesMat ~
almmserv.PreBas almmserv.UndBas 
...
almmserv.PreBas almmserv.UndBas 
&Scoped-define DISPLAYED-TABLES almmserv
&Scoped-define FIRST-DISPLAYED-TABLE almmserv
...
DEFINE FRAME F-Main
     almmserv.codmat AT ROW 1.38 COL 20 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 10.43 BY .81
     almmserv.DesMat AT ROW 2.15 COL 20 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 46.43 BY .81
     almmserv.PreBas AT ROW 2.92 COL 20 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 17.43 BY .81
     almmserv.UndBas AT ROW 3.69 COL 20 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 8.43 BY .81
