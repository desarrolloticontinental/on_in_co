...
DEF BUFFER BB-CDOCU FOR CcbCdocu.
DEF BUFFER BB-DDOCU FOR CcbDdocu.
...
FOR EACH Gn-Divi WHERE Gn-Divi.Codcia = S-CodCia NO-LOCK :
    ...
    FOR EACH CcbCdocu NO-LOCK WHERE CcbCdocu.CodCia = S-CODCIA 
        ...
        IF Ccbcdocu.coddiv <> '00019' AND Ccbcdocu.codven = '081' THEN pCodDiv = '00019'.   /* Mesa redonda */
        IF Ccbcdocu.CodDiv <> '00099' AND Ccbcdocu.codven = '998' THEN pCodDiv = '00099'.   /* Exportaciones */
        IF Ccbcdocu.CodDiv <> '00098' AND Ccbcdocu.codven = '157' THEN pCodDiv = '00098'.   /* Refiles */
        /* ***************** FILTROS ********************************** */
        ...
        IF Ccbcdocu.CodDoc = 'N/C' THEN DO:
            ...
            IF B-CDOCU.coddiv <> '00018' AND LOOKUP(B-CDOCU.codven, '015,173,901,902,017') > 0 THEN pCodDiv = '00018'.    /* Provincias */
            IF B-CDOCU.codcli = '20511358907' THEN pCodDiv = '00022'.  /* STANDFORD */
            IF B-CDOCU.coddiv <> '00019' AND B-CDOCU.codven = '081' THEN pCodDiv = '00019'.   /* Mesa redonda */
            IF B-CDOCU.CodDiv <> '00099' AND B-CDOCU.codven = '998' THEN pCodDiv = '00099'.   /* Exportaciones */
            IF B-CDOCU.CodDiv <> '00098' AND B-CDOCU.codven = '157' THEN pCodDiv = '00098'.   /* Refiles */
            IF Ccbcdocu.CndCre = "N" THEN DO:       /* OTRAS */
                /* NO por APLICACION DE ANTICIPO */
/*                 FIND FIRST Ccbddocu OF Ccbcdocu WHERE Ccbddocu.codmat = '00014' NO-LOCK NO-ERROR. */
...
/* ******************** */
    ...
    FIND BB-DDOCU WHERE ROWID(BB-DDOCU) = ROWID(Ccbddocu) EXCLUSIVE-LOCK NO-WAIT NO-ERROR.
    IF NOT AVAILABLE BB-DDOCU THEN RETURN "ADM-ERROR".
    FIND BB-CDOCU OF Ccbddocu NO-LOCK NO-ERROR.
    IF AVAILABLE BB-CDOCU THEN DO:
        /***********Grabando Costos **********************/
        IF AVAILABLE Almmmatg AND Almmmatg.TpoCmb > 0 THEN DO: 
            IF BB-DDOCU.Factor = ? OR BB-DDOCU.Factor = 0 THEN BB-DDOCU.Factor = 1.
            IF almmmatg.monvta = 1 THEN DO:
                x-cto1 = ROUND( Almmmatg.Ctotot * BB-DDOCU.CanDes * BB-DDOCU.Factor , 2 ).
                x-cto2 = ROUND(( Almmmatg.Ctotot * BB-DDOCU.CanDes * BB-DDOCU.Factor ) /  Almmmatg.Tpocmb , 2 ).
            END.
            IF almmmatg.monvta = 2 THEN DO:
                x-cto1 = ROUND( Almmmatg.Ctotot * BB-DDOCU.CanDes * BB-DDOCU.Factor * Almmmatg.TpoCmb, 2 ).
                x-cto2 = ROUND(( Almmmatg.Ctotot * BB-DDOCU.CanDes * BB-DDOCU.Factor ) , 2 ).
            END.
        END.
        /*************************************************/
        ASSIGN
            BB-DDOCU.ImpCto = ( IF BB-CDOCU.codmon = 1 THEN x-cto1 ELSE x-cto2 ).
    END.
    ELSE ASSIGN
            BB-DDOCU.ImpCto = 0.
...
/* ************************* */
    ...
    END.
    FOR EACH estavtas.EvtAll04 WHERE estavtas.EvtAll04.Codcia = S-CODCIA
        AND estavtas.EvtAll04.NroFch >= x-NroFchI
        AND estavtas.EvtAll04.NroFch <= x-NroFchF:
        DELETE estavtas.EvtAll04.
    END.
    ...
    END.
    FOR EACH estavtas.EvtProvArti USE-INDEX Indice02 WHERE estavtas.EvtProvArti.Codcia = S-CODCIA
        AND estavtas.EvtProvArti.NroFch >= x-NroFchI
        AND estavtas.EvtProvArti.NroFch <= x-NroFchF:
        DELETE estavtas.EvtProvArti.
    END.
END.
...
/* **************************** */
    ...
    IF Ccbcdocu.CodMon = 1 THEN 
        ASSIGN
            ...
            estavtas.EvtAll01.VtaxDiaMn[x-Day] = estavtas.EvtAll01.VtaxDiaMn[x-Day] + ( x-signo1 * x-ImpLin * x-coe)
            estavtas.EvtAll01.CtoxDiaMe[x-Day] = estavtas.EvtAll01.CtoxDiaMe[x-Day] + ( x-signo1 * CcbDdocu.ImpCto * x-coe / x-TpoCmbCmp)
            estavtas.EvtAll01.VtaxDiaMe[x-Day] = estavtas.EvtAll01.VtaxDiaMe[x-Day] + ( x-signo1 * x-ImpLin * x-coe / x-TpoCmbCmp)
            estavtas.EvtAll01.CtoxMesMn = estavtas.EvtAll01.CtoxMesMn + x-signo1 * CcbDdocu.ImpCto * x-coe
            estavtas.EvtAll01.VtaxMesMn = estavtas.EvtAll01.VtaxMesMn + x-signo1 * x-ImpLin * x-coe
            estavtas.EvtAll01.CtoxMesMe = estavtas.EvtAll01.CtoxMesMe + x-signo1 * CcbDdocu.ImpCto * x-coe / x-TpoCmbCmp
            estavtas.EvtAll01.VtaxMesMe = estavtas.EvtAll01.VtaxMesMe + x-signo1 * x-ImpLin * x-coe / x-TpoCmbCmp.
    IF Ccbcdocu.CodMon = 2 THEN 
        ASSIGN
            ...
            estavtas.EvtAll01.VtaxDiaMe[x-Day] = estavtas.EvtAll01.VtaxDiaMe[x-Day] + ( x-signo1 * x-ImpLin * x-coe)
            estavtas.EvtAll01.CtoxDiaMn[x-Day] = estavtas.EvtAll01.CtoxDiaMn[x-Day] + ( x-signo1 * CcbDdocu.ImpCto * x-coe * x-TpoCmbVta)
            estavtas.EvtAll01.VtaxDiaMn[x-Day] = estavtas.EvtAll01.VtaxDiaMn[x-Day] + ( x-signo1 * x-ImpLin * x-coe * x-TpoCmbVta)
            estavtas.EvtAll01.CtoxMesMn = estavtas.EvtAll01.CtoxMesMn + x-signo1 * CcbDdocu.ImpCto * x-TpoCmbVta * x-coe
            estavtas.EvtAll01.VtaxMesMn = estavtas.EvtAll01.VtaxMesMn + x-signo1 * x-ImpLin * x-TpoCmbVta * x-coe
            estavtas.EvtAll01.CtoxMesMe = estavtas.EvtAll01.CtoxMesMe + x-signo1 * CcbDdocu.ImpCto * x-coe
            estavtas.EvtAll01.VtaxMesMe = estavtas.EvtAll01.VtaxMesMe + x-signo1 * x-ImpLin * x-coe.
...
/* ************************* */
    ...
    FOR EACH estavtas.EvtAll01 NO-LOCK WHERE estavtas.EvtAll01.codcia = s-codcia
        AND estavtas.EvtAll01.NroFch >= x-NroFchI
        AND estavtas.EvtAll01.NroFch <= x-NroFchF:
        /* VENTAS GENERALES ACUMULADAS */
        FIND estavtas.EvtAll04 WHERE estavtas.EvtAll04.Codcia = s-Codcia 
            AND estavtas.EvtAll04.Nrofch = estavtas.EvtAll01.NroFch
            AND estavtas.EvtAll04.CodDiv = estavtas.EvtAll01.CodDiv
            AND estavtas.EvtAll04.CanalVenta = estavtas.EvtAll01.CanalVenta
            AND estavtas.EvtAll04.CodUnico = estavtas.EvtAll01.CodUnico
            AND estavtas.EvtAll04.CodCli = estavtas.EvtAll01.CodCli
            AND estavtas.EvtAll04.CodMat = estavtas.EvtAll01.CodMat 
            AND estavtas.EvtAll04.CodPro = estavtas.EvtAll01.CodPro
            AND estavtas.EvtAll04.CodVen = estavtas.EvtAll01.codven 
            NO-ERROR.     
        IF NOT AVAILABLE estavtas.EvtAll04 THEN DO:
             CREATE estavtas.EvtAll04.
             ASSIGN
                 estavtas.EvtAll04.Codcia = s-Codcia 
                 estavtas.EvtAll04.Nrofch = estavtas.EvtAll01.NroFch
                 estavtas.EvtAll04.CodDiv = estavtas.EvtAll01.Coddiv 
                 estavtas.EvtAll04.CodAno = estavtas.EvtAll01.CodAno
                 estavtas.EvtAll04.CodMes = estavtas.EvtAll01.CodMes
                 estavtas.EvtAll04.CanalVenta = estavtas.EvtAll01.CanalVenta
                 estavtas.EvtAll04.CodUnico = estavtas.EvtAll01.CodUnico
                 estavtas.EvtAll04.CodCli = estavtas.EvtAll01.CodCli
                 estavtas.EvtAll04.CodMat = estavtas.EvtAll01.CodMat
                 estavtas.EvtAll04.CodPro = estavtas.EvtAll01.CodPro
                 estavtas.EvtAll04.CodVen = estavtas.EvtAll01.CodVen.
        END.                    
        ASSIGN
            estavtas.EvtAll04.CanxMes   = estavtas.EvtAll04.CanxMes   + estavtas.EvtAll01.CanxMes
            estavtas.EvtAll04.VtaxMesMe = estavtas.EvtAll04.VtaxMesMe + estavtas.EvtAll01.VtaxMesMe 
            estavtas.EvtAll04.VtaxMesMn = estavtas.EvtAll04.VtaxMesMn + estavtas.EvtAll01.VtaxMesMn
            estavtas.EvtAll04.CtoxMesMe = estavtas.EvtAll04.CtoxMesMe + estavtas.EvtAll01.CtoxMesMe
            estavtas.EvtAll04.CtoxMesMn = estavtas.EvtAll04.CtoxMesMn + estavtas.EvtAll01.CtoxMesMn
            estavtas.EvtAll04.ProxMesMe = estavtas.EvtAll04.ProxMesMe + estavtas.EvtAll01.ProxMesMe
            estavtas.EvtAll04.ProxMesMn = estavtas.EvtAll04.ProxMesMn + estavtas.EvtAll01.ProxMesMn.                  
        DO I = 1 TO 31 :
            estavtas.EvtAll04.CanxDia[I]   = estavtas.EvtAll04.CanxDia[I]   + estavtas.EvtAll01.CanxDia[I].
            estavtas.EvtAll04.VtaxDiaMn[I] = estavtas.EvtAll04.VtaxDiaMn[I] + estavtas.EvtAll01.VtaxDiaMn[I].
            estavtas.EvtAll04.VtaxDiaMe[I] = estavtas.EvtAll04.VtaxDiaMe[I] + estavtas.EvtAll01.VtaxDiaMe[I].
            estavtas.EvtAll04.CtoxDiaMn[I] = estavtas.EvtAll04.CtoxDiaMn[I] + estavtas.EvtAll01.CtoxDiaMn[I].
            estavtas.EvtAll04.CtoxDiaMe[I] = estavtas.EvtAll04.CtoxDiaMe[I] + estavtas.EvtAll01.CtoxDiaMe[I].
            estavtas.EvtAll04.ProxDiaMn[I] = estavtas.EvtAll04.ProxDiaMn[I] + estavtas.EvtAll01.ProxDiaMn[I].
            estavtas.EvtAll04.ProxDiaMe[I] = estavtas.EvtAll04.ProxDiaMe[I] + estavtas.EvtAll01.ProxDiaMe[I].
        END.
        ...
        END.
        /* VENTAS POR PROVEEDOR ARTICULO */
        FIND  estavtas.EvtProvArti WHERE  estavtas.EvtProvArti.codcia = s-codcia
            AND estavtas.EvtProvArti.NroFch = estavtas.EvtAll01.NroFch
            AND estavtas.EvtProvArti.CanalVenta = estavtas.EvtAll01.CanalVenta
            AND estavtas.EvtProvArti.CodDiv = estavtas.EvtAll01.CodDiv
            AND estavtas.EvtProvArti.CodPro = estavtas.EvtAll01.CodPro
            AND estavtas.EvtProvArti.CodMat = estavtas.EvtAll01.CodMat
            EXCLUSIVE-LOCK NO-ERROR.
        IF NOT AVAILABLE  estavtas.EvtProvArti THEN DO:
            CREATE  estavtas.EvtProvArti.
            ASSIGN
                estavtas.EvtProvArti.codcia = s-codcia
                estavtas.EvtProvArti.CodAno = estavtas.EvtAll01.CodAno
                estavtas.EvtProvArti.CodMes = estavtas.EvtAll01.CodMes
                estavtas.EvtProvArti.NroFch = estavtas.EvtAll01.NroFch
                estavtas.EvtProvArti.CanalVenta = estavtas.EvtAll01.CanalVenta
                estavtas.EvtProvArti.CodDiv = estavtas.EvtAll01.CodDiv
                estavtas.EvtProvArti.CodPro = estavtas.EvtAll01.CodPro
                estavtas.EvtProvArti.CodMat = estavtas.EvtAll01.CodMat.
        END.
        ASSIGN
            estavtas.EvtProvArti.CanxMes   = estavtas.EvtProvArti.CanxMes   + estavtas.EvtAll01.CanxMes
            estavtas.EvtProvArti.VtaxMesMe =  estavtas.EvtProvArti.VtaxMesMe + estavtas.EvtAll01.VtaxMesMe 
            estavtas.EvtProvArti.VtaxMesMn =  estavtas.EvtProvArti.VtaxMesMn + estavtas.EvtAll01.VtaxMesMn
            estavtas.EvtProvArti.CtoxMesMe =  estavtas.EvtProvArti.CtoxMesMe + estavtas.EvtAll01.CtoxMesMe
            estavtas.EvtProvArti.CtoxMesMn =  estavtas.EvtProvArti.CtoxMesMn + estavtas.EvtAll01.CtoxMesMn
            estavtas.EvtProvArti.ProxMesMe =  estavtas.EvtProvArti.ProxMesMe + estavtas.EvtAll01.ProxMesMe
            estavtas.EvtProvArti.ProxMesMn =  estavtas.EvtProvArti.ProxMesMn + estavtas.EvtAll01.ProxMesMn.
        DO I = 1 TO 31 :
            estavtas.EvtProvArti.CanxDia[I]   = estavtas.EvtProvArti.CanxDia[I]   + estavtas.EvtAll01.CanxDia[I].
            estavtas.EvtProvArti.VtaxDiaMn[I] = estavtas.EvtProvArti.VtaxDiaMn[I] + estavtas.EvtAll01.VtaxDiaMn[I].
            estavtas.EvtProvArti.VtaxDiaMe[I] = estavtas.EvtProvArti.VtaxDiaMe[I] + estavtas.EvtAll01.VtaxDiaMe[I].
            estavtas.EvtProvArti.CtoxDiaMn[I] = estavtas.EvtProvArti.CtoxDiaMn[I] + estavtas.EvtAll01.CtoxDiaMn[I].
            estavtas.EvtProvArti.CtoxDiaMe[I] = estavtas.EvtProvArti.CtoxDiaMe[I] + estavtas.EvtAll01.CtoxDiaMe[I].
            estavtas.EvtProvArti.ProxDiaMn[I] = estavtas.EvtProvArti.ProxDiaMn[I] + estavtas.EvtAll01.ProxDiaMn[I].
            estavtas.EvtProvArti.ProxDiaMe[I] = estavtas.EvtProvArti.ProxDiaMe[I] + estavtas.EvtAll01.ProxDiaMe[I].
        END.
