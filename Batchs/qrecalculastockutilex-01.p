...
DISPLAY 'INICIO:' NOW SKIP WITH STREAM-IO NO-BOX. PAUSE 0.
DEF TEMP-TABLE t-mate LIKE almmmate.
FOR EACH Almacen NO-LOCK WHERE Almacen.codcia = s-codcia
    AND Almacen.campo-c[9] = ""
    AND Almacen.flgrep = YES
    AND Almacen.campo-c[6] = "Si",
    FIRST gn-divi OF almacen NO-LOCK WHERE GN-DIVI.CanalVenta = "MIN":  /* Tiendas UTILEX */
