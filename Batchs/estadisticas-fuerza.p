...
/* Fecha de Cierre */
/* un meses atrás */
x-CodFchI = ADD-INTERVAL(TODAY, -7, "days").
...
x-CodFchI = DATE(02,01,2022).
x-CodFchF = DATE(02,28,2022).
...
------------------------------------------------------------------------------*/
    ...
    /* ************************************************************************ */
    /*FIND FIRST DimProducto WHERE DimProducto.CodMat = TRIM(ccbddocu.codmat) NO-LOCK NO-ERROR.*/
    ASSIGN 
