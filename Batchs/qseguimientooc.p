...
DEFINE VAR lFechaProceso AS DATE NO-UNDO.
...
&IF DEFINED(EXCLUDE-ue-graba) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ue-graba Procedure 
PROCEDURE ue-graba :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&IF DEFINED(EXCLUDE-ue-ordenes-compra) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ue-ordenes-compra Procedure 
...
&IF DEFINED(EXCLUDE-ue-ordenes-compra-acumulada) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ue-ordenes-compra-acumulada Procedure 
...
&IF DEFINED(EXCLUDE-ue-stocks) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ue-stocks Procedure 
PROCEDURE ue-stocks :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
