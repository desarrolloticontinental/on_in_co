...
PUT UNFORMATTED 'Anula RAN pendientes de aprobación' NOW SKIP.
RUN Rechaza-RAN.
IF RETURN-VALUE = 'ADM-ERROR' THEN DO:
...
/* ******************************************************************************** */
PUT UNFORMATTED 'Carga Reposicion ' NOW SKIP.
...
DO TRANSACTION ON ERROR UNDO, RETURN 'ADM-ERROR' ON STOP UNDO, RETURN 'ADM-ERROR':
    ...
    PUT UNFORMATTED 'Carga Temporal ' NOW SKIP.
    RUN Carga-Temporal.

    PUT UNFORMATTED 'Generar Pedido ' NOW SKIP.
    pOcurrencia = "".
    RUN GENERAR-PEDIDO.
    IF RETURN-VALUE = 'ADM-ERROR' THEN DO:
