...
IF Faccpedi.impfle > 0 THEN DO:
    ...
    IF AVAILABLE Almmmatg THEN DO:
        /* Cantidad pedida */
        x-CanPed = Faccpedi.impfle.
        /* El precio final ?????????????*/
        x-precio =  1 * x-CanPed.
        /**/
        x-ImpLin =  x-precio .
        x-Precio = ROUND(x-ImpLin / x-CanPed, 5).
        x-Precio-Sin-Igv = x-Precio * 100 / (1 + Faccpedi.PorIgv / 100).
        /* Verificar el IGV */
        ...
        CREATE Facdpedi.
        /*BUFFER-COPY Faccpedi TO Facdpedi*/
        ASSIGN 
        ...
        ASSIGN
            ...
            Facdpedi.ImpLin = x-ImpLin /*+ x-ImpIgv*/
            Facdpedi.PreUni = x-precio . /* (Facdpedi.ImpLin / Facdpedi.CanPed) */
