...
x-CodFchI = ADD-INTERVAL(x-CodFchI, -2, "months").
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE DimProducto AND DimProducto.TpoCmb > 0 AND (DimProducto.CtoTot + DimProducto.CtoLis) > 0 THEN DO:
        IF DimProducto.MonVta = 1 THEN DO:
            Ventas_Detalle.CostoNacCIGV = x-signo1 * CcbDdocu.CanDes * F-FACTOR * DimProducto.CtoTot * x-coe.
            Ventas_Detalle.CostoExtCIGV = x-signo1 * CcbDdocu.CanDes * F-FACTOR * DimProducto.CtoTot * x-coe / DimProducto.TpoCmb.
            Ventas_Detalle.CostoNacSIGV = x-signo1 * CcbDdocu.CanDes * F-FACTOR * DimProducto.CtoLis * x-coe.
            Ventas_Detalle.CostoExtSIGV = x-signo1 * CcbDdocu.CanDes * F-FACTOR * DimProducto.CtoLis * x-coe / DimProducto.TpoCmb.
        END.
        ELSE DO:
            Ventas_Detalle.CostoExtCIGV = x-signo1 * CcbDdocu.CanDes * F-FACTOR * DimProducto.CtoTot * x-coe.
            Ventas_Detalle.CostoNacCIGV = x-signo1 * CcbDdocu.CanDes * F-FACTOR * DimProducto.CtoTot * DimProducto.TpoCmb * x-coe.
            Ventas_Detalle.CostoExtSIGV = x-signo1 * CcbDdocu.CanDes * F-FACTOR * DimProducto.CtoLis * x-coe.
            Ventas_Detalle.CostoNacSIGV = x-signo1 * CcbDdocu.CanDes * F-FACTOR * DimProducto.CtoLis * DimProducto.TpoCmb * x-coe.
        END.
    END.
