...
DO TRANSACTION ON ERROR UNDO, RETURN ON STOP UNDO, RETURN:
    ...
    FOR EACH faccpedi WHERE faccpedi.codcia = s-codcia
        ...
        AND faccpedi.fchped = TODAY         /* Dela día  */
