...
/* 04/09/2024: LOs campos ya están en la cabecera */                                                              
...
FOR EACH t-Ventas_Cabecera:
    ...
    END.
END.
x-Archivo = "/home/u/IN/log/" + "ventas_cabecera2022" + ".txt".
...
END.
x-Archivo = "/home/u/IN/log/" + "ventas_detalle2022" + ".txt".
OUTPUT TO VALUE(x-archivo) KEEP-MESSAGES.
